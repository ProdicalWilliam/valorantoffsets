...
{ 
public:
	TMap<class UClass*, FPlatformSettingsInstances>    SettingsMap;                                                // 0x0030   (0x0050)  
...
static_assert(sizeof(UDeveloperSettings) == 0x0048); // 72 bytes (0x000030 - 0x000048)
static_assert(sizeof(UDeveloperSettingsBackedByCVars) == 0x0048); // 72 bytes (0x000048 - 0x000048)
static_assert(sizeof(UPlatformSettings) == 0x0050); // 80 bytes (0x000030 - 0x000050)
static_assert(sizeof(FPlatformSettingsInstances) == 0x0058); // 88 bytes (0x000000 - 0x000058)
static_assert(sizeof(UPlatformSettingsManager) == 0x0090); // 144 bytes (0x000030 - 0x000090)
...
static_assert(offsetof(UPlatformSettingsManager, SettingsMap) == 0x0030);
