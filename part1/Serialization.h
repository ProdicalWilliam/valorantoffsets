...
{ 
	...
	FSoftClassPath                                     ClassPath;                                                  // 0x0090   (0x0028)  
	FSoftObjectPath                                    ObjectPath;                                                 // 0x00B8   (0x0028)  
};
...
{ 
	...
	SDK_UNDEFINED(80,5228) /* TSet<FVector> */         __um(VectorSet);                                            // 0x0310   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(80,5229) /* TSet<FVector3f> */       __um(VectorSet);                                            // 0x01C8   (0x0050)  
...
{ 
	SDK_UNDEFINED(80,5230) /* TSet<FString> */         __um(StrSet);                                               // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,5231) /* TSet<int32_t> */         __um(IntSet);                                               // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,5232) /* TSet<FName> */           __um(NameSet);                                              // 0x00A0   (0x0050)  
	SDK_UNDEFINED(80,5233) /* TSet<FStructSerializerBuiltinTestStruct> */ __um(StructSet);                         // 0x00F0   (0x0050)  
};

/// Struct /Script/Serialization.StructSerializerTestStruct
/// Size: 0x0830 (2096 bytes) (0x000000 - 0x000830) align 16 MaxSize: 0x0830
...
{ 
	...
	FStructSerializerObjectTestStruct                  Objects;                                                    // 0x0038   (0x00E0)  
	unsigned char                                      UnknownData01_6[0x8];                                       // 0x0118   (0x0008)  MISSED
	FStructSerializerBuiltinTestStruct                 Builtins;                                                   // 0x0120   (0x00D0)  
	FStructSerializerArrayTestStruct                   Arrays;                                                     // 0x01F0   (0x0060)  
	FStructSerializerMapTestStruct                     Maps;                                                       // 0x0250   (0x0140)  
	FStructSerializerSetTestStruct                     Sets;                                                       // 0x0390   (0x0140)  
	FStructSerializerLWCTypesTest                      LWCTypes;                                                   // 0x04D0   (0x0360)  
};
...
static_assert(sizeof(FStructSerializerObjectTestStruct) == 0x00E0); // 224 bytes (0x000000 - 0x0000E0)
...
static_assert(sizeof(FStructSerializerTestStruct) == 0x0830); // 2096 bytes (0x000000 - 0x000830)
...
static_assert(offsetof(FStructSerializerObjectTestStruct, ObjectPath) == 0x00B8);
...
static_assert(offsetof(FStructSerializerBuiltinTestStruct, String) == 0x0020);
static_assert(offsetof(FStructSerializerBuiltinTestStruct, Text) == 0x0030);
static_assert(offsetof(FStructSerializerBuiltinTestStruct, Vector) == 0x0048);
...
static_assert(offsetof(FStructSerializerTestStruct, Builtins) == 0x0120);
static_assert(offsetof(FStructSerializerTestStruct, Arrays) == 0x01F0);
static_assert(offsetof(FStructSerializerTestStruct, Maps) == 0x0250);
static_assert(offsetof(FStructSerializerTestStruct, Sets) == 0x0390);
static_assert(offsetof(FStructSerializerTestStruct, LWCTypes) == 0x04D0);
