...
{ 
	...
	FSoftClassPath                                     GameMode;                                                   // 0x0010   (0x0028)  
};
...
public:
	...
	FSoftObjectPath                                    TransitionMap;                                              // 0x0040   (0x0028)  
	bool                                               bUseSplitscreen;                                            // 0x0068   (0x0001)  
	TEnumAsByte<ETwoPlayerSplitScreenType>             TwoPlayerSplitscreenLayout;                                 // 0x0069   (0x0001)  
	TEnumAsByte<EThreePlayerSplitScreenType>           ThreePlayerSplitscreenLayout;                               // 0x006A   (0x0001)  
	EFourPlayerSplitScreenType                         FourPlayerSplitscreenLayout;                                // 0x006B   (0x0001)  
	bool                                               bOffsetPlayerGamepadIds;                                    // 0x006C   (0x0001)  
	unsigned char                                      UnknownData00_6[0x3];                                       // 0x006D   (0x0003)  MISSED
	FSoftClassPath                                     GameInstanceClass;                                          // 0x0070   (0x0028)  
	FSoftObjectPath                                    GameDefaultMap;                                             // 0x0098   (0x0028)  
	FSoftObjectPath                                    ServerDefaultMap;                                           // 0x00C0   (0x0028)  
	FSoftClassPath                                     GlobalDefaultGameMode;                                      // 0x00E8   (0x0028)  
	FSoftClassPath                                     GlobalDefaultServerGameMode;                                // 0x0110   (0x0028)  
	TArray<FGameModeName>                              GameModeMapPrefixes;                                        // 0x0138   (0x0010)  
	TArray<FGameModeName>                              GameModeClassAliases;                                       // 0x0148   (0x0010)  


	/// Functions
	// Function /Script/EngineSettings.GameMapsSettings.SetSkipAssigningGamepadToPlayer1
	// void SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer);                                                            // [0x1f584d0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/EngineSettings.GameMapsSettings.GetSkipAssigningGamepadToPlayer1
	// bool GetSkipAssigningGamepadToPlayer1();                                                                                 // [0x1f584b0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EngineSettings.GameMapsSettings.GetGameMapsSettings
	// class UGameMapsSettings* GetGameMapsSettings();                                                                          // [0x1f585c0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	float                                              EyeOffsetForFakeStereoRenderingDevice;                      // 0x0118   (0x0004)  
	float                                              FOVForFakeStereoRenderingDevice;                            // 0x011C   (0x0004)  
};
...
{ 
	FSoftObjectPath                                    Thumbnail;                                                  // 0x0000   (0x0028)  
	FSoftObjectPath                                    Map;                                                        // 0x0028   (0x0028)  
	FText                                              DisplayName;                                                // 0x0050   (0x0018)  
};
...
static_assert(sizeof(FGameModeName) == 0x0038); // 56 bytes (0x000000 - 0x000038)
static_assert(sizeof(UGameMapsSettings) == 0x0158); // 344 bytes (0x000030 - 0x000158)
...
static_assert(sizeof(UGeneralProjectSettings) == 0x0120); // 288 bytes (0x000030 - 0x000120)
static_assert(sizeof(UHudSettings) == 0x0048); // 72 bytes (0x000030 - 0x000048)
static_assert(sizeof(FTemplateMapInfoOverride) == 0x0068); // 104 bytes (0x000000 - 0x000068)
...
static_assert(offsetof(UGameMapsSettings, TwoPlayerSplitscreenLayout) == 0x0069);
static_assert(offsetof(UGameMapsSettings, ThreePlayerSplitscreenLayout) == 0x006A);
static_assert(offsetof(UGameMapsSettings, FourPlayerSplitscreenLayout) == 0x006B);
static_assert(offsetof(UGameMapsSettings, GameInstanceClass) == 0x0070);
static_assert(offsetof(UGameMapsSettings, GameDefaultMap) == 0x0098);
static_assert(offsetof(UGameMapsSettings, ServerDefaultMap) == 0x00C0);
static_assert(offsetof(UGameMapsSettings, GlobalDefaultGameMode) == 0x00E8);
static_assert(offsetof(UGameMapsSettings, GlobalDefaultServerGameMode) == 0x0110);
static_assert(offsetof(UGameMapsSettings, GameModeMapPrefixes) == 0x0138);
static_assert(offsetof(UGameMapsSettings, GameModeClassAliases) == 0x0148);
...
static_assert(offsetof(FTemplateMapInfoOverride, Map) == 0x0028);
static_assert(offsetof(FTemplateMapInfoOverride, DisplayName) == 0x0050);
