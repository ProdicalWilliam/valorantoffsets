...
/// Enum /Script/SlateCore.EButtonInputPriority
/// Size: 0x01 (1 bytes)
enum class EButtonInputPriority : uint8_t
{
	EButtonInputPriority__AfterChildren                                              = 0,
	EButtonInputPriority__BeforeChildren                                             = 1,
	EButtonInputPriority__Never                                                      = 2
};
...
/// Size: 0x09C8 (2504 bytes) (0x000030 - 0x0009C8) align 8 MaxSize: 0x09C8
class USlateThemeManager : public UObject
{ 
public:
	FGuid                                              CurrentThemeId;                                             // 0x0030   (0x0010)  
	FStyleColorList                                    ActiveColors;                                               // 0x0040   (0x0988)  
};
...
{ 
	...
	FName                                              ResourceName;                                               // 0x0098   (0x000C)  
	FBox2f                                             UVRegion;                                                   // 0x00A4   (0x0014)  
	unsigned char                                      UnknownData03_7[0x18];                                      // 0x00B8   (0x0018)  MISSED
};
...
/// Size: 0x0400 (1024 bytes) (0x000008 - 0x000400) align 16 MaxSize: 0x0400
...
{ 
	...
	FSlateSound                                        PressedSlateSound;                                          // 0x03C0   (0x0020)  
	FSlateSound                                        HoveredSlateSound;                                          // 0x03E0   (0x0020)  
};

/// Struct /Script/SlateCore.ComboButtonStyle
/// Size: 0x0610 (1552 bytes) (0x000008 - 0x000610) align 16 MaxSize: 0x0610
struct FComboButtonStyle : FSlateWidgetStyle
{ 
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0008   (0x0008)  MISSED
	FButtonStyle                                       ButtonStyle;                                                // 0x0010   (0x0400)  
	FSlateBrush                                        DownArrowImage;                                             // 0x0410   (0x00D0)  
	FDeprecateSlateVector2D                            ShadowOffset;                                               // 0x04E0   (0x0008)  
	FLinearColor                                       ShadowColorAndOpacity;                                      // 0x04E8   (0x0010)  
	unsigned char                                      UnknownData01_6[0x8];                                       // 0x04F8   (0x0008)  MISSED
	FSlateBrush                                        MenuBorderBrush;                                            // 0x0500   (0x00D0)  
	FMargin                                            MenuBorderPadding;                                          // 0x05D0   (0x0010)  
	FMargin                                            ContentPadding;                                             // 0x05E0   (0x0010)  
	FMargin                                            DownArrowPadding;                                           // 0x05F0   (0x0010)  
	TEnumAsByte<EVerticalAlignment>                    DownArrowAlign;                                             // 0x0600   (0x0001)  
	unsigned char                                      UnknownData02_7[0xF];                                       // 0x0601   (0x000F)  MISSED
};

/// Struct /Script/SlateCore.ComboBoxStyle
/// Size: 0x0680 (1664 bytes) (0x000008 - 0x000680) align 16 MaxSize: 0x0680
struct FComboBoxStyle : FSlateWidgetStyle
{ 
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0008   (0x0008)  MISSED
	FComboButtonStyle                                  ComboButtonStyle;                                           // 0x0010   (0x0610)  
	FSlateSound                                        PressedSlateSound;                                          // 0x0620   (0x0020)  
	FSlateSound                                        SelectionChangeSlateSound;                                  // 0x0640   (0x0020)  
	FMargin                                            ContentPadding;                                             // 0x0660   (0x0010)  
	FMargin                                            MenuRowPadding;                                             // 0x0670   (0x0010)  
};
...
{ 
	unsigned char                                      UnknownData00_1[0x28];                                      // 0x0020   (0x0028)  MISSED
};
...
/// Size: 0x0AE0 (2784 bytes) (0x000008 - 0x000AE0) align 16 MaxSize: 0x0AE0
...
{ 
	...
	FSlateSound                                        CheckedSlateSound;                                          // 0x0A80   (0x0020)  
	FSlateSound                                        UncheckedSlateSound;                                        // 0x0AA0   (0x0020)  
	FSlateSound                                        HoveredSlateSound;                                          // 0x0AC0   (0x0020)  
};

/// Struct /Script/SlateCore.SegmentedControlStyle
/// Size: 0x2190 (8592 bytes) (0x000008 - 0x002190) align 16 MaxSize: 0x2190
struct FSegmentedControlStyle : FSlateWidgetStyle
{ 
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0008   (0x0008)  MISSED
	FCheckBoxStyle                                     ControlStyle;                                               // 0x0010   (0x0AE0)  
	FCheckBoxStyle                                     FirstControlStyle;                                          // 0x0AF0   (0x0AE0)  
	FCheckBoxStyle                                     LastControlStyle;                                           // 0x15D0   (0x0AE0)  
	FSlateBrush                                        BackgroundBrush;                                            // 0x20B0   (0x00D0)  
	FMargin                                            UniformPadding;                                             // 0x2180   (0x0010)  
};
...
{ 
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0008   (0x0008)  MISSED
	FButtonStyle                                       UnderlineStyle;                                             // 0x0010   (0x0400)  
	FTextBlockStyle                                    TextStyle;                                                  // 0x0410   (0x0340)  
	FMargin                                            Padding;                                                    // 0x0750   (0x0010)  
};
...
/// Size: 0x0D90 (3472 bytes) (0x000008 - 0x000D90) align 16 MaxSize: 0x0D90
struct FDockTabStyle : FSlateWidgetStyle
{ 
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0008   (0x0008)  MISSED
	FButtonStyle                                       CloseButtonStyle;                                           // 0x0010   (0x0400)  
	FSlateBrush                                        NormalBrush;                                                // 0x0410   (0x00D0)  
	FSlateBrush                                        ColorOverlayTabBrush;                                       // 0x04E0   (0x00D0)  
	FSlateBrush                                        ColorOverlayIconBrush;                                      // 0x05B0   (0x00D0)  
	FSlateBrush                                        ForegroundBrush;                                            // 0x0680   (0x00D0)  
	FSlateBrush                                        HoveredBrush;                                               // 0x0750   (0x00D0)  
	FSlateBrush                                        ContentAreaBrush;                                           // 0x0820   (0x00D0)  
	FSlateBrush                                        TabWellBrush;                                               // 0x08F0   (0x00D0)  
	FTextBlockStyle                                    TabTextStyle;                                               // 0x09C0   (0x0340)  
	FMargin                                            TabPadding;                                                 // 0x0D00   (0x0010)  
	FDeprecateSlateVector2D                            IconSize;                                                   // 0x0D10   (0x0008)  
	float                                              OverlapWidth;                                               // 0x0D18   (0x0004)  
	FSlateColor                                        FlashColor;                                                 // 0x0D1C   (0x0014)  
	FSlateColor                                        NormalForegroundColor;                                      // 0x0D30   (0x0014)  
	FSlateColor                                        HoveredForegroundColor;                                     // 0x0D44   (0x0014)  
	FSlateColor                                        ActiveForegroundColor;                                      // 0x0D58   (0x0014)  
	FSlateColor                                        ForegroundForegroundColor;                                  // 0x0D6C   (0x0014)  
	float                                              IconBorderPadding;                                          // 0x0D80   (0x0004)  
	unsigned char                                      UnknownData01_7[0xC];                                       // 0x0D84   (0x000C)  MISSED
};
...
/// Size: 0x1980 (6528 bytes) (0x000008 - 0x001980) align 16 MaxSize: 0x1980
struct FWindowStyle : FSlateWidgetStyle
{ 
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0008   (0x0008)  MISSED
	FButtonStyle                                       MinimizeButtonStyle;                                        // 0x0010   (0x0400)  
	FButtonStyle                                       MaximizeButtonStyle;                                        // 0x0410   (0x0400)  
	FButtonStyle                                       RestoreButtonStyle;                                         // 0x0810   (0x0400)  
	FButtonStyle                                       CloseButtonStyle;                                           // 0x0C10   (0x0400)  
	FTextBlockStyle                                    TitleTextStyle;                                             // 0x1010   (0x0340)  
	FSlateBrush                                        ActiveTitleBrush;                                           // 0x1350   (0x00D0)  
	FSlateBrush                                        InactiveTitleBrush;                                         // 0x1420   (0x00D0)  
	FSlateBrush                                        FlashTitleBrush;                                            // 0x14F0   (0x00D0)  
	FSlateColor                                        BackgroundColor;                                            // 0x15C0   (0x0014)  
	unsigned char                                      UnknownData01_6[0xC];                                       // 0x15D4   (0x000C)  MISSED
	FSlateBrush                                        OutlineBrush;                                               // 0x15E0   (0x00D0)  
	FSlateColor                                        OutlineColor;                                               // 0x16B0   (0x0014)  
	unsigned char                                      UnknownData02_6[0xC];                                       // 0x16C4   (0x000C)  MISSED
	FSlateBrush                                        BorderBrush;                                                // 0x16D0   (0x00D0)  
	FSlateColor                                        BorderColor;                                                // 0x17A0   (0x0014)  
	unsigned char                                      UnknownData03_6[0xC];                                       // 0x17B4   (0x000C)  MISSED
	FSlateBrush                                        BackgroundBrush;                                            // 0x17C0   (0x00D0)  
	FSlateBrush                                        ChildBackgroundBrush;                                       // 0x1890   (0x00D0)  
	int32_t                                            WindowCornerRadius;                                         // 0x1960   (0x0004)  
	FMargin                                            BorderPadding;                                              // 0x1964   (0x0010)  
	unsigned char                                      UnknownData04_7[0xC];                                       // 0x1974   (0x000C)  MISSED
};
...
/// Size: 0x3EF0 (16112 bytes) (0x000008 - 0x003EF0) align 16 MaxSize: 0x3EF0
...
{ 
	...
	FCheckBoxStyle                                     ToggleButton;                                               // 0x1440   (0x0AE0)  
	FComboButtonStyle                                  ComboButtonStyle;                                           // 0x1F20   (0x0610)  
	FButtonStyle                                       SettingsButtonStyle;                                        // 0x2530   (0x0400)  
	FComboButtonStyle                                  SettingsComboButton;                                        // 0x2930   (0x0610)  
	FCheckBoxStyle                                     SettingsToggleButton;                                       // 0x2F40   (0x0AE0)  
	FButtonStyle                                       ButtonStyle;                                                // 0x3A20   (0x0400)  
	FMargin                                            LabelPadding;                                               // 0x3E20   (0x0010)  
	float                                              UniformBlockWidth;                                          // 0x3E30   (0x0004)  
	float                                              UniformBlockHeight;                                         // 0x3E34   (0x0004)  
	int32_t                                            NumColumns;                                                 // 0x3E38   (0x0004)  
	FMargin                                            IconPadding;                                                // 0x3E3C   (0x0010)  
	FMargin                                            SeparatorPadding;                                           // 0x3E4C   (0x0010)  
	FMargin                                            ComboButtonPadding;                                         // 0x3E5C   (0x0010)  
	FMargin                                            ButtonPadding;                                              // 0x3E6C   (0x0010)  
	FMargin                                            CheckBoxPadding;                                            // 0x3E7C   (0x0010)  
	FMargin                                            BlockPadding;                                               // 0x3E8C   (0x0010)  
	FMargin                                            IndentedBlockPadding;                                       // 0x3E9C   (0x0010)  
	FMargin                                            BackgroundPadding;                                          // 0x3EAC   (0x0010)  
	FDeprecateSlateVector2D                            IconSize;                                                   // 0x3EBC   (0x0008)  
	bool                                               bShowLabels;                                                // 0x3EC4   (0x0001)  
	unsigned char                                      UnknownData01_6[0x3];                                       // 0x3EC5   (0x0003)  MISSED
	float                                              ButtonContentMaxWidth;                                      // 0x3EC8   (0x0004)  
	float                                              ButtonContentFillWidth;                                     // 0x3ECC   (0x0004)  
	FMargin                                            IconPaddingWithVisibleLabel;                                // 0x3ED0   (0x0010)  
	FMargin                                            IconPaddingWithCollapsedLabel;                              // 0x3EE0   (0x0010)  
};
...
static_assert(sizeof(USlateThemeManager) == 0x09C8); // 2504 bytes (0x000030 - 0x0009C8)
...
static_assert(sizeof(FPointerEvent) == 0x0080); // 128 bytes (0x000020 - 0x000080)
...
static_assert(sizeof(FSlateSound) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FButtonStyle) == 0x0400); // 1024 bytes (0x000008 - 0x000400)
static_assert(sizeof(FComboButtonStyle) == 0x0610); // 1552 bytes (0x000008 - 0x000610)
static_assert(sizeof(FComboBoxStyle) == 0x0680); // 1664 bytes (0x000008 - 0x000680)
...
static_assert(sizeof(FKeyEvent) == 0x0048); // 72 bytes (0x000020 - 0x000048)
static_assert(sizeof(FNavigationEvent) == 0x0028); // 40 bytes (0x000020 - 0x000028)
static_assert(sizeof(FAnalogInputEvent) == 0x0050); // 80 bytes (0x000048 - 0x000050)
...
static_assert(sizeof(FTypefaceEntry) == 0x0038); // 56 bytes (0x000000 - 0x000038)
...
static_assert(sizeof(FCheckBoxStyle) == 0x0AE0); // 2784 bytes (0x000008 - 0x000AE0)
static_assert(sizeof(FSegmentedControlStyle) == 0x2190); // 8592 bytes (0x000008 - 0x002190)
static_assert(sizeof(FHyperlinkStyle) == 0x0760); // 1888 bytes (0x000008 - 0x000760)
...
static_assert(sizeof(FDockTabStyle) == 0x0D90); // 3472 bytes (0x000008 - 0x000D90)
...
static_assert(sizeof(FWindowStyle) == 0x1980); // 6528 bytes (0x000008 - 0x001980)
static_assert(sizeof(FStyleTheme) == 0x0048); // 72 bytes (0x000000 - 0x000048)
static_assert(sizeof(FToolBarStyle) == 0x3EF0); // 16112 bytes (0x000008 - 0x003EF0)
...
static_assert(offsetof(USlateThemeManager, CurrentThemeId) == 0x0030);
static_assert(offsetof(USlateThemeManager, ActiveColors) == 0x0040);
...
static_assert(offsetof(FSlateBrush, UVRegion) == 0x00A4);
...
static_assert(offsetof(FButtonStyle, HoveredSlateSound) == 0x03E0);
static_assert(offsetof(FComboButtonStyle, ButtonStyle) == 0x0010);
static_assert(offsetof(FComboButtonStyle, DownArrowImage) == 0x0410);
static_assert(offsetof(FComboButtonStyle, ShadowOffset) == 0x04E0);
static_assert(offsetof(FComboButtonStyle, ShadowColorAndOpacity) == 0x04E8);
static_assert(offsetof(FComboButtonStyle, MenuBorderBrush) == 0x0500);
static_assert(offsetof(FComboButtonStyle, MenuBorderPadding) == 0x05D0);
static_assert(offsetof(FComboButtonStyle, ContentPadding) == 0x05E0);
static_assert(offsetof(FComboButtonStyle, DownArrowPadding) == 0x05F0);
static_assert(offsetof(FComboButtonStyle, DownArrowAlign) == 0x0600);
static_assert(offsetof(FComboBoxStyle, ComboButtonStyle) == 0x0010);
static_assert(offsetof(FComboBoxStyle, PressedSlateSound) == 0x0620);
static_assert(offsetof(FComboBoxStyle, SelectionChangeSlateSound) == 0x0640);
static_assert(offsetof(FComboBoxStyle, ContentPadding) == 0x0660);
static_assert(offsetof(FComboBoxStyle, MenuRowPadding) == 0x0670);
...
static_assert(offsetof(FTypefaceEntry, Font) == 0x0010);
...
static_assert(offsetof(FCheckBoxStyle, UncheckedSlateSound) == 0x0AA0);
static_assert(offsetof(FCheckBoxStyle, HoveredSlateSound) == 0x0AC0);
static_assert(offsetof(FSegmentedControlStyle, ControlStyle) == 0x0010);
static_assert(offsetof(FSegmentedControlStyle, FirstControlStyle) == 0x0AF0);
static_assert(offsetof(FSegmentedControlStyle, LastControlStyle) == 0x15D0);
static_assert(offsetof(FSegmentedControlStyle, BackgroundBrush) == 0x20B0);
static_assert(offsetof(FSegmentedControlStyle, UniformPadding) == 0x2180);
static_assert(offsetof(FHyperlinkStyle, UnderlineStyle) == 0x0010);
static_assert(offsetof(FHyperlinkStyle, TextStyle) == 0x0410);
static_assert(offsetof(FHyperlinkStyle, Padding) == 0x0750);
...
static_assert(offsetof(FDockTabStyle, NormalBrush) == 0x0410);
static_assert(offsetof(FDockTabStyle, ColorOverlayTabBrush) == 0x04E0);
static_assert(offsetof(FDockTabStyle, ColorOverlayIconBrush) == 0x05B0);
static_assert(offsetof(FDockTabStyle, ForegroundBrush) == 0x0680);
static_assert(offsetof(FDockTabStyle, HoveredBrush) == 0x0750);
static_assert(offsetof(FDockTabStyle, ContentAreaBrush) == 0x0820);
static_assert(offsetof(FDockTabStyle, TabWellBrush) == 0x08F0);
static_assert(offsetof(FDockTabStyle, TabTextStyle) == 0x09C0);
static_assert(offsetof(FDockTabStyle, TabPadding) == 0x0D00);
static_assert(offsetof(FDockTabStyle, IconSize) == 0x0D10);
static_assert(offsetof(FDockTabStyle, FlashColor) == 0x0D1C);
static_assert(offsetof(FDockTabStyle, NormalForegroundColor) == 0x0D30);
static_assert(offsetof(FDockTabStyle, HoveredForegroundColor) == 0x0D44);
static_assert(offsetof(FDockTabStyle, ActiveForegroundColor) == 0x0D58);
static_assert(offsetof(FDockTabStyle, ForegroundForegroundColor) == 0x0D6C);
...
static_assert(offsetof(FWindowStyle, MaximizeButtonStyle) == 0x0410);
static_assert(offsetof(FWindowStyle, RestoreButtonStyle) == 0x0810);
static_assert(offsetof(FWindowStyle, CloseButtonStyle) == 0x0C10);
static_assert(offsetof(FWindowStyle, TitleTextStyle) == 0x1010);
static_assert(offsetof(FWindowStyle, ActiveTitleBrush) == 0x1350);
static_assert(offsetof(FWindowStyle, InactiveTitleBrush) == 0x1420);
static_assert(offsetof(FWindowStyle, FlashTitleBrush) == 0x14F0);
static_assert(offsetof(FWindowStyle, BackgroundColor) == 0x15C0);
static_assert(offsetof(FWindowStyle, OutlineBrush) == 0x15E0);
static_assert(offsetof(FWindowStyle, OutlineColor) == 0x16B0);
static_assert(offsetof(FWindowStyle, BorderBrush) == 0x16D0);
static_assert(offsetof(FWindowStyle, BorderColor) == 0x17A0);
static_assert(offsetof(FWindowStyle, BackgroundBrush) == 0x17C0);
static_assert(offsetof(FWindowStyle, ChildBackgroundBrush) == 0x1890);
static_assert(offsetof(FWindowStyle, BorderPadding) == 0x1964);
...
static_assert(offsetof(FToolBarStyle, ComboButtonStyle) == 0x1F20);
static_assert(offsetof(FToolBarStyle, SettingsButtonStyle) == 0x2530);
static_assert(offsetof(FToolBarStyle, SettingsComboButton) == 0x2930);
static_assert(offsetof(FToolBarStyle, SettingsToggleButton) == 0x2F40);
static_assert(offsetof(FToolBarStyle, ButtonStyle) == 0x3A20);
static_assert(offsetof(FToolBarStyle, LabelPadding) == 0x3E20);
static_assert(offsetof(FToolBarStyle, IconPadding) == 0x3E3C);
static_assert(offsetof(FToolBarStyle, SeparatorPadding) == 0x3E4C);
static_assert(offsetof(FToolBarStyle, ComboButtonPadding) == 0x3E5C);
static_assert(offsetof(FToolBarStyle, ButtonPadding) == 0x3E6C);
static_assert(offsetof(FToolBarStyle, CheckBoxPadding) == 0x3E7C);
static_assert(offsetof(FToolBarStyle, BlockPadding) == 0x3E8C);
static_assert(offsetof(FToolBarStyle, IndentedBlockPadding) == 0x3E9C);
static_assert(offsetof(FToolBarStyle, BackgroundPadding) == 0x3EAC);
static_assert(offsetof(FToolBarStyle, IconSize) == 0x3EBC);
static_assert(offsetof(FToolBarStyle, IconPaddingWithVisibleLabel) == 0x3ED0);
static_assert(offsetof(FToolBarStyle, IconPaddingWithCollapsedLabel) == 0x3EE0);
