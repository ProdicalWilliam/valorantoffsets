...
/// Enum /Script/CoreUObject.EStringMeasurementUnits
/// Size: 0x01 (1 bytes)
enum class EStringMeasurementUnits : uint8_t
{
	EStringMeasurementUnits__CodeUnits_UTF16                                         = 0,
	EStringMeasurementUnits__CodeUnits_UTF8                                          = 1,
	EStringMeasurementUnits__CodePoints                                              = 2
};
...
enum class EUnit : uint8_t
{
	...
	EUnit__KilogramCentimetersPerSecondSquared                                       = 30,
	EUnit__NewtonMeters                                                              = 31,
	EUnit__KilogramCentimetersSquaredPerSecondSquared                                = 32,
	EUnit__Hertz                                                                     = 33,
	EUnit__Kilohertz                                                                 = 34,
	EUnit__Megahertz                                                                 = 35,
	EUnit__Gigahertz                                                                 = 36,
	EUnit__RevolutionsPerMinute                                                      = 37,
	EUnit__Bytes                                                                     = 38,
	EUnit__Kilobytes                                                                 = 39,
	EUnit__Megabytes                                                                 = 40,
	EUnit__Gigabytes                                                                 = 41,
	...
	EUnit__Months                                                                    = 55,
	EUnit__Years                                                                     = 56,
	EUnit__Multiplier                                                                = 59,
	EUnit__Percentage                                                                = 58,
	EUnit__Unspecified                                                               = 64
};
...
public:
	...
	// void ExecuteUbergraph(int32_t EntryPoint);                                                                               // [0x1a821d0] Event|Public|BlueprintEvent 
};
...
/// Size: 0x0210 (528 bytes) (0x0000B8 - 0x000210) align 8 MaxSize: 0x0210
class UClass : public UStruct
{ 
public:
	unsigned char                                      UnknownData00_1[0x158];                                     // 0x00B8   (0x0158)  MISSED
};
...
/// Size: 0x0290 (656 bytes) (0x000210 - 0x000290) align 8 MaxSize: 0x0290
class UDynamicClass : public UClass
{ 
public:
	unsigned char                                      UnknownData00_1[0x80];                                      // 0x0210   (0x0080)  MISSED
};
...
/// Size: 0x03D0 (976 bytes) (0x000210 - 0x0003D0) align 8 MaxSize: 0x03D0
class ULinkerPlaceholderClass : public UClass
{ 
public:
	unsigned char                                      UnknownData00_1[0x1C0];                                     // 0x0210   (0x01C0)  MISSED
};
...
/// Size: 0x02A8 (680 bytes) (0x0000E8 - 0x0002A8) align 8 MaxSize: 0x02A8
class ULinkerPlaceholderFunction : public UFunction
{ 
public:
	unsigned char                                      UnknownData00_1[0x1C0];                                     // 0x00E8   (0x01C0)  MISSED
};
...
{ 
	FTopLevelAssetPath                                 AssetPath;                                                  // 0x0000   (0x0018)  
	FString                                            SubPathString;                                              // 0x0018   (0x0010)  
};
...
{ 
	...
	TArray<FTopLevelAssetPath>                         AssetPaths;                                                 // 0x0010   (0x0010)  
};
...
{ 
	FName                                              PackageName;                                                // 0x0000   (0x000C)  
	FName                                              PackagePath;                                                // 0x000C   (0x000C)  
	FName                                              AssetName;                                                  // 0x0018   (0x000C)  
	FName                                              AssetClass;                                                 // 0x0024   (0x000C)  
	FTopLevelAssetPath                                 AssetClassPath;                                             // 0x0030   (0x0018)  
...
{ 
	...
	FSoftObjectPath                                    SoftObjectPath;                                             // 0x0038   (0x0028)  
	TWeakObjectPtr<class UObject*>                     WeakObjectPointer;                                          // 0x0060   (0x0008)  
};
...
/// Struct /Script/CoreUObject.UnicodeStringLength
/// Size: 0x0008 (8 bytes) (0x000000 - 0x000008) align 4 MaxSize: 0x0008
struct FUnicodeStringLength
{ 
	EStringMeasurementUnits                            Units;                                                      // 0x0000   (0x0001)  
	unsigned char                                      UnknownData00_6[0x3];                                       // 0x0001   (0x0003)  MISSED
...
static_assert(sizeof(UGCObjectReferencer) == 0x0040); // 64 bytes (0x000030 - 0x000040)
...
static_assert(sizeof(UPackage) == 0x00A8); // 168 bytes (0x000030 - 0x0000A8)
static_assert(sizeof(UClass) == 0x0210); // 528 bytes (0x0000B8 - 0x000210)
...
static_assert(sizeof(USparseDelegateFunction) == 0x0100); // 256 bytes (0x0000E8 - 0x000100)
static_assert(sizeof(UDynamicClass) == 0x0290); // 656 bytes (0x000210 - 0x000290)
static_assert(sizeof(UPackageMap) == 0x00E8); // 232 bytes (0x000030 - 0x0000E8)
static_assert(sizeof(UEnum) == 0x0078); // 120 bytes (0x000038 - 0x000078)
static_assert(sizeof(UObjectReachabilityStressData) == 0x0040); // 64 bytes (0x000030 - 0x000040)
static_assert(sizeof(UInterface) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(ULinkerPlaceholderClass) == 0x03D0); // 976 bytes (0x000210 - 0x0003D0)
static_assert(sizeof(ULinkerPlaceholderExportObject) == 0x0100); // 256 bytes (0x000030 - 0x000100)
static_assert(sizeof(ULinkerPlaceholderFunction) == 0x02A8); // 680 bytes (0x0000E8 - 0x0002A8)
...
static_assert(sizeof(UProperty) == 0x0080); // 128 bytes (0x000038 - 0x000080)
static_assert(sizeof(UEnumProperty) == 0x0090); // 144 bytes (0x000080 - 0x000090)
static_assert(sizeof(UArrayProperty) == 0x0088); // 136 bytes (0x000080 - 0x000088)
static_assert(sizeof(UObjectPropertyBase) == 0x0088); // 136 bytes (0x000080 - 0x000088)
static_assert(sizeof(UBoolProperty) == 0x0088); // 136 bytes (0x000080 - 0x000088)
static_assert(sizeof(UNumericProperty) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UByteProperty) == 0x0088); // 136 bytes (0x000080 - 0x000088)
static_assert(sizeof(UObjectProperty) == 0x0088); // 136 bytes (0x000088 - 0x000088)
static_assert(sizeof(UClassProperty) == 0x0090); // 144 bytes (0x000088 - 0x000090)
static_assert(sizeof(UDelegateProperty) == 0x0088); // 136 bytes (0x000080 - 0x000088)
static_assert(sizeof(UDoubleProperty) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UFloatProperty) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UIntProperty) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UInt8Property) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UInt16Property) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UInt64Property) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UInterfaceProperty) == 0x0088); // 136 bytes (0x000080 - 0x000088)
static_assert(sizeof(ULazyObjectProperty) == 0x0088); // 136 bytes (0x000088 - 0x000088)
static_assert(sizeof(UMapProperty) == 0x00A8); // 168 bytes (0x000080 - 0x0000A8)
static_assert(sizeof(UMulticastDelegateProperty) == 0x0088); // 136 bytes (0x000080 - 0x000088)
static_assert(sizeof(UMulticastInlineDelegateProperty) == 0x0088); // 136 bytes (0x000088 - 0x000088)
static_assert(sizeof(UMulticastSparseDelegateProperty) == 0x0088); // 136 bytes (0x000088 - 0x000088)
static_assert(sizeof(UNameProperty) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(USetProperty) == 0x00A0); // 160 bytes (0x000080 - 0x0000A0)
static_assert(sizeof(USoftObjectProperty) == 0x0088); // 136 bytes (0x000088 - 0x000088)
static_assert(sizeof(USoftClassProperty) == 0x0090); // 144 bytes (0x000088 - 0x000090)
static_assert(sizeof(UStrProperty) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UStructProperty) == 0x0088); // 136 bytes (0x000080 - 0x000088)
static_assert(sizeof(UUInt16Property) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UUInt32Property) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UUInt64Property) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UWeakObjectProperty) == 0x0088); // 136 bytes (0x000088 - 0x000088)
static_assert(sizeof(UTextProperty) == 0x0080); // 128 bytes (0x000080 - 0x000080)
...
static_assert(sizeof(FTopLevelAssetPath) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(FSoftObjectPath) == 0x0028); // 40 bytes (0x000000 - 0x000028)
static_assert(sizeof(FARFilter) == 0x0150); // 336 bytes (0x000000 - 0x000150)
static_assert(sizeof(FAssetBundleEntry) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FAssetBundleData) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FAssetData) == 0x0080); // 128 bytes (0x000000 - 0x000080)
...
static_assert(sizeof(FPrimaryAssetType) == 0x000C); // 12 bytes (0x000000 - 0x00000C)
static_assert(sizeof(FPrimaryAssetId) == 0x0018); // 24 bytes (0x000000 - 0x000018)
...
static_assert(sizeof(FRandomStream) == 0x0018); // 24 bytes (0x000000 - 0x000018)
...
static_assert(sizeof(FSoftClassPath) == 0x0028); // 40 bytes (0x000028 - 0x000028)
...
static_assert(sizeof(FTestUndeclaredScriptStructObjectReferencesTest) == 0x0068); // 104 bytes (0x000000 - 0x000068)
...
static_assert(sizeof(FUnicodeStringLength) == 0x0008); // 8 bytes (0x000000 - 0x000008)
...
static_assert(offsetof(UObject, OuterPrivate) == 0x0024);
...
static_assert(offsetof(FTopLevelAssetPath, AssetName) == 0x000C);
static_assert(offsetof(FSoftObjectPath, AssetPath) == 0x0000);
static_assert(offsetof(FSoftObjectPath, SubPathString) == 0x0018);
...
static_assert(offsetof(FAssetBundleEntry, AssetPaths) == 0x0010);
static_assert(offsetof(FAssetBundleData, Bundles) == 0x0000);
static_assert(offsetof(FAssetData, PackageName) == 0x0000);
static_assert(offsetof(FAssetData, PackagePath) == 0x000C);
static_assert(offsetof(FAssetData, AssetName) == 0x0018);
static_assert(offsetof(FAssetData, AssetClass) == 0x0024);
static_assert(offsetof(FAssetData, AssetClassPath) == 0x0030);
...
static_assert(offsetof(FPrimaryAssetId, PrimaryAssetName) == 0x000C);
...
static_assert(offsetof(FTestUndeclaredScriptStructObjectReferencesTest, SoftObjectPath) == 0x0038);
static_assert(offsetof(FTestUndeclaredScriptStructObjectReferencesTest, WeakObjectPointer) == 0x0060);
...
static_assert(offsetof(FUnicodeStringLength, Units) == 0x0000);
