...
{ 
	FSoftObjectPath                                    LibraryNode;                                                // 0x0000   (0x0028)  
	FSoftObjectPath                                    HostObject;                                                 // 0x0028   (0x0028)  
};
...
{ 
	...
	FName                                              CPPType;                                                    // 0x0018   (0x000C)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x0024   (0x0004)  MISSED
	TWeakObjectPtr<class UObject*>                     CPPTypeObject;                                              // 0x0028   (0x0008)  
	unsigned char                                      UnknownData01_6[0x28];                                      // 0x0030   (0x0028)  MISSED
	bool                                               bIsArray;                                                   // 0x0058   (0x0001)  
	ERigVMPinDirection                                 Direction;                                                  // 0x0059   (0x0001)  
	unsigned char                                      UnknownData02_6[0x6];                                       // 0x005A   (0x0006)  MISSED
	FString                                            DefaultValue;                                               // 0x0060   (0x0010)  
	bool                                               bIsConst;                                                   // 0x0070   (0x0001)  
	unsigned char                                      UnknownData03_6[0x7];                                       // 0x0071   (0x0007)  MISSED
	TMap<FString, FText>                               PathToTooltip;                                              // 0x0078   (0x0050)  
};
...
{ 
	FRigVMGraphFunctionIdentifier                      LibraryPointer;                                             // 0x0000   (0x0050)  
	FName                                              Name;                                                       // 0x0050   (0x000C)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x005C   (0x0004)  MISSED
	FString                                            NodeTitle;                                                  // 0x0060   (0x0010)  
	FLinearColor                                       NodeColor;                                                  // 0x0070   (0x0010)  
	FText                                              ToolTip;                                                    // 0x0080   (0x0018)  
	FString                                            Category;                                                   // 0x0098   (0x0010)  
	FString                                            Keywords;                                                   // 0x00A8   (0x0010)  
	TArray<FRigVMGraphFunctionArgument>                Arguments;                                                  // 0x00B8   (0x0010)  
	TMap<FRigVMGraphFunctionIdentifier, uint32_t>      Dependencies;                                               // 0x00C8   (0x0050)  
	TArray<FRigVMExternalVariable>                     ExternalVariables;                                          // 0x0118   (0x0010)  
};
...
{ 
	...
	FName                                              Label;                                                      // 0x0004   (0x000C)  
	int32_t                                            InstructionIndex;                                           // 0x0010   (0x0004)  
	int32_t                                            ArgumentIndex;                                              // 0x0014   (0x0004)  
	uint16_t                                           FirstInstruction;                                           // 0x0018   (0x0002)  
	uint16_t                                           LastInstruction;                                            // 0x001A   (0x0002)  
};
...
{ 
	...
	unsigned char                                      UnknownData01_7[0x58];                                      // 0x0048   (0x0058)  MISSED
};
...
{ 
	...
	TWeakObjectPtr<class UObject*>                     CPPTypeObject;                                              // 0x0020   (0x0008)  
	unsigned char                                      UnknownData01_6[0x28];                                      // 0x0028   (0x0028)  MISSED
...
{ 
	FRigVMByteCode                                     ByteCode;                                                   // 0x0000   (0x00A0)  
	TArray<FName>                                      FunctionNames;                                              // 0x00A0   (0x0010)  
	TArray<FRigVMFunctionCompilationPropertyDescription> WorkPropertyDescriptions;                                 // 0x00B0   (0x0010)  
	TArray<FRigVMFunctionCompilationPropertyPath>      WorkPropertyPathDescriptions;                               // 0x00C0   (0x0010)  
	TArray<FRigVMFunctionCompilationPropertyDescription> LiteralPropertyDescriptions;                              // 0x00D0   (0x0010)  
	TArray<FRigVMFunctionCompilationPropertyPath>      LiteralPropertyPathDescriptions;                            // 0x00E0   (0x0010)  
	TArray<FRigVMFunctionCompilationPropertyDescription> DebugPropertyDescriptions;                                // 0x00F0   (0x0010)  
	...
	TMap<int32_t, FName>                               ExternalRegisterIndexToVariable;                            // 0x0130   (0x0050)  
	TMap<FString, FRigVMOperand>                       Operands;                                                   // 0x0180   (0x0050)  
	uint32_t                                           Hash;                                                       // 0x01D0   (0x0004)  
	unsigned char                                      UnknownData00_7[0x54];                                      // 0x01D4   (0x0054)  MISSED
};
...
{ 
	FRigVMGraphFunctionHeader                          Header;                                                     // 0x0000   (0x0128)  
	FRigVMFunctionCompilationData                      CompilationData;                                            // 0x0128   (0x0228)  
...
/// Size: 0x03A0 (928 bytes) (0x000378 - 0x0003A0) align 8 MaxSize: 0x03A0
class URigVMBlueprintGeneratedClass : public UBlueprintGeneratedClass
{ 
public:
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0378   (0x0008)  MISSED
	FRigVMGraphFunctionStore                           GraphFunctionStore;                                         // 0x0380   (0x0020)  
};
...
{ 
public:
	class URigVMMemoryStorage*                         WorkMemoryStorageObject;                                    // 0x0030   (0x0008)  
	class URigVMMemoryStorage*                         LiteralMemoryStorageObject;                                 // 0x0038   (0x0008)  
	class URigVMMemoryStorage*                         DebugMemoryStorageObject;                                   // 0x0040   (0x0008)  
	unsigned char                                      UnknownData00_6[0x20];                                      // 0x0048   (0x0020)  MISSED
	FRigVMByteCode                                     ByteCodeStorage;                                            // 0x0068   (0x00A0)  
	unsigned char                                      UnknownData01_6[0x8];                                       // 0x0108   (0x0008)  MISSED
	FRigVMInstructionArray                             Instructions;                                               // 0x0110   (0x0010)  
	unsigned char                                      UnknownData02_6[0x8];                                       // 0x0120   (0x0008)  MISSED
	TArray<FName>                                      FunctionNamesStorage;                                       // 0x0128   (0x0010)  
	unsigned char                                      UnknownData03_6[0x38];                                      // 0x0138   (0x0038)  MISSED
	TArray<FRigVMParameter>                            Parameters;                                                 // 0x0170   (0x0010)  
	TMap<FName, int32_t>                               ParametersNameMap;                                          // 0x0180   (0x0050)  
	unsigned char                                      UnknownData04_6[0x98];                                      // 0x01D0   (0x0098)  MISSED
	class URigVM*                                      DeferredVMToCopy;                                           // 0x0268   (0x0008)  
	unsigned char                                      UnknownData05_7[0x40];                                      // 0x0270   (0x0040)  MISSED


	/// Functions
	// Function /Script/RigVM.RigVM.SetParameterValueVector2D
	// void SetParameterValueVector2D(FName& InParameterName, FVector2D& InValue, int32_t InArrayIndex);                        // [0x72458c0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueVector
	// void SetParameterValueVector(FName& InParameterName, FVector& InValue, int32_t InArrayIndex);                            // [0x7245570] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueTransform
	// void SetParameterValueTransform(FName& InParameterName, FTransform& InValue, int32_t InArrayIndex);                      // [0x7244e50] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueString
	// void SetParameterValueString(FName& InParameterName, FString InValue, int32_t InArrayIndex);                             // [0x7245bf0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueQuat
	// void SetParameterValueQuat(FName& InParameterName, FQuat& InValue, int32_t InArrayIndex);                                // [0x7245230] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueName
	// void SetParameterValueName(FName& InParameterName, FName& InValue, int32_t InArrayIndex);                                // [0x7245f90] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueInt
	// void SetParameterValueInt(FName& InParameterName, int32_t InValue, int32_t InArrayIndex);                                // [0x72462d0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueFloat
	// void SetParameterValueFloat(FName& InParameterName, float InValue, int32_t InArrayIndex);                                // [0x7246910] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueDouble
	// void SetParameterValueDouble(FName& InParameterName, double InValue, int32_t InArrayIndex);                              // [0x72465e0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueBool
	// void SetParameterValueBool(FName& InParameterName, bool InValue, int32_t InArrayIndex);                                  // [0x7246c30] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetStatistics
	// FRigVMStatistics GetStatistics();                                                                                        // [0x7244cc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RigVM.RigVM.GetRigVMFunctionName
	// FString GetRigVMFunctionName(int32_t InFunctionIndex);                                                                   // [0x7248220] Native|Public|Const  
	// Function /Script/RigVM.RigVM.GetParameterValueVector2D
	// FVector2D GetParameterValueVector2D(FName& InParameterName, int32_t InArrayIndex);                                       // [0x7247580] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueVector
	// FVector GetParameterValueVector(FName& InParameterName, int32_t InArrayIndex);                                           // [0x7247380] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueTransform
	// FTransform GetParameterValueTransform(FName& InParameterName, int32_t InArrayIndex);                                     // [0x7246f40] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueString
	// FString GetParameterValueString(FName& InParameterName, int32_t InArrayIndex);                                           // [0x7247760] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueQuat
	// FQuat GetParameterValueQuat(FName& InParameterName, int32_t InArrayIndex);                                               // [0x7247190] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueName
	// FName GetParameterValueName(FName& InParameterName, int32_t InArrayIndex);                                               // [0x7247980] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueInt
	// int32_t GetParameterValueInt(FName& InParameterName, int32_t InArrayIndex);                                              // [0x7247b60] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueFloat
	// float GetParameterValueFloat(FName& InParameterName, int32_t InArrayIndex);                                              // [0x7247ec0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueDouble
	// double GetParameterValueDouble(FName& InParameterName, int32_t InArrayIndex);                                            // [0x7247d10] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueBool
	// bool GetParameterValueBool(FName& InParameterName, int32_t InArrayIndex);                                                // [0x7248070] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.Execute
	// bool Execute(FRigVMExtendedExecuteContext& Context, FName& InEntryName);                                                 // [0x7248550] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.AddRigVMFunction
	// int32_t AddRigVMFunction(class UScriptStruct* InRigVMStruct, FName& InMethodName);                                       // [0x7248390] Native|Public|HasOutParms 
};
...
{ 
public:
	FString                                            Namespace;                                                  // 0x0030   (0x0010)  
	unsigned char                                      UnknownData00_7[0xC8];                                      // 0x0040   (0x00C8)  MISSED
};
...
{ 
public:
	class UDataAsset*                                  DataAsset;                                                  // 0x0108   (0x0008)  


	/// Functions
	// Function /Script/RigVM.DataAssetLink.SetDataAsset
	// void SetDataAsset(class UDataAsset* InDataAsset);                                                                        // [0x724fad0] Final|Native|Public|BlueprintCallable 
	// Function /Script/RigVM.DataAssetLink.GetDataAsset
	// class UDataAsset* GetDataAsset();                                                                                        // [0x5206980] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/RigVM.RigVMMemoryStorageGeneratorClass
/// Size: 0x0250 (592 bytes) (0x000210 - 0x000250) align 8 MaxSize: 0x0250
class URigVMMemoryStorageGeneratorClass : public UClass
{ 
public:
	unsigned char                                      UnknownData00_1[0x40];                                      // 0x0210   (0x0040)  MISSED
};
...
/// Size: 0x02D8 (728 bytes) (0x0002B0 - 0x0002D8) align 8 MaxSize: 0x02D8
...
{ 
	...
	SDK_UNDEFINED(20,5094) /* FDelegateProperty */     __um(PerformDynamicDelegate);                               // 0x0040   (0x0014)  
	unsigned char                                      UnknownData02_6[0x4];                                       // 0x0054   (0x0004)  MISSED
	class UClass*                                      OptionsClass;                                               // 0x0058   (0x0008)  
};
...
{ 
public:
	class UObject*                                     Subject;                                                    // 0x0030   (0x0008)  
	FRigVMUserWorkflow                                 Workflow;                                                   // 0x0038   (0x0060)  
	unsigned char                                      UnknownData00_7[0x10];                                      // 0x0098   (0x0010)  MISSED


	/// Functions
	// Function /Script/RigVM.RigVMUserWorkflowOptions.RequiresDialog
	// bool RequiresDialog();                                                                                                   // [0x728c840] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RigVM.RigVMUserWorkflowOptions.ReportWarning
	// void ReportWarning(FString InMessage);                                                                                   // [0x728c510] Final|Native|Public|BlueprintCallable 
	// Function /Script/RigVM.RigVMUserWorkflowOptions.ReportInfo
	// void ReportInfo(FString InMessage);                                                                                      // [0x728c370] Final|Native|Public|BlueprintCallable 
	// Function /Script/RigVM.RigVMUserWorkflowOptions.ReportError
	// void ReportError(FString InMessage);                                                                                     // [0x728c710] Final|Native|Public|BlueprintCallable 
	// Function /Script/RigVM.RigVMUserWorkflowOptions.IsValid
	// bool IsValid();                                                                                                          // [0x728c920] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
	unsigned char                                      UnknownData00_7[0x8];                                       // 0x0000   (0x0008)  MISSED
	uint32_t                                           VMHash;                                                     // 0x0008   (0x0004)  
	unsigned char                                      UnknownData01_6[0x104];                                     // 0x000C   (0x0104)  MISSED
	uint32_t                                           NumExecutions;                                              // 0x0110   (0x0004)  
	unsigned char                                      UnknownData02_6[0x64];                                      // 0x0114   (0x0064)  MISSED
	class URigVM*                                      DeferredVMToCopy;                                           // 0x0178   (0x0008)  
	unsigned char                                      UnknownData03_7[0x40];                                      // 0x0180   (0x0040)  MISSED
};
...
{ 
	FName                                              Name;                                                       // 0x0000   (0x000C)  
	TEnumAsByte<ERigVMDrawSettings>                    PrimitiveType;                                              // 0x000C   (0x0001)  
...
public:
	...
	FRigVMRuntimeSettings                              VMRuntimeSettings;                                          // 0x0038   (0x0018)  
	unsigned char                                      UnknownData01_6[0x10];                                      // 0x0050   (0x0010)  MISSED
	class URigVM*                                      VM;                                                         // 0x0060   (0x0008)  
	FRigVMExtendedExecuteContext                       ExtendedExecuteContext;                                     // 0x0068   (0x01C0)  
	FRigVMDrawContainer                                DrawContainer;                                              // 0x0228   (0x0018)  
	unsigned char                                      UnknownData02_6[0x18];                                      // 0x0240   (0x0018)  MISSED
	TArray<FName>                                      EventQueue;                                                 // 0x0258   (0x0010)  
	unsigned char                                      UnknownData03_6[0x90];                                      // 0x0268   (0x0090)  MISSED
	TArray<class UAssetUserData*>                      AssetUserData;                                              // 0x02F8   (0x0010)  
	unsigned char                                      UnknownData04_7[0x40];                                      // 0x0308   (0x0040)  MISSED


	/// Functions
	// Function /Script/RigVM.RigVMHost.SupportsEvent
	// bool SupportsEvent(FName& InEventName);                                                                                  // [0x733da40] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RigVM.RigVMHost.SetVariableFromString
	// bool SetVariableFromString(FName& InVariableName, FString InValue);                                                      // [0x733dc70] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVMHost.SetFramesPerSecond
	// void SetFramesPerSecond(float InFramesPerSecond);                                                                        // [0x733e2a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/RigVM.RigVMHost.SetDeltaTime
	// void SetDeltaTime(float InDeltaTime);                                                                                    // [0x5868830] Final|Native|Public|BlueprintCallable 
	// Function /Script/RigVM.RigVMHost.SetAbsoluteTime
	// void SetAbsoluteTime(float InAbsoluteTime, bool InSetDeltaTimeZero);                                                     // [0x733e520] Final|Native|Public|BlueprintCallable 
	// Function /Script/RigVM.RigVMHost.SetAbsoluteAndDeltaTime
	// void SetAbsoluteAndDeltaTime(float InAbsoluteTime, float InDeltaTime);                                                   // [0x733e390] Final|Native|Public|BlueprintCallable 
	// Function /Script/RigVM.RigVMHost.RequestRunOnceEvent
	// void RequestRunOnceEvent(FName& InEventName, int32_t InEventIndex);                                                      // [0x733d6d0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVMHost.RequestInit
	// void RequestInit();                                                                                                      // [0x3c94d50] Native|Public|BlueprintCallable 
	// Function /Script/RigVM.RigVMHost.RemoveRunOnceEvent
	// bool RemoveRunOnceEvent(FName& InEventName);                                                                             // [0x733d5c0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVMHost.GetVM
	// class URigVM* GetVM();                                                                                                   // [0x733d550] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/RigVM.RigVMHost.GetVariableType
	// FName GetVariableType(FName& InVariableName);                                                                            // [0x733df60] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RigVM.RigVMHost.GetVariableAsString
	// FString GetVariableAsString(FName& InVariableName);                                                                      // [0x733de50] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RigVM.RigVMHost.GetSupportedEvents
	// TArray<FName> GetSupportedEvents();                                                                                      // [0x733d980] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RigVM.RigVMHost.GetScriptAccessibleVariables
	// TArray<FName> GetScriptAccessibleVariables();                                                                            // [0x733e0c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RigVM.RigVMHost.GetExtendedExecuteContext
	// FRigVMExtendedExecuteContext GetExtendedExecuteContext();                                                                // [0x733d510] Native|Public|BlueprintCallable 
	// Function /Script/RigVM.RigVMHost.GetDeltaTime
	// float GetDeltaTime();                                                                                                    // [0x41e79c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RigVM.RigVMHost.GetCurrentFramesPerSecond
	// float GetCurrentFramesPerSecond();                                                                                       // [0x733e240] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RigVM.RigVMHost.GetAbsoluteTime
	// float GetAbsoluteTime();                                                                                                 // [0x3ecbc70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RigVM.RigVMHost.FindRigVMHosts
	// TArray<URigVMHost*> FindRigVMHosts(class UObject* Outer, class UClass* OptionalClass);                                   // [0x733e6d0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/RigVM.RigVMHost.ExecuteEvent
	// bool ExecuteEvent(FName& InEventName);                                                                                   // [0x733d880] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVMHost.Execute
	// bool Execute(FName& InEventName);                                                                                        // [0x733db60] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVMHost.CanExecute
	// bool CanExecute();                                                                                                       // [0x3aeba60] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
	...
	FRigVMExecuteContext                               ExecuteContext;                                             // 0x0010   (0x0100)  
};
...
/// Size: 0x0310 (784 bytes) (0x000008 - 0x000310) align 16 MaxSize: 0x0310
struct FRigVMFunction_Sequence : FRigVMStruct
{ 
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0008   (0x0008)  MISSED
	FRigVMExecuteContext                               ExecuteContext;                                             // 0x0010   (0x0100)  
	FRigVMExecuteContext                               A;                                                          // 0x0110   (0x0100)  
	FRigVMExecuteContext                               B;                                                          // 0x0210   (0x0100)  
};
...
/// Size: 0x0010 (16 bytes) (0x000001 - 0x000010) align 4 MaxSize: 0x0010
...
{ 
	FName                                              CPPType;                                                    // 0x0000   (0x000C)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x000C   (0x0004)  MISSED
	class UObject*                                     CPPTypeObject;                                              // 0x0010   (0x0008)  
};
...
/// Size: 0x01C0 (448 bytes) (0x000110 - 0x0001C0) align 16 MaxSize: 0x01C0
struct FRigVMFunction_DebugPointMutable : FRigVMFunction_DebugBaseMutable
{ 
	FVector                                            Vector;                                                     // 0x0110   (0x0018)  
	ERigUnitDebugPointMode                             Mode;                                                       // 0x0128   (0x0001)  
	unsigned char                                      UnknownData00_6[0x3];                                       // 0x0129   (0x0003)  MISSED
	FLinearColor                                       Color;                                                      // 0x012C   (0x0010)  
	float                                              Scale;                                                      // 0x013C   (0x0004)  
	float                                              Thickness;                                                  // 0x0140   (0x0004)  
	FName                                              Space;                                                      // 0x0144   (0x000C)  
...
{ 
	FTransform                                         Transform;                                                  // 0x0110   (0x0060)  
	FLinearColor                                       Color;                                                      // 0x0170   (0x0010)  
	float                                              Scale;                                                      // 0x0180   (0x0004)  
	float                                              Thickness;                                                  // 0x0184   (0x0004)  
	FName                                              Space;                                                      // 0x0188   (0x000C)  
...
/// Size: 0x0200 (512 bytes) (0x000110 - 0x000200) align 16 MaxSize: 0x0200
...
{ 
	...
	float                                              MinimumDegrees;                                             // 0x0184   (0x0004)  
	float                                              MaximumDegrees;                                             // 0x0188   (0x0004)  
	float                                              Thickness;                                                  // 0x018C   (0x0004)  
	int32_t                                            Detail;                                                     // 0x0190   (0x0004)  
...
{ 
	FTransform                                         Transform;                                                  // 0x0110   (0x0060)  
	ERigUnitDebugTransformMode                         Mode;                                                       // 0x0170   (0x0001)  
...
{ 
	TArray<FTransform>                                 Transforms;                                                 // 0x0110   (0x0010)  
	TArray<int32_t>                                    ParentIndices;                                              // 0x0120   (0x0010)  
	ERigUnitDebugTransformMode                         Mode;                                                       // 0x0130   (0x0001)  
	unsigned char                                      UnknownData00_6[0x3];                                       // 0x0131   (0x0003)  MISSED
	FLinearColor                                       Color;                                                      // 0x0134   (0x0010)  
	float                                              Thickness;                                                  // 0x0144   (0x0004)  
	float                                              Scale;                                                      // 0x0148   (0x0004)  
...
/// Size: 0x0230 (560 bytes) (0x000110 - 0x000230) align 16 MaxSize: 0x0230
struct FRigVMFunction_ForLoopCount : FRigVMStructMutable
{ 
	FName                                              BlockToRun;                                                 // 0x0110   (0x000C)  
	int32_t                                            Count;                                                      // 0x011C   (0x0004)  
	int32_t                                            Index;                                                      // 0x0120   (0x0004)  
	float                                              Ratio;                                                      // 0x0124   (0x0004)  
	unsigned char                                      UnknownData00_6[0x8];                                       // 0x0128   (0x0008)  MISSED
	FRigVMExecuteContext                               Completed;                                                  // 0x0130   (0x0100)  
};
...
{ 
	TArray<FTransform>                                 Transforms;                                                 // 0x0110   (0x0010)  
	ERigVMTransformSpace                               TargetSpace;                                                // 0x0120   (0x0001)  
	unsigned char                                      UnknownData00_6[0xF];                                       // 0x0121   (0x000F)  MISSED
	FTransform                                         Root;                                                       // 0x0130   (0x0060)  
	TArray<int32_t>                                    ParentIndices;                                              // 0x0190   (0x0010)  
};
...
{ 
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0008   (0x0008)  MISSED
	FRigVMExecuteContext                               ExecuteContext;                                             // 0x0010   (0x0100)  
	bool                                               Condition;                                                  // 0x0110   (0x0001)  
	unsigned char                                      UnknownData01_6[0xF];                                       // 0x0111   (0x000F)  MISSED
	FRigVMExecuteContext                               TRUE0;                                                      // 0x0120   (0x0100)  
	FRigVMExecuteContext                               FALSE0;                                                     // 0x0220   (0x0100)  
	FRigVMExecuteContext                               Completed;                                                  // 0x0320   (0x0100)  
	FName                                              BlockToRun;                                                 // 0x0420   (0x000C)  
	unsigned char                                      UnknownData02_7[0x4];                                       // 0x042C   (0x0004)  MISSED
};
...
static_assert(sizeof(URigVMGraphFunctionHost) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(FRigVMGraphFunctionIdentifier) == 0x0050); // 80 bytes (0x000000 - 0x000050)
static_assert(sizeof(FRigVMGraphFunctionArgument) == 0x00C8); // 200 bytes (0x000000 - 0x0000C8)
static_assert(sizeof(FRigVMExternalVariableDef) == 0x0038); // 56 bytes (0x000000 - 0x000038)
static_assert(sizeof(FRigVMExternalVariable) == 0x0040); // 64 bytes (0x000038 - 0x000040)
static_assert(sizeof(FRigVMGraphFunctionHeader) == 0x0128); // 296 bytes (0x000000 - 0x000128)
static_assert(sizeof(FRigVMByteCodeEntry) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FRigVMBranchInfo) == 0x001C); // 28 bytes (0x000000 - 0x00001C)
static_assert(sizeof(FRigVMPredicateBranch) == 0x0038); // 56 bytes (0x000000 - 0x000038)
static_assert(sizeof(FRigVMByteCode) == 0x00A0); // 160 bytes (0x000000 - 0x0000A0)
static_assert(sizeof(FRigVMFunctionCompilationPropertyDescription) == 0x0060); // 96 bytes (0x000000 - 0x000060)
...
static_assert(sizeof(FRigVMFunctionCompilationData) == 0x0228); // 552 bytes (0x000000 - 0x000228)
...
static_assert(sizeof(URigVMBlueprintGeneratedClass) == 0x03A0); // 928 bytes (0x000378 - 0x0003A0)
...
static_assert(sizeof(FRigVMParameter) == 0x0040); // 64 bytes (0x000000 - 0x000040)
static_assert(sizeof(URigVM) == 0x02B0); // 688 bytes (0x000030 - 0x0002B0)
static_assert(sizeof(UNameSpacedUserData) == 0x0108); // 264 bytes (0x000030 - 0x000108)
static_assert(sizeof(UDataAssetLink) == 0x0110); // 272 bytes (0x000108 - 0x000110)
static_assert(sizeof(URigVMMemoryStorageGeneratorClass) == 0x0250); // 592 bytes (0x000210 - 0x000250)
static_assert(sizeof(URigVMMemoryStorage) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(URigVMNativized) == 0x02D8); // 728 bytes (0x0002B0 - 0x0002D8)
static_assert(sizeof(FRigVMUserWorkflow) == 0x0060); // 96 bytes (0x000000 - 0x000060)
static_assert(sizeof(URigVMUserWorkflowOptions) == 0x00A8); // 168 bytes (0x000030 - 0x0000A8)
static_assert(sizeof(FRigVMRuntimeSettings) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(FRigVMExtendedExecuteContext) == 0x01C0); // 448 bytes (0x000000 - 0x0001C0)
...
static_assert(sizeof(URigVMHost) == 0x0348); // 840 bytes (0x000030 - 0x000348)
static_assert(sizeof(URigVMEditorSettings) == 0x0048); // 72 bytes (0x000048 - 0x000048)
static_assert(sizeof(FRigVMStruct) == 0x0008); // 8 bytes (0x000000 - 0x000008)
static_assert(sizeof(FRigVMDecorator) == 0x0020); // 32 bytes (0x000008 - 0x000020)
...
static_assert(sizeof(FRigVMExecuteContext) == 0x0100); // 256 bytes (0x000000 - 0x000100)
static_assert(sizeof(FRigVMStructMutable) == 0x0110); // 272 bytes (0x000008 - 0x000110)
static_assert(sizeof(FRigVMFunction_DebugBaseMutable) == 0x0110); // 272 bytes (0x000110 - 0x000110)
static_assert(sizeof(FRigVMFunction_MathBase) == 0x0008); // 8 bytes (0x000008 - 0x000008)
static_assert(sizeof(FRigVMFunction_MathMutableBase) == 0x0110); // 272 bytes (0x000110 - 0x000110)
static_assert(sizeof(FRigVMFunction_Sequence) == 0x0310); // 784 bytes (0x000008 - 0x000310)
...
static_assert(sizeof(FRigVMFunction_SimBaseMutable) == 0x0110); // 272 bytes (0x000110 - 0x000110)
...
static_assert(sizeof(FRigVMInvokeEntryOp) == 0x0010); // 16 bytes (0x000001 - 0x000010)
...
static_assert(sizeof(FRigVMRegister) == 0x0028); // 40 bytes (0x000000 - 0x000028)
...
static_assert(sizeof(FRigVMTemplateArgumentType) == 0x0018); // 24 bytes (0x000000 - 0x000018)
...
static_assert(sizeof(FRigVMFunction_DebugLineNoSpace) == 0x01D0); // 464 bytes (0x000110 - 0x0001D0)
static_assert(sizeof(FRigVMFunction_DebugLineStripNoSpace) == 0x01B0); // 432 bytes (0x000110 - 0x0001B0)
static_assert(sizeof(FRigVMFunction_DebugPoint) == 0x00C0); // 192 bytes (0x000008 - 0x0000C0)
static_assert(sizeof(FRigVMFunction_DebugPointMutable) == 0x01C0); // 448 bytes (0x000110 - 0x0001C0)
static_assert(sizeof(FRigVMFunction_DebugRectangle) == 0x0210); // 528 bytes (0x000110 - 0x000210)
static_assert(sizeof(FRigVMFunction_DebugRectangleNoSpace) == 0x0200); // 512 bytes (0x000110 - 0x000200)
static_assert(sizeof(FRigVMFunction_DebugArc) == 0x0210); // 528 bytes (0x000110 - 0x000210)
static_assert(sizeof(FRigVMFunction_DebugArcNoSpace) == 0x0210); // 528 bytes (0x000110 - 0x000210)
static_assert(sizeof(FRigVMFunction_DebugTransformMutableNoSpace) == 0x0200); // 512 bytes (0x000110 - 0x000200)
static_assert(sizeof(FRigVMFunction_DebugTransformArrayMutable_WorkData) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FRigVMFunction_DebugTransformArrayMutableNoSpace) == 0x01C0); // 448 bytes (0x000110 - 0x0001C0)
...
static_assert(sizeof(FRigVMFunction_ForLoopCount) == 0x0230); // 560 bytes (0x000110 - 0x000230)
static_assert(sizeof(FRigVMFunction_UserDefinedEvent) == 0x0120); // 288 bytes (0x000008 - 0x000120)
...
static_assert(sizeof(FRigVMFunction_MathIntToName) == 0x0020); // 32 bytes (0x000008 - 0x000020)
...
static_assert(sizeof(FRigVMFunction_MathTransformMutableBase) == 0x0110); // 272 bytes (0x000110 - 0x000110)
...
static_assert(sizeof(FRigVMFunction_MathTransformAccumulateArray) == 0x01A0); // 416 bytes (0x000110 - 0x0001A0)
...
static_assert(sizeof(FRigVMFunction_ControlFlowBranch) == 0x0430); // 1072 bytes (0x000008 - 0x000430)
static_assert(sizeof(FRigVMFunction_NameBase) == 0x0008); // 8 bytes (0x000008 - 0x000008)
static_assert(sizeof(FRigVMFunction_NameConcat) == 0x0030); // 48 bytes (0x000008 - 0x000030)
static_assert(sizeof(FRigVMFunction_NameTruncate) == 0x0038); // 56 bytes (0x000008 - 0x000038)
static_assert(sizeof(FRigVMFunction_NameReplace) == 0x0038); // 56 bytes (0x000008 - 0x000038)
static_assert(sizeof(FRigVMFunction_EndsWith) == 0x0028); // 40 bytes (0x000008 - 0x000028)
static_assert(sizeof(FRigVMFunction_StartsWith) == 0x0028); // 40 bytes (0x000008 - 0x000028)
static_assert(sizeof(FRigVMFunction_Contains) == 0x0028); // 40 bytes (0x000008 - 0x000028)
...
static_assert(offsetof(FRigVMGraphFunctionIdentifier, HostObject) == 0x0028);
static_assert(offsetof(FRigVMGraphFunctionArgument, Name) == 0x0000);
static_assert(offsetof(FRigVMGraphFunctionArgument, DisplayName) == 0x000C);
static_assert(offsetof(FRigVMGraphFunctionArgument, CPPType) == 0x0018);
static_assert(offsetof(FRigVMGraphFunctionArgument, CPPTypeObject) == 0x0028);
static_assert(offsetof(FRigVMGraphFunctionArgument, Direction) == 0x0059);
static_assert(offsetof(FRigVMGraphFunctionArgument, DefaultValue) == 0x0060);
static_assert(offsetof(FRigVMGraphFunctionArgument, PathToTooltip) == 0x0078);
static_assert(offsetof(FRigVMGraphFunctionHeader, LibraryPointer) == 0x0000);
static_assert(offsetof(FRigVMGraphFunctionHeader, Name) == 0x0050);
static_assert(offsetof(FRigVMGraphFunctionHeader, NodeTitle) == 0x0060);
static_assert(offsetof(FRigVMGraphFunctionHeader, NodeColor) == 0x0070);
static_assert(offsetof(FRigVMGraphFunctionHeader, ToolTip) == 0x0080);
static_assert(offsetof(FRigVMGraphFunctionHeader, Category) == 0x0098);
static_assert(offsetof(FRigVMGraphFunctionHeader, Keywords) == 0x00A8);
static_assert(offsetof(FRigVMGraphFunctionHeader, Arguments) == 0x00B8);
static_assert(offsetof(FRigVMGraphFunctionHeader, Dependencies) == 0x00C8);
static_assert(offsetof(FRigVMGraphFunctionHeader, ExternalVariables) == 0x0118);
...
static_assert(offsetof(FRigVMFunctionCompilationPropertyDescription, CPPType) == 0x0010);
static_assert(offsetof(FRigVMFunctionCompilationPropertyDescription, CPPTypeObject) == 0x0020);
static_assert(offsetof(FRigVMFunctionCompilationPropertyDescription, DefaultValue) == 0x0050);
...
static_assert(offsetof(FRigVMFunctionCompilationData, FunctionNames) == 0x00A0);
static_assert(offsetof(FRigVMFunctionCompilationData, WorkPropertyDescriptions) == 0x00B0);
static_assert(offsetof(FRigVMFunctionCompilationData, WorkPropertyPathDescriptions) == 0x00C0);
static_assert(offsetof(FRigVMFunctionCompilationData, LiteralPropertyDescriptions) == 0x00D0);
static_assert(offsetof(FRigVMFunctionCompilationData, LiteralPropertyPathDescriptions) == 0x00E0);
static_assert(offsetof(FRigVMFunctionCompilationData, DebugPropertyDescriptions) == 0x00F0);
static_assert(offsetof(FRigVMFunctionCompilationData, DebugPropertyPathDescriptions) == 0x0100);
static_assert(offsetof(FRigVMFunctionCompilationData, ExternalPropertyDescriptions) == 0x0110);
static_assert(offsetof(FRigVMFunctionCompilationData, ExternalPropertyPathDescriptions) == 0x0120);
static_assert(offsetof(FRigVMFunctionCompilationData, ExternalRegisterIndexToVariable) == 0x0130);
static_assert(offsetof(FRigVMFunctionCompilationData, Operands) == 0x0180);
static_assert(offsetof(FRigVMGraphFunctionData, Header) == 0x0000);
static_assert(offsetof(FRigVMGraphFunctionData, CompilationData) == 0x0128);
...
static_assert(offsetof(URigVMBlueprintGeneratedClass, GraphFunctionStore) == 0x0380);
...
static_assert(offsetof(FRigVMParameter, CPPType) == 0x0018);
static_assert(offsetof(FRigVMParameter, ScriptStruct) == 0x0028);
static_assert(offsetof(FRigVMParameter, ScriptStructPath) == 0x0030);
static_assert(offsetof(URigVM, WorkMemoryStorageObject) == 0x0030);
static_assert(offsetof(URigVM, LiteralMemoryStorageObject) == 0x0038);
static_assert(offsetof(URigVM, DebugMemoryStorageObject) == 0x0040);
static_assert(offsetof(URigVM, ByteCodeStorage) == 0x0068);
static_assert(offsetof(URigVM, Instructions) == 0x0110);
static_assert(offsetof(URigVM, FunctionNamesStorage) == 0x0128);
static_assert(offsetof(URigVM, Parameters) == 0x0170);
static_assert(offsetof(URigVM, ParametersNameMap) == 0x0180);
static_assert(offsetof(URigVM, DeferredVMToCopy) == 0x0268);
static_assert(offsetof(UNameSpacedUserData, Namespace) == 0x0030);
static_assert(offsetof(UDataAssetLink, DataAsset) == 0x0108);
...
static_assert(offsetof(FRigVMUserWorkflow, OptionsClass) == 0x0058);
static_assert(offsetof(URigVMUserWorkflowOptions, Subject) == 0x0030);
static_assert(offsetof(URigVMUserWorkflowOptions, Workflow) == 0x0038);
static_assert(offsetof(FRigVMExtendedExecuteContext, DeferredVMToCopy) == 0x0178);
static_assert(offsetof(FRigVMDrawInstruction, Name) == 0x0000);
static_assert(offsetof(FRigVMDrawInstruction, PrimitiveType) == 0x000C);
...
static_assert(offsetof(URigVMHost, VMRuntimeSettings) == 0x0038);
static_assert(offsetof(URigVMHost, VM) == 0x0060);
static_assert(offsetof(URigVMHost, ExtendedExecuteContext) == 0x0068);
static_assert(offsetof(URigVMHost, DrawContainer) == 0x0228);
static_assert(offsetof(URigVMHost, EventQueue) == 0x0258);
static_assert(offsetof(URigVMHost, AssetUserData) == 0x02F8);
...
static_assert(offsetof(FRigVMFunction_Sequence, A) == 0x0110);
static_assert(offsetof(FRigVMFunction_Sequence, B) == 0x0210);
...
static_assert(offsetof(FRigVMTemplateArgumentType, CPPTypeObject) == 0x0010);
...
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, A) == 0x0110);
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, B) == 0x0128);
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, Color) == 0x0140);
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, WorldOffset) == 0x0160);
static_assert(offsetof(FRigVMFunction_DebugLineStripNoSpace, Points) == 0x0110);
static_assert(offsetof(FRigVMFunction_DebugLineStripNoSpace, Color) == 0x0120);
static_assert(offsetof(FRigVMFunction_DebugLineStripNoSpace, WorldOffset) == 0x0140);
...
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Vector) == 0x0110);
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Mode) == 0x0128);
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Color) == 0x012C);
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Space) == 0x0144);
static_assert(offsetof(FRigVMFunction_DebugPointMutable, WorldOffset) == 0x0150);
static_assert(offsetof(FRigVMFunction_DebugRectangle, Transform) == 0x0110);
static_assert(offsetof(FRigVMFunction_DebugRectangle, Color) == 0x0170);
static_assert(offsetof(FRigVMFunction_DebugRectangle, Space) == 0x0188);
static_assert(offsetof(FRigVMFunction_DebugRectangle, WorldOffset) == 0x01A0);
static_assert(offsetof(FRigVMFunction_DebugRectangleNoSpace, Transform) == 0x0110);
static_assert(offsetof(FRigVMFunction_DebugRectangleNoSpace, Color) == 0x0170);
static_assert(offsetof(FRigVMFunction_DebugRectangleNoSpace, WorldOffset) == 0x0190);
static_assert(offsetof(FRigVMFunction_DebugArc, Transform) == 0x0110);
static_assert(offsetof(FRigVMFunction_DebugArc, Color) == 0x0170);
static_assert(offsetof(FRigVMFunction_DebugArc, Space) == 0x0194);
static_assert(offsetof(FRigVMFunction_DebugArc, WorldOffset) == 0x01A0);
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, Transform) == 0x0110);
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, Color) == 0x0170);
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, WorldOffset) == 0x01A0);
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, Transform) == 0x0110);
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, Mode) == 0x0170);
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, Color) == 0x0174);
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, WorldOffset) == 0x0190);
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable_WorkData, DrawTransforms) == 0x0000);
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, Transforms) == 0x0110);
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, ParentIndices) == 0x0120);
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, Mode) == 0x0130);
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, Color) == 0x0134);
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, WorldOffset) == 0x0150);
...
static_assert(offsetof(FRigVMFunction_ForLoopCount, BlockToRun) == 0x0110);
static_assert(offsetof(FRigVMFunction_ForLoopCount, Completed) == 0x0130);
static_assert(offsetof(FRigVMFunction_UserDefinedEvent, ExecuteContext) == 0x0010);
static_assert(offsetof(FRigVMFunction_UserDefinedEvent, EventName) == 0x0110);
...
static_assert(offsetof(FRigVMFunction_MathTransformAccumulateArray, Transforms) == 0x0110);
static_assert(offsetof(FRigVMFunction_MathTransformAccumulateArray, TargetSpace) == 0x0120);
static_assert(offsetof(FRigVMFunction_MathTransformAccumulateArray, Root) == 0x0130);
static_assert(offsetof(FRigVMFunction_MathTransformAccumulateArray, ParentIndices) == 0x0190);
...
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, TRUE0) == 0x0120);
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, FALSE0) == 0x0220);
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, Completed) == 0x0320);
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, BlockToRun) == 0x0420);
static_assert(offsetof(FRigVMFunction_NameConcat, A) == 0x0008);
static_assert(offsetof(FRigVMFunction_NameConcat, B) == 0x0014);
static_assert(offsetof(FRigVMFunction_NameConcat, Result) == 0x0020);
static_assert(offsetof(FRigVMFunction_NameTruncate, Name) == 0x0008);
static_assert(offsetof(FRigVMFunction_NameTruncate, Remainder) == 0x001C);
static_assert(offsetof(FRigVMFunction_NameTruncate, Chopped) == 0x0028);
static_assert(offsetof(FRigVMFunction_NameReplace, Name) == 0x0008);
static_assert(offsetof(FRigVMFunction_NameReplace, Old) == 0x0014);
static_assert(offsetof(FRigVMFunction_NameReplace, New) == 0x0020);
static_assert(offsetof(FRigVMFunction_NameReplace, Result) == 0x002C);
static_assert(offsetof(FRigVMFunction_EndsWith, Name) == 0x0008);
static_assert(offsetof(FRigVMFunction_EndsWith, Ending) == 0x0014);
static_assert(offsetof(FRigVMFunction_StartsWith, Name) == 0x0008);
static_assert(offsetof(FRigVMFunction_StartsWith, Start) == 0x0014);
static_assert(offsetof(FRigVMFunction_Contains, Name) == 0x0008);
static_assert(offsetof(FRigVMFunction_Contains, Search) == 0x0014);
