...
public:
	...
	// void Release(FScriptTypedElementHandle& ElementHandle);                                                                  // [0x263d380] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/TypedElementFramework.TypedElementHandleLibrary.NotEqual
	// bool NotEqual(FScriptTypedElementHandle& LHS, FScriptTypedElementHandle& RHS);                                           // [0x263cf80] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/TypedElementFramework.TypedElementHandleLibrary.IsSet
	// bool IsSet(FScriptTypedElementHandle& ElementHandle);                                                                    // [0x263d4b0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/TypedElementFramework.TypedElementHandleLibrary.Equal
	// bool Equal(FScriptTypedElementHandle& LHS, FScriptTypedElementHandle& RHS);                                              // [0x263d180] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void Shrink(FScriptTypedElementListProxy ElementList);                                                                   // [0x263f9e0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.Reset
	// void Reset(FScriptTypedElementListProxy ElementList);                                                                    // [0x263f3a0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.Reserve
	// void Reserve(FScriptTypedElementListProxy ElementList, int32_t Size);                                                    // [0x263f6d0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.Remove
	// bool Remove(FScriptTypedElementListProxy ElementList, FScriptTypedElementHandle& ElementHandle);                         // [0x263e550] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.Num
	// int32_t Num(FScriptTypedElementListProxy ElementList);                                                                   // [0x263fc10] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.IsValidIndex
	// bool IsValidIndex(FScriptTypedElementListProxy ElementList, int32_t Index);                                              // [0x263fdd0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.HasElementsOfType
	// bool HasElementsOfType(FScriptTypedElementListProxy ElementList, FName ElementTypeName);                                 // [0x26405b0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.HasElements
	// bool HasElements(FScriptTypedElementListProxy ElementList, class UClass* BaseInterfaceType);                             // [0x2640b20] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.GetElementInterface
	// class UObject* GetElementInterface(FScriptTypedElementListProxy ElementList, FScriptTypedElementHandle& ElementHandle, class UClass* BaseInterfaceType); // [0x2640e00] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.GetElementHandles
	// TArray<FScriptTypedElementHandle> GetElementHandles(FScriptTypedElementListProxy ElementList, class UClass* BaseInterfaceType); // [0x2640050] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.GetElementHandleAt
	// FScriptTypedElementHandle GetElementHandleAt(FScriptTypedElementListProxy ElementList, int32_t Index);                   // [0x2641140] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.Empty
	// void Empty(FScriptTypedElementListProxy ElementList, int32_t Slack);                                                     // [0x263f4e0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.CreateScriptElementList
	// FScriptTypedElementListProxy CreateScriptElementList(class UTypedElementRegistry* Registry);                             // [0x2641580] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.CountElementsOfType
	// int32_t CountElementsOfType(FScriptTypedElementListProxy ElementList, FName ElementTypeName);                            // [0x26402d0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.CountElements
	// int32_t CountElements(FScriptTypedElementListProxy ElementList, class UClass* BaseInterfaceType);                        // [0x2640890] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.Contains
	// bool Contains(FScriptTypedElementListProxy ElementList, FScriptTypedElementHandle& ElementHandle);                       // [0x263f080] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.Clone
	// FScriptTypedElementListProxy Clone(FScriptTypedElementListProxy ElementList);                                            // [0x2641400] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.AppendList
	// void AppendList(FScriptTypedElementListProxy ElementList, FScriptTypedElementListProxy OtherElementList);                // [0x263e830] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.Append
	// void Append(FScriptTypedElementListProxy ElementList, TArray<FScriptTypedElementHandle>& ElementHandles);                // [0x263eaa0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/TypedElementFramework.TypedElementListLibrary.Add
	// bool Add(FScriptTypedElementListProxy ElementList, FScriptTypedElementHandle& ElementHandle);                            // [0x263eda0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
/// Size: 0x0980 (2432 bytes) (0x000030 - 0x000980) align 8 MaxSize: 0x0980
class UTypedElementRegistry : public UObject
{ 
public:
	unsigned char                                      UnknownData00_1[0x950];                                     // 0x0030   (0x0950)  MISSED


	/// Functions
	// Function /Script/TypedElementFramework.TypedElementRegistry.GetInstance
	// class UTypedElementRegistry* GetInstance();                                                                              // [0x2643cf0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/TypedElementFramework.TypedElementRegistry.GetElementInterface
	// class UObject* GetElementInterface(FScriptTypedElementHandle& InElementHandle, class UClass* InBaseInterfaceType);       // [0x2643b10] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool SetDisplayName(FScriptTypedElementHandle& InElementHandle, FText InNewName, bool bNotify);                          // [0x26455e0] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/TypedElementFramework.TestTypedElementInterfaceA.GetDisplayName
	// FText GetDisplayName(FScriptTypedElementHandle& InElementHandle);                                                        // [0x2645890] Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// bool MarkAsTested(FScriptTypedElementHandle& InElementHandle);                                                           // [0x2645ab0] Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// bool GetIsTested(FScriptTypedElementHandle& InElementHandle);                                                            // [0x2645ab0] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
static_assert(sizeof(UTypedElementDataStorageCompatibilityInterface) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UTypedElementDataStorageFactory) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UTypedElementDataStorageInterface) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UTypedElementDataStorageUiInterface) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UTypedElementHandleLibrary) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UTypedElementListLibrary) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UTypedElementCounterInterface) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UTypedElementRegistry) == 0x0980); // 2432 bytes (0x000030 - 0x000980)
static_assert(sizeof(UTestTypedElementInterfaceA) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UTestTypedElementInterfaceB) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UTestTypedElementInterfaceC) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UTestTypedElementInterfaceA_ImplTyped) == 0x0038); // 56 bytes (0x000030 - 0x000038)
static_assert(sizeof(UTestTypedElementInterfaceA_ImplUntyped) == 0x0038); // 56 bytes (0x000030 - 0x000038)
static_assert(sizeof(UTestTypedElementInterfaceBAndC_Typed) == 0x0040); // 64 bytes (0x000030 - 0x000040)
...
static_assert(sizeof(FTypedElementWidgetConstructor) == 0x0010); // 16 bytes (0x000000 - 0x000010)
...
static_assert(sizeof(FTypedElementPackageLoadedPathColumn) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FTypedElementSelectionColumn) == 0x0001); // 1 bytes (0x000000 - 0x000001)
static_assert(sizeof(FTypedElementSlateWidgetReferenceColumn) == 0x0010); // 16 bytes (0x000000 - 0x000010)
