...
public:
	...
	EWaveTableSamplingMode                             SampleMode;                                                 // 0x0038   (0x0001)  
	EWaveTableResolution                               Resolution;                                                 // 0x0039   (0x0001)  
	unsigned char                                      UnknownData01_6[0x2];                                       // 0x003A   (0x0002)  MISSED
	int32_t                                            SampleRate;                                                 // 0x003C   (0x0004)  
	bool                                               bBipolar;                                                   // 0x0040   (0x0001)  
	unsigned char                                      UnknownData02_6[0x7];                                       // 0x0041   (0x0007)  MISSED
	TArray<FWaveTableBankEntry>                        Entries;                                                    // 0x0048   (0x0010)  
	unsigned char                                      UnknownData03_7[0x10];                                      // 0x0058   (0x0010)  MISSED
};
...
static_assert(sizeof(FWaveTableData) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FWaveTableTransform) == 0x00B8); // 184 bytes (0x000000 - 0x0000B8)
static_assert(sizeof(FWaveTableBankEntry) == 0x00B8); // 184 bytes (0x000000 - 0x0000B8)
static_assert(sizeof(UWaveTableBank) == 0x0068); // 104 bytes (0x000030 - 0x000068)
static_assert(sizeof(FWaveTableSettings) == 0x0058); // 88 bytes (0x000000 - 0x000058)
static_assert(offsetof(FWaveTableData, BitDepth) == 0x0000);
static_assert(offsetof(FWaveTableData, Data) == 0x0008);
...
static_assert(offsetof(FWaveTableTransform, TableData) == 0x0090);
static_assert(offsetof(FWaveTableBankEntry, Transform) == 0x0000);
static_assert(offsetof(UWaveTableBank, SampleMode) == 0x0038);
static_assert(offsetof(UWaveTableBank, Resolution) == 0x0039);
static_assert(offsetof(UWaveTableBank, Entries) == 0x0048);
static_assert(offsetof(FWaveTableSettings, FilePath) == 0x0000);
static_assert(offsetof(FWaveTableSettings, SourceData) == 0x0018);
