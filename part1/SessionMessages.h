...
static_assert(sizeof(FSessionServiceLog) == 0x0040); // 64 bytes (0x000000 - 0x000040)
...
static_assert(offsetof(FSessionServiceLog, Data) == 0x0010);
static_assert(offsetof(FSessionServiceLog, InstanceId) == 0x0020);
