...
{ 
	...
	bool                                               bUseStiffness;                                              // 0x0011   (0x0001)  
	unsigned char                                      UnknownData00_6[0x6];                                       // 0x0012   (0x0006)  MISSED
	FVector                                            LinearStiffness;                                            // 0x0018   (0x0018)  
	FVector                                            AngularStiffness;                                           // 0x0030   (0x0018)  
	bool                                               bUseAngularLimit;                                           // 0x0048   (0x0001)  
	unsigned char                                      UnknownData01_6[0x7];                                       // 0x0049   (0x0007)  MISSED
	FFBIKBoneLimit                                     AngularLimit;                                               // 0x0050   (0x0020)  
	bool                                               bUsePoleVector;                                             // 0x0070   (0x0001)  
	EPoleVectorOption                                  PoleVectorOption;                                           // 0x0071   (0x0001)  
	unsigned char                                      UnknownData02_6[0x6];                                       // 0x0072   (0x0006)  MISSED
	FVector                                            PoleVector;                                                 // 0x0078   (0x0018)  
	FRotator                                           OffsetRotation;                                             // 0x0090   (0x0018)  
};
...
/// Size: 0x03F0 (1008 bytes) (0x000170 - 0x0003F0) align 16 MaxSize: 0x03F0
struct FRigUnit_FullbodyIK : FRigUnit_HighlevelBaseMutable
{ 
	FRigElementKey                                     Root;                                                       // 0x0170   (0x0010)  
	TArray<FFBIKEndEffector>                           Effectors;                                                  // 0x0180   (0x0010)  
	TArray<FFBIKConstraintOption>                      Constraints;                                                // 0x0190   (0x0010)  
	FSolverInput                                       SolverProperty;                                             // 0x01A0   (0x0024)  
	FMotionProcessInput                                MotionProperty;                                             // 0x01C4   (0x0002)  
	bool                                               bPropagateToChildren;                                       // 0x01C6   (0x0001)  
	unsigned char                                      UnknownData00_6[0x9];                                       // 0x01C7   (0x0009)  MISSED
	FFBIKDebugOption                                   DebugOption;                                                // 0x01D0   (0x0080)  
	FRigUnit_FullbodyIK_WorkData                       WorkData;                                                   // 0x0250   (0x0198)  
	unsigned char                                      UnknownData01_7[0x8];                                       // 0x03E8   (0x0008)  MISSED
};
...
static_assert(sizeof(FFBIKConstraintOption) == 0x00A8); // 168 bytes (0x000000 - 0x0000A8)
...
static_assert(sizeof(FRigUnit_FullbodyIK) == 0x03F0); // 1008 bytes (0x000170 - 0x0003F0)
...
static_assert(offsetof(FFBIKConstraintOption, LinearStiffness) == 0x0018);
static_assert(offsetof(FFBIKConstraintOption, AngularStiffness) == 0x0030);
static_assert(offsetof(FFBIKConstraintOption, AngularLimit) == 0x0050);
static_assert(offsetof(FFBIKConstraintOption, PoleVectorOption) == 0x0071);
static_assert(offsetof(FFBIKConstraintOption, PoleVector) == 0x0078);
static_assert(offsetof(FFBIKConstraintOption, OffsetRotation) == 0x0090);
...
static_assert(offsetof(FRigUnit_FullbodyIK, Root) == 0x0170);
static_assert(offsetof(FRigUnit_FullbodyIK, Effectors) == 0x0180);
static_assert(offsetof(FRigUnit_FullbodyIK, Constraints) == 0x0190);
static_assert(offsetof(FRigUnit_FullbodyIK, SolverProperty) == 0x01A0);
static_assert(offsetof(FRigUnit_FullbodyIK, MotionProperty) == 0x01C4);
static_assert(offsetof(FRigUnit_FullbodyIK, DebugOption) == 0x01D0);
static_assert(offsetof(FRigUnit_FullbodyIK, WorkData) == 0x0250);
