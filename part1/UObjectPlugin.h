...
{ 
public:
	FMyPluginStruct                                    MyStruct;                                                   // 0x0030   (0x0010)  
};
...
static_assert(sizeof(UMyPluginObject) == 0x0040); // 64 bytes (0x000030 - 0x000040)
static_assert(offsetof(FMyPluginStruct, TestString) == 0x0000);
static_assert(offsetof(UMyPluginObject, MyStruct) == 0x0030);
