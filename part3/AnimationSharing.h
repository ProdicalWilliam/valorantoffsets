...
public:
	...
	// void ProcessActorState(int32_t& OutState, class AActor* InActor, char CurrentState, char OnDemandState, bool& bShouldProcess); // [0x761cb20] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/AnimationSharing.AnimationSharingStateProcessor.GetAnimationStateEnum
	// class UEnum* GetAnimationStateEnum();                                                                                    // [0x3bf33e0] Native|Event|Public|BlueprintEvent 
};
...
{ 
public:
	class UAnimSequence*                               AnimationToPlay;                                            // 0x0390   (0x0008)  
	float                                              PermutationTimeOffset;                                      // 0x0398   (0x0004)  
	float                                              PlayRate;                                                   // 0x039C   (0x0004)  
	bool                                               bStateBool;                                                 // 0x03A0   (0x0001)  
	unsigned char                                      UnknownData00_6[0x7];                                       // 0x03A1   (0x0007)  MISSED
	class UAnimSharingInstance*                        Instance;                                                   // 0x03A8   (0x0008)  


	/// Functions
	// Function /Script/AnimationSharing.AnimSharingStateInstance.GetInstancedActors
	// void GetInstancedActors(TArray<AActor*>& Actors);                                                                        // [0x761d850] Final|Native|Protected|HasOutParms|BlueprintCallable 
};
...
{ 
public:
	TWeakObjectPtr<class USkeletalMeshComponent*>      FromComponent;                                              // 0x0390   (0x0008)  
	TWeakObjectPtr<class USkeletalMeshComponent*>      ToComponent;                                                // 0x0398   (0x0008)  
	float                                              BlendTime;                                                  // 0x03A0   (0x0004)  
	bool                                               bBlendBool;                                                 // 0x03A4   (0x0001)  
	unsigned char                                      UnknownData00_7[0xB];                                       // 0x03A5   (0x000B)  MISSED
};
...
{ 
public:
	TWeakObjectPtr<class USkeletalMeshComponent*>      BaseComponent;                                              // 0x0390   (0x0008)  
	TWeakObjectPtr<class UAnimSequence*>               AdditiveAnimation;                                          // 0x0398   (0x0008)  
	float                                              Alpha;                                                      // 0x03A0   (0x0004)  
	bool                                               bStateBool;                                                 // 0x03A4   (0x0001)  
	unsigned char                                      UnknownData00_7[0xB];                                       // 0x03A5   (0x000B)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData03_7[0x28];                                      // 0x0100   (0x0028)  MISSED
};
...
public:
	...
	// void RegisterActorWithSkeletonBP(class AActor* InActor, class USkeleton* SharingSkeleton);                               // [0x761e120] Final|Native|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.GetAnimationSharingManager
	// class UAnimationSharingManager* GetAnimationSharingManager(class UObject* WorldContextObject);                           // [0x761e450] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.CreateAnimationSharingManager
	// bool CreateAnimationSharingManager(class UObject* WorldContextObject, class UAnimationSharingSetup* Setup);              // [0x761e2c0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.AnimationSharingEnabled
	// bool AnimationSharingEnabled();                                                                                          // [0x761e0f0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
static_assert(sizeof(UAnimationSharingStateProcessor) == 0x0060); // 96 bytes (0x000030 - 0x000060)
static_assert(sizeof(UAnimSharingStateInstance) == 0x03B0); // 944 bytes (0x000390 - 0x0003B0)
static_assert(sizeof(UAnimSharingTransitionInstance) == 0x03B0); // 944 bytes (0x000390 - 0x0003B0)
static_assert(sizeof(UAnimSharingAdditiveInstance) == 0x03B0); // 944 bytes (0x000390 - 0x0003B0)
static_assert(sizeof(UAnimSharingInstance) == 0x0128); // 296 bytes (0x000030 - 0x000128)
static_assert(sizeof(UAnimationSharingManager) == 0x0090); // 144 bytes (0x000030 - 0x000090)
...
static_assert(offsetof(UAnimSharingStateInstance, AnimationToPlay) == 0x0390);
static_assert(offsetof(UAnimSharingStateInstance, Instance) == 0x03A8);
static_assert(offsetof(UAnimSharingTransitionInstance, FromComponent) == 0x0390);
static_assert(offsetof(UAnimSharingTransitionInstance, ToComponent) == 0x0398);
static_assert(offsetof(UAnimSharingAdditiveInstance, BaseComponent) == 0x0390);
static_assert(offsetof(UAnimSharingAdditiveInstance, AdditiveAnimation) == 0x0398);
