...
public:
	...
	// void StopLink();                                                                                                         // [0x3a1f980] Native|Public|BlueprintCallable 
	// Function /Script/AudioLinkEngine.AudioLinkBlueprintInterface.SetLinkSound
	// void SetLinkSound(class USoundBase* NewSound);                                                                           // [0x3a1fab0] Native|Public|BlueprintCallable 
	// Function /Script/AudioLinkEngine.AudioLinkBlueprintInterface.PlayLink
	// void PlayLink(float StartTime);                                                                                          // [0x3a1f9b0] Native|Public|BlueprintCallable 
	// Function /Script/AudioLinkEngine.AudioLinkBlueprintInterface.IsLinkPlaying
	// bool IsLinkPlaying();                                                                                                    // [0x3a1f940] Native|Public|BlueprintCallable|BlueprintPure|Const 
};

#pragma pack(pop)


static_assert(sizeof(UAudioLinkBlueprintInterface) == 0x0030); // 48 bytes (0x000030 - 0x000030)
