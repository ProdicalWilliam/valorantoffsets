...
{ 
public:
	SDK_UNDEFINED(80,2) /* TMap<FName, TWeakObjectPtr<UObject*>> */ __um(DataSources);                             // 0x0030   (0x0050)  
};
...
static_assert(sizeof(FNodeObject) == 0x0018); // 24 bytes (0x000000 - 0x000018)
...
static_assert(sizeof(FTransformConstraint) == 0x0030); // 48 bytes (0x000000 - 0x000030)
...
static_assert(offsetof(FNodeObject, ParentName) == 0x000C);
...
static_assert(offsetof(FTransformConstraint, TargetNode) == 0x001C);
