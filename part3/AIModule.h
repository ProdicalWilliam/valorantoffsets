...
/// Enum /Script/AIModule.EAILogicResuming
/// Size: 0x01 (1 bytes)
enum class EAILogicResuming : uint8_t
{
	EAILogicResuming__Continue                                                       = 0,
	EAILogicResuming__RestartedInstead                                               = 1
};
...
/// Enum /Script/AIModule.EEnvQueryTraceResult
/// Size: 0x01 (1 bytes)
enum class EEnvQueryTraceResult : uint8_t
{
	EEnvQueryTraceResult__Single                                                     = 0,
	EEnvQueryTraceResult__Multiple                                                   = 1
};
...
/// Enum /Script/AIModule.EAISenseActorSize
/// Size: 0x01 (1 bytes)
enum class EAISenseActorSize : uint8_t
{
	EAISenseActorSize__AISize_Small                                                  = 0,
	EAISenseActorSize__AISize_Medium                                                 = 1,
	EAISenseActorSize__AISize_Large                                                  = 2
};
...
public:
	...
	SDK_UNDEFINED(16,353) /* FMulticastInlineDelegate */ __um(OnFail);                                             // 0x0040   (0x0010)  
	...
	// void OnMoveCompleted(FAIRequestID RequestID, TEnumAsByte<EPathFollowingResult> MovementResult);                          // [0x5106a10] Final|RequiredAPI|Native|Public 
};
...
public:
	class UClass*                                      Implementation;                                             // 0x0050   (0x0008)  
	bool                                               bCanSeeThroughWalls;                                        // 0x0058   (0x0001)  
	unsigned char                                      UnknownData00_6[0x3];                                       // 0x0059   (0x0003)  MISSED
	float                                              SightRadius;                                                // 0x005C   (0x0004)  
	float                                              LoseSightRadius;                                            // 0x0060   (0x0004)  
	float                                              PeripheralVisionAngleDegrees;                               // 0x0064   (0x0004)  
	FAISenseAffiliationFilter                          DetectionByAffiliation;                                     // 0x0068   (0x0004)  
	float                                              AutoSuccessRangeFromLastSeenLocation;                       // 0x006C   (0x0004)  
	float                                              PointOfViewBackwardOffset;                                  // 0x0070   (0x0004)  
	float                                              NearClippingRadius;                                         // 0x0074   (0x0004)  
};
...
{ 
public:
	FAIDamageEvent                                     event;                                                      // 0x0030   (0x0058)  
};
...
{ 
public:
	FAINoiseEvent                                      event;                                                      // 0x0030   (0x0040)  
};
...
public:
	...
	// TEnumAsByte<EAIRequestPriority> GetActionPriority();                                                                     // [0x510c8c0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.PawnAction.Finish
	// void Finish(TEnumAsByte<EPawnActionResult> WithResult);                                                                  // [0x510c630] RequiredAPI|Native|Protected|BlueprintCallable 
	// Function /Script/AIModule.PawnAction.CreateActionInstance
	// class UPawnAction* CreateActionInstance(class UObject* WorldContextObject, class UClass* ActionClass);                   // [0x510c730] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	class APawn*                                       ControlledPawn;                                             // 0x00D8   (0x0008)  
	TArray<FPawnActionStack>                           ActionStacks;                                               // 0x00E0   (0x0010)  
	TArray<FPawnActionEvent>                           ActionEvents;                                               // 0x00F0   (0x0010)  
	class UPawnAction*                                 CurrentAction;                                              // 0x0100   (0x0008)  
	unsigned char                                      UnknownData00_7[0x8];                                       // 0x0108   (0x0008)  MISSED


	/// Functions
	// Function /Script/AIModule.PawnActionsComponent.K2_PushAction
	// bool K2_PushAction(class UPawnAction* NewAction, TEnumAsByte<EAIRequestPriority> Priority, class UObject* Instigator);   // [0x510df20] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnActionsComponent.K2_PerformAction
	// bool K2_PerformAction(class APawn* Pawn, class UPawnAction* Action, TEnumAsByte<EAIRequestPriority> Priority);           // [0x510e170] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnActionsComponent.K2_ForceAbortAction
	// TEnumAsByte<EPawnActionAbortState> K2_ForceAbortAction(class UPawnAction* ActionToAbort);                                // [0x510dcc0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnActionsComponent.K2_AbortAction
	// TEnumAsByte<EPawnActionAbortState> K2_AbortAction(class UPawnAction* ActionToAbort);                                     // [0x510de10] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void ActionTick(class APawn* ControlledPawn, float DeltaSeconds);                                                        // [0x1a821d0] RequiredAPI|Event|Public|BlueprintEvent 
	// Function /Script/AIModule.PawnAction_BlueprintBase.ActionStart
	// void ActionStart(class APawn* ControlledPawn);                                                                           // [0x1a821d0] RequiredAPI|Event|Public|BlueprintEvent 
	// Function /Script/AIModule.PawnAction_BlueprintBase.ActionResume
	// void ActionResume(class APawn* ControlledPawn);                                                                          // [0x1a821d0] RequiredAPI|Event|Public|BlueprintEvent 
	// Function /Script/AIModule.PawnAction_BlueprintBase.ActionPause
	// void ActionPause(class APawn* ControlledPawn);                                                                           // [0x1a821d0] RequiredAPI|Event|Public|BlueprintEvent 
	// Function /Script/AIModule.PawnAction_BlueprintBase.ActionFinished
	// void ActionFinished(class APawn* ControlledPawn, TEnumAsByte<EPawnActionResult> WithResult);                             // [0x1a821d0] RequiredAPI|Event|Public|BlueprintEvent 
};
...
public:
	...
	FVector                                            GoalLocation;                                               // 0x00A0   (0x0018)  
	float                                              AcceptableRadius;                                           // 0x00B8   (0x0004)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x00BC   (0x0004)  MISSED
	class UClass*                                      FilterClass;                                                // 0x00C0   (0x0008)  
	bool                                               bAllowStrafe : 1;                                           // 0x00C8:0 (0x0001)  
	bool                                               bFinishOnOverlap : 1;                                       // 0x00C8:1 (0x0001)  
	bool                                               bUsePathfinding : 1;                                        // 0x00C8:2 (0x0001)  
	bool                                               bAllowPartialPath : 1;                                      // 0x00C8:3 (0x0001)  
	bool                                               bProjectGoalToNavigation : 1;                               // 0x00C8:4 (0x0001)  
	bool                                               bUpdatePathToGoal : 1;                                      // 0x00C8:5 (0x0001)  
	bool                                               bAbortSubActionOnPathChange : 1;                            // 0x00C8:6 (0x0001)  
	unsigned char                                      UnknownData01_7[0x2F];                                      // 0x00C9   (0x002F)  MISSED
};
...
/// Size: 0x05B0 (1456 bytes) (0x000500 - 0x0005B0) align 8 MaxSize: 0x05B0
class AAIController : public AController
{ 
public:
	unsigned char                                      UnknownData00_8[0x38];                                      // 0x0500   (0x0038)  MISSED
	bool                                               bStartAILogicOnPossess : 1;                                 // 0x0538:0 (0x0001)  
	bool                                               bStopAILogicOnUnposses : 1;                                 // 0x0538:1 (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0539   (0x0007)  MISSED
	FVector                                            CustomMoveToProjectionExtents;                              // 0x0540   (0x0018)  
	class UPathFollowingComponent*                     PathFollowingComponent;                                     // 0x0558   (0x0008)  
	bool                                               bLOSflag : 1;                                               // 0x0560:0 (0x0001)  
	bool                                               bSkipExtraLOSChecks : 1;                                    // 0x0560:1 (0x0001)  
	bool                                               bAllowStrafe : 1;                                           // 0x0560:2 (0x0001)  
	bool                                               bWantsPlayerState : 1;                                      // 0x0560:3 (0x0001)  
	bool                                               bSetControlRotationFromPawnOrientation : 1;                 // 0x0560:4 (0x0001)  
	unsigned char                                      UnknownData02_5[0x7];                                       // 0x0561   (0x0007)  MISSED
	class UBrainComponent*                             BrainComponent;                                             // 0x0568   (0x0008)  
	class UAIPerceptionComponent*                      PerceptionComponent;                                        // 0x0570   (0x0008)  
	class UPawnActionsComponent*                       ActionsComp;                                                // 0x0578   (0x0008)  
	class UBlackboardComponent*                        Blackboard;                                                 // 0x0580   (0x0008)  
	class UGameplayTasksComponent*                     CachedGameplayTasksComponent;                               // 0x0588   (0x0008)  
	class UClass*                                      DefaultNavigationFilterClass;                               // 0x0590   (0x0008)  
	SDK_UNDEFINED(16,354) /* FMulticastInlineDelegate */ __um(ReceiveMoveCompleted);                               // 0x0598   (0x0010)  
	bool                                               bPitchWithoutPawnTarget;                                    // 0x05A8   (0x0001)  
	unsigned char                                      UnknownData03_7[0x7];                                       // 0x05A9   (0x0007)  MISSED


	/// Functions
	// Function /Script/AIModule.AIController.UseBlackboard
	// bool UseBlackboard(class UBlackboardData* BlackboardAsset, class UBlackboardComponent*& BlackboardComponent);            // [0x5114e40] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.AIController.UnclaimTaskResource
	// void UnclaimTaskResource(class UClass* ResourceClass);                                                                   // [0x5114a10] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.SetPathFollowingComponent
	// void SetPathFollowingComponent(class UPathFollowingComponent* NewPFComponent);                                           // [0x5114370] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.SetMoveBlockDetection
	// void SetMoveBlockDetection(bool bEnable);                                                                                // [0x51152d0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.RunBehaviorTree
	// bool RunBehaviorTree(class UBehaviorTree* BTAsset);                                                                      // [0x51151c0] RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.OverrideControlRotation
	// FRotator OverrideControlRotation(float DeltaTime, FRotator NewControlRotation);                                          // [0x5115ff0] RequiredAPI|Native|Event|Protected|HasDefaults|BlueprintEvent 
	// Function /Script/AIModule.AIController.OnUsingBlackBoard
	// void OnUsingBlackBoard(class UBlackboardComponent* BlackboardComp, class UBlackboardData* BlackboardAsset);              // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.AIController.OnGameplayTaskResourcesClaimed
	// void OnGameplayTaskResourcesClaimed(FGameplayResourceSet NewlyClaimed, FGameplayResourceSet FreshlyReleased);            // [0x51144a0] RequiredAPI|Native|Public 
	// Function /Script/AIModule.AIController.MoveToLocation
	// TEnumAsByte<EPathFollowingRequestResult> MoveToLocation(FVector& Dest, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bProjectDestinationToNavigation, bool bCanStrafe, class UClass* FilterClass, bool bAllowPartialPath); // [0x5115600] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.AIController.MoveToActor
	// TEnumAsByte<EPathFollowingRequestResult> MoveToActor(class AActor* Goal, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bCanStrafe, class UClass* FilterClass, bool bAllowPartialPath); // [0x5115b50] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.K2_SetFocus
	// void K2_SetFocus(class AActor* NewFocus);                                                                                // [0x51146a0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.K2_SetFocalPoint
	// void K2_SetFocalPoint(FVector FP);                                                                                       // [0x51147a0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.AIController.K2_ClearFocus
	// void K2_ClearFocus();                                                                                                    // [0x5114640] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.HasPartialPath
	// bool HasPartialPath();                                                                                                   // [0x5115570] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetPathFollowingComponent
	// class UPathFollowingComponent* GetPathFollowingComponent();                                                              // [0x5114480] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetMoveStatus
	// TEnumAsByte<EPathFollowingStatus> GetMoveStatus();                                                                       // [0x51155c0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetImmediateMoveDestination
	// FVector GetImmediateMoveDestination();                                                                                   // [0x51154f0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetFocusActor
	// class AActor* GetFocusActor();                                                                                           // [0x5114670] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetFocalPointOnActor
	// FVector GetFocalPointOnActor(class AActor* Actor);                                                                       // [0x51148b0] RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetFocalPoint
	// FVector GetFocalPoint();                                                                                                 // [0x51149d0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetFinalMoveDestination
	// FVector GetFinalMoveDestination();                                                                                       // [0x5115400] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetDeprecatedActionsComponent
	// class UPawnActionsComponent* GetDeprecatedActionsComponent();                                                            // [0x5114350] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetAIPerceptionComponent
	// class UAIPerceptionComponent* GetAIPerceptionComponent();                                                                // [0x5114460] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIController.ClaimTaskResource
	// void ClaimTaskResource(class UClass* ResourceClass);                                                                     // [0x5114c50] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
public:
	...
	class UAISystem*                                   AISystem;                                                   // 0x0048   (0x0008)  
};
...
{ 
public:
	FSoftClassPath                                     PerceptionSystemClassName;                                  // 0x0078   (0x0028)  
	FSoftClassPath                                     HotSpotManagerClassName;                                    // 0x00A0   (0x0028)  
	FSoftClassPath                                     EnvQueryManagerClassName;                                   // 0x00C8   (0x0028)  
	float                                              AcceptanceRadius;                                           // 0x00F0   (0x0004)  
	float                                              PathfollowingRegularPathPointAcceptanceRadius;              // 0x00F4   (0x0004)  
	float                                              PathfollowingNavLinkAcceptanceRadius;                       // 0x00F8   (0x0004)  
	bool                                               bFinishMoveOnGoalOverlap;                                   // 0x00FC   (0x0001)  
	bool                                               bAcceptPartialPaths;                                        // 0x00FD   (0x0001)  
	bool                                               bAllowStrafing;                                             // 0x00FE   (0x0001)  
	bool                                               bAllowControllersAsEQSQuerier;                              // 0x00FF   (0x0001)  
	bool                                               bEnableDebuggerPlugin;                                      // 0x0100   (0x0001)  
	bool                                               bForgetStaleActors;                                         // 0x0101   (0x0001)  
	bool                                               bAddBlackboardSelfKey;                                      // 0x0102   (0x0001)  
	bool                                               bClearBBEntryOnBTEQSFail;                                   // 0x0103   (0x0001)  
	bool                                               bBlackboardKeyDecoratorAllowsNoneAsValue;                   // 0x0104   (0x0001)  
	unsigned char                                      UnknownData00_6[0x3];                                       // 0x0105   (0x0003)  MISSED
	TWeakObjectPtr<class UBlackboardData*>             DefaultBlackboard;                                          // 0x0108   (0x0008)  
	unsigned char                                      UnknownData01_6[0x28];                                      // 0x0110   (0x0028)  MISSED
	TEnumAsByte<ECollisionChannel>                     DefaultSightCollisionChannel;                               // 0x0138   (0x0001)  
	unsigned char                                      UnknownData02_6[0x7];                                       // 0x0139   (0x0007)  MISSED
	class UBehaviorTreeManager*                        BehaviorTreeManager;                                        // 0x0140   (0x0008)  
	class UEnvQueryManager*                            EnvironmentQueryManager;                                    // 0x0148   (0x0008)  
	class UAIPerceptionSystem*                         PerceptionSystem;                                           // 0x0150   (0x0008)  
	TArray<class UAIAsyncTaskBlueprintProxy*>          AllProxyObjects;                                            // 0x0158   (0x0010)  
	class UAIHotSpotManager*                           HotSpotManager;                                             // 0x0168   (0x0008)  
	class UNavLocalGridManager*                        NavLocalGrids;                                              // 0x0170   (0x0008)  
	unsigned char                                      UnknownData03_7[0x60];                                      // 0x0178   (0x0060)  MISSED


	/// Functions
	// Function /Script/AIModule.AISystem.AILoggingVerbose
	// void AILoggingVerbose();                                                                                                 // [0x3eaeab0] RequiredAPI|Exec|Native|Public 
	// Function /Script/AIModule.AISystem.AIIgnorePlayers
	// void AIIgnorePlayers();                                                                                                  // [0x27ec4f0] RequiredAPI|Exec|Native|Public 
};
...
public:
	...
	class UBlackboardComponent*                        BlackboardComp;                                             // 0x00E0   (0x0008)  
	class AAIController*                               AIOwner;                                                    // 0x00E8   (0x0008)  
	unsigned char                                      UnknownData01_7[0x40];                                      // 0x00F0   (0x0040)  MISSED


	/// Functions
	// Function /Script/AIModule.BrainComponent.StopLogic
	// void StopLogic(FString Reason);                                                                                          // [0x5167640] RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.BrainComponent.StartLogic
	// void StartLogic();                                                                                                       // [0x46a08e0] RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.BrainComponent.ResumeLogic
	// TEnumAsByte<EAILogicResuming> ResumeLogic(FString Reason);                                                               // [0x51673b0] RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.BrainComponent.RestartLogic
	// void RestartLogic();                                                                                                     // [0x5167780] RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.BrainComponent.PauseLogic
	// void PauseLogic(FString Reason);                                                                                         // [0x5167500] Native|Public|BlueprintCallable 
	// Function /Script/AIModule.BrainComponent.IsRunning
	// bool IsRunning();                                                                                                        // [0x5167370] RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BrainComponent.IsPaused
	// bool IsPaused();                                                                                                         // [0x5167330] RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/AIModule.BehaviorTreeComponent
/// Size: 0x02C8 (712 bytes) (0x000130 - 0x0002C8) align 8 MaxSize: 0x02C8
class UBehaviorTreeComponent : public UBrainComponent
{ 
public:
	unsigned char                                      UnknownData00_8[0x20];                                      // 0x0130   (0x0020)  MISSED
	TArray<class UBTNode*>                             NodeInstances;                                              // 0x0150   (0x0010)  
	unsigned char                                      UnknownData01_6[0x148];                                     // 0x0160   (0x0148)  MISSED
	...
	// void SetDynamicSubtree(FGameplayTag InjectTag, class UBehaviorTree* BehaviorAsset);                                      // [0x511dc40] RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.BehaviorTreeComponent.GetTagCooldownEndTime
	// double GetTagCooldownEndTime(FGameplayTag CooldownTag);                                                                  // [0x511e050] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BehaviorTreeComponent.AddCooldownTagDuration
	// void AddCooldownTagDuration(FGameplayTag CooldownTag, float CooldownDuration, bool bAddToExistingDuration);              // [0x511de00] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
public:
	...
	// class UBlackboardData* GetBlackboardAsset();                                                                             // [0x5129810] RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/AIModule.BlackboardComponent
/// Size: 0x01E0 (480 bytes) (0x0000D8 - 0x0001E0) align 8 MaxSize: 0x01E0
class UBlackboardComponent : public UActorComponent
{ 
public:
	class UBrainComponent*                             BrainComp;                                                  // 0x00D8   (0x0008)  
	class UBlackboardData*                             DefaultBlackboardAsset;                                     // 0x00E0   (0x0008)  
	class UBlackboardData*                             BlackboardAsset;                                            // 0x00E8   (0x0008)  
	unsigned char                                      UnknownData00_6[0x20];                                      // 0x00F0   (0x0020)  MISSED
	TArray<class UBlackboardKeyType*>                  KeyInstances;                                               // 0x0110   (0x0010)  
	unsigned char                                      UnknownData01_7[0xC0];                                      // 0x0120   (0x00C0)  MISSED


	/// Functions
	// Function /Script/AIModule.BlackboardComponent.SetValueAsVector
	// void SetValueAsVector(FName& KeyName, FVector VectorValue);                                                              // [0x512a0c0] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsString
	// void SetValueAsString(FName& KeyName, FString StringValue);                                                              // [0x512a470] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsRotator
	// void SetValueAsRotator(FName& KeyName, FRotator VectorValue);                                                            // [0x5129ef0] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsObject
	// void SetValueAsObject(FName& KeyName, class UObject* ObjectValue);                                                       // [0x512af60] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsName
	// void SetValueAsName(FName& KeyName, FName NameValue);                                                                    // [0x512a290] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsInt
	// void SetValueAsInt(FName& KeyName, int32_t IntValue);                                                                    // [0x512aa50] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsFloat
	// void SetValueAsFloat(FName& KeyName, float FloatValue);                                                                  // [0x512a8a0] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsEnum
	// void SetValueAsEnum(FName& KeyName, char EnumValue);                                                                     // [0x512ac00] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsClass
	// void SetValueAsClass(FName& KeyName, class UClass* ClassValue);                                                          // [0x512adb0] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsBool
	// void SetValueAsBool(FName& KeyName, bool BoolValue);                                                                     // [0x512a6f0] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.IsVectorValueSet
	// bool IsVectorValueSet(FName& KeyName);                                                                                   // [0x5129da0] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsVector
	// FVector GetValueAsVector(FName& KeyName);                                                                                // [0x512b240] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsString
	// FString GetValueAsString(FName& KeyName);                                                                                // [0x512b480] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsRotator
	// FRotator GetValueAsRotator(FName& KeyName);                                                                              // [0x512b110] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsObject
	// class UObject* GetValueAsObject(FName& KeyName);                                                                         // [0x512bb70] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsName
	// FName GetValueAsName(FName& KeyName);                                                                                    // [0x512b370] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsInt
	// int32_t GetValueAsInt(FName& KeyName);                                                                                   // [0x512b850] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsFloat
	// float GetValueAsFloat(FName& KeyName);                                                                                   // [0x512b730] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsEnum
	// char GetValueAsEnum(FName& KeyName);                                                                                     // [0x512b970] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsClass
	// class UClass* GetValueAsClass(FName& KeyName);                                                                           // [0x512ba70] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsBool
	// bool GetValueAsBool(FName& KeyName);                                                                                     // [0x512b610] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetRotationFromEntry
	// bool GetRotationFromEntry(FName& KeyName, FRotator& ResultRotation);                                                     // [0x5129a00] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetLocationFromEntry
	// bool GetLocationFromEntry(FName& KeyName, FVector& ResultLocation);                                                      // [0x5129bd0] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.ClearValue
	// void ClearValue(FName& KeyName);                                                                                         // [0x51298f0] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	bool                                               bApplyDecoratorScope : 1;                                   // 0x0080:0 (0x0001)  
...
public:
	...
	// void StopUsingExternalEvent(class UBTNode* NodeOwner);                                                                   // [0x34773d0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.StartUsingExternalEvent
	// void StartUsingExternalEvent(class UBTNode* NodeOwner, class AActor* OwningActor);                                       // [0x4a44eb0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsVector
	// void SetBlackboardValueAsVector(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, FVector Value);                   // [0x5137220] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsString
	// void SetBlackboardValueAsString(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, FString Value);                   // [0x5137800] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsRotator
	// void SetBlackboardValueAsRotator(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, FRotator Value);                 // [0x5136f30] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsObject
	// void SetBlackboardValueAsObject(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, class UObject* Value);            // [0x5138a10] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsName
	// void SetBlackboardValueAsName(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, FName Value);                       // [0x5137510] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsInt
	// void SetBlackboardValueAsInt(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, int32_t Value);                      // [0x51381a0] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsFloat
	// void SetBlackboardValueAsFloat(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, float Value);                      // [0x5137ec0] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsEnum
	// void SetBlackboardValueAsEnum(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, char Value);                        // [0x5138470] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsClass
	// void SetBlackboardValueAsClass(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, class UClass* Value);              // [0x5138740] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsBool
	// void SetBlackboardValueAsBool(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, bool Value);                        // [0x5137bf0] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.GetOwnersBlackboard
	// class UBlackboardComponent* GetOwnersBlackboard(class UBTNode* NodeOwner);                                               // [0x513a8b0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetOwnerComponent
	// class UBehaviorTreeComponent* GetOwnerComponent(class UBTNode* NodeOwner);                                               // [0x513a780] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsVector
	// FVector GetBlackboardValueAsVector(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                               // [0x5138f60] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsString
	// FString GetBlackboardValueAsString(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                               // [0x5139450] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsRotator
	// FRotator GetBlackboardValueAsRotator(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                             // [0x5138ce0] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsObject
	// class UObject* GetBlackboardValueAsObject(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                        // [0x513a510] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsName
	// FName GetBlackboardValueAsName(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                   // [0x51391e0] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsInt
	// int32_t GetBlackboardValueAsInt(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                  // [0x5139b90] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsFloat
	// float GetBlackboardValueAsFloat(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                  // [0x5139920] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsEnum
	// char GetBlackboardValueAsEnum(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                    // [0x5139e00] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsClass
	// class UClass* GetBlackboardValueAsClass(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                          // [0x513a040] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsBool
	// bool GetBlackboardValueAsBool(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                    // [0x51396b0] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsActor
	// class AActor* GetBlackboardValueAsActor(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                          // [0x513a280] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.ClearBlackboardValueAsVector
	// void ClearBlackboardValueAsVector(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                // [0x5136ce0] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.ClearBlackboardValue
	// void ClearBlackboardValue(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                        // [0x5136ce0] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
public:
	TEnumAsByte<EBTParallelMode>                       FinishMode;                                                 // 0x0088   (0x0001)  
...
{ 
	...
	int32_t                                            SelectedKeyID;                                              // 0x0028   (0x0004)  
...
public:
	...
	// void ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds);               // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveTick
	// void ReceiveTick(class AActor* OwnerActor, float DeltaSeconds);                                                          // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveObserverDeactivatedAI
	// void ReceiveObserverDeactivatedAI(class AAIController* OwnerController, class APawn* ControlledPawn);                    // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveObserverDeactivated
	// void ReceiveObserverDeactivated(class AActor* OwnerActor);                                                               // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveObserverActivatedAI
	// void ReceiveObserverActivatedAI(class AAIController* OwnerController, class APawn* ControlledPawn);                      // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveObserverActivated
	// void ReceiveObserverActivated(class AActor* OwnerActor);                                                                 // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveExecutionStartAI
	// void ReceiveExecutionStartAI(class AAIController* OwnerController, class APawn* ControlledPawn);                         // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveExecutionStart
	// void ReceiveExecutionStart(class AActor* OwnerActor);                                                                    // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveExecutionFinishAI
	// void ReceiveExecutionFinishAI(class AAIController* OwnerController, class APawn* ControlledPawn, TEnumAsByte<EBTNodeResult> NodeResult); // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveExecutionFinish
	// void ReceiveExecutionFinish(class AActor* OwnerActor, TEnumAsByte<EBTNodeResult> NodeResult);                            // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.PerformConditionCheckAI
	// bool PerformConditionCheckAI(class AAIController* OwnerController, class APawn* ControlledPawn);                         // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.PerformConditionCheck
	// bool PerformConditionCheck(class AActor* OwnerActor);                                                                    // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.IsDecoratorObserverActive
	// bool IsDecoratorObserverActive();                                                                                        // [0x5145a30] Final|RequiredAPI|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.IsDecoratorExecutionActive
	// bool IsDecoratorExecutionActive();                                                                                       // [0x5145ac0] Final|RequiredAPI|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void ReceiveSearchStartAI(class AAIController* OwnerController, class APawn* ControlledPawn);                            // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTService_BlueprintBase.ReceiveSearchStart
	// void ReceiveSearchStart(class AActor* OwnerActor);                                                                       // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTService_BlueprintBase.ReceiveDeactivationAI
	// void ReceiveDeactivationAI(class AAIController* OwnerController, class APawn* ControlledPawn);                           // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTService_BlueprintBase.ReceiveDeactivation
	// void ReceiveDeactivation(class AActor* OwnerActor);                                                                      // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTService_BlueprintBase.ReceiveActivationAI
	// void ReceiveActivationAI(class AAIController* OwnerController, class APawn* ControlledPawn);                             // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTService_BlueprintBase.ReceiveActivation
	// void ReceiveActivation(class AActor* OwnerActor);                                                                        // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTService_BlueprintBase.IsServiceActive
	// bool IsServiceActive();                                                                                                  // [0x5151970] Final|RequiredAPI|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	bool                                               bUpdateBBOnFail;                                            // 0x00F8   (0x0001)  
	unsigned char                                      UnknownData00_6[0x17];                                      // 0x00F9   (0x0017)  MISSED
	class AController*                                 QueryOwnerController;                                       // 0x0110   (0x0008)  
};
...
public:
	...
	// void SetFinishOnMessageWithId(FName MessageName, int32_t RequestID);                                                     // [0x5155b20] Final|RequiredAPI|Native|Protected|BlueprintCallable 
	// Function /Script/AIModule.BTTask_BlueprintBase.SetFinishOnMessage
	// void SetFinishOnMessage(FName MessageName);                                                                              // [0x5155d10] Final|RequiredAPI|Native|Protected|BlueprintCallable 
	...
	// void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);                                // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTTask_BlueprintBase.ReceiveExecute
	// void ReceiveExecute(class AActor* OwnerActor);                                                                           // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTTask_BlueprintBase.ReceiveAbortAI
	// void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn);                                  // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTTask_BlueprintBase.ReceiveAbort
	// void ReceiveAbort(class AActor* OwnerActor);                                                                             // [0x1a821d0] RequiredAPI|Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTTask_BlueprintBase.IsTaskExecuting
	// bool IsTaskExecuting();                                                                                                  // [0x5155aa0] Final|RequiredAPI|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BTTask_BlueprintBase.IsTaskAborting
	// bool IsTaskAborting();                                                                                                   // [0x5155a70] Final|RequiredAPI|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BTTask_BlueprintBase.FinishExecute
	// void FinishExecute(bool bSuccess);                                                                                       // [0x5155ef0] Final|RequiredAPI|Native|Protected|BlueprintCallable 
	// Function /Script/AIModule.BTTask_BlueprintBase.FinishAbort
	// void FinishAbort();                                                                                                      // [0x5155e50] Final|RequiredAPI|Native|Protected|BlueprintCallable 
};
...
public:
	...
	bool                                               bRequireNavigableEndLocation : 1;                           // 0x00BC:4 (0x0001)  
	bool                                               bProjectGoalLocation : 1;                                   // 0x00BC:5 (0x0001)  
	bool                                               bReachTestIncludesAgentRadius : 1;                          // 0x00BC:6 (0x0001)  
	bool                                               bReachTestIncludesGoalRadius : 1;                           // 0x00BC:7 (0x0001)  
	bool                                               bStopOnOverlap : 1;                                         // 0x00BD:0 (0x0001)  
	bool                                               bStopOnOverlapNeedsUpdate : 1;                              // 0x00BD:1 (0x0001)  
...
/// Size: 0x0180 (384 bytes) (0x0000A8 - 0x000180) align 8 MaxSize: 0x0180
...
public:
	...
	bool                                               bUpdateBBOnFail;                                            // 0x0160   (0x0001)  
	unsigned char                                      UnknownData02_7[0x1F];                                      // 0x0161   (0x001F)  MISSED
};
...
public:
	...
	// void UnlockAIResourcesWithAnimation(class UAnimInstance* AnimInstance, bool bUnlockMovement, bool UnlockAILogic);        // [0x5162030] Final|RequiredAPI|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.SpawnAIFromClass
	// class APawn* SpawnAIFromClass(class UObject* WorldContextObject, class UClass* PawnClass, class UBehaviorTree* BehaviorTree, FVector Location, FRotator Rotation, bool bNoCollisionFail, class AActor* Owner); // [0x5162910] Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.SimpleMoveToLocation
	// void SimpleMoveToLocation(class AController* Controller, FVector& Goal);                                                 // [0x5161280] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.SimpleMoveToActor
	// void SimpleMoveToActor(class AController* Controller, class AActor* Goal);                                               // [0x5161410] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.SendAIMessage
	// void SendAIMessage(class APawn* Target, FName Message, class UObject* MessageSource, bool bSuccess);                     // [0x5162da0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.LockAIResourcesWithAnimation
	// void LockAIResourcesWithAnimation(class UAnimInstance* AnimInstance, bool bLockMovement, bool LockAILogic);              // [0x5162340] Final|RequiredAPI|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.IsValidAIRotation
	// bool IsValidAIRotation(FRotator Rotation);                                                                               // [0x5161c40] Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.IsValidAILocation
	// bool IsValidAILocation(FVector Location);                                                                                // [0x5161ed0] Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.IsValidAIDirection
	// bool IsValidAIDirection(FVector DirectionVector);                                                                        // [0x5161d60] Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.GetNextNavLinkIndex
	// int32_t GetNextNavLinkIndex(class AController* Controller);                                                              // [0x5161590] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.GetCurrentPathPoints
	// TArray<FVector> GetCurrentPathPoints(class AController* Controller);                                                     // [0x5161910] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.GetCurrentPathIndex
	// int32_t GetCurrentPathIndex(class AController* Controller);                                                              // [0x51617c0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.GetCurrentPath
	// class UNavigationPath* GetCurrentPath(class AController* Controller);                                                    // [0x5161a40] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.GetBlackboard
	// class UBlackboardComponent* GetBlackboard(class AActor* Target);                                                         // [0x5162650] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.GetAIController
	// class AAIController* GetAIController(class AActor* ControlledActor);                                                     // [0x51627c0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.CreateMoveToProxyObject
	// class UAIAsyncTaskBlueprintProxy* CreateMoveToProxyObject(class UObject* WorldContextObject, class APawn* Pawn, FVector Destination, class AActor* TargetActor, float AcceptanceRadius, bool bStopOnOverlap); // [0x5163110] Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
/// Size: 0x05B0 (1456 bytes) (0x0005B0 - 0x0005B0) align 8 MaxSize: 0x05B0
...
public:
	...
	// void ProvideSingleLocation(class UObject* QuerierObject, class AActor* QuerierActor, FVector& ResultingLocation);        // [0x1a821d0] Event|Public|HasOutParms|HasDefaults|BlueprintEvent|Const 
	// Function /Script/AIModule.EnvQueryContext_BlueprintBase.ProvideSingleActor
	// void ProvideSingleActor(class UObject* QuerierObject, class AActor* QuerierActor, class AActor*& ResultingActor);        // [0x1a821d0] Event|Public|HasOutParms|BlueprintEvent|Const 
	// Function /Script/AIModule.EnvQueryContext_BlueprintBase.ProvideLocationsSet
	// void ProvideLocationsSet(class UObject* QuerierObject, class AActor* QuerierActor, TArray<FVector>& ResultingLocationSet); // [0x1a821d0] Event|Public|HasOutParms|BlueprintEvent|Const 
	// Function /Script/AIModule.EnvQueryContext_BlueprintBase.ProvideActorsSet
	// void ProvideActorsSet(class UObject* QuerierObject, class AActor* QuerierActor, TArray<AActor*>& ResultingActorsSet);    // [0x1a821d0] Event|Public|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	SDK_UNDEFINED(16,355) /* FMulticastInlineDelegate */ __um(OnQueryFinishedEvent);                               // 0x0070   (0x0010)  


	/// Functions
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.SetNamedParam
	// void SetNamedParam(FName ParamName, float Value);                                                                        // [0x516d5c0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.SetNamedIntParam
	// void SetNamedIntParam(FName ParamName, int32_t Value);                                                                   // [0x516d3f0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.SetNamedBoolParam
	// void SetNamedBoolParam(FName ParamName, bool Value);                                                                     // [0x516d210] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetResultsAsLocations
	// TArray<FVector> GetResultsAsLocations();                                                                                 // [0x516d790] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetResultsAsActors
	// TArray<AActor*> GetResultsAsActors();                                                                                    // [0x516d8a0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetQueryResultsAsLocations
	// bool GetQueryResultsAsLocations(TArray<FVector>& ResultLocations);                                                       // [0x516d940] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetQueryResultsAsActors
	// bool GetQueryResultsAsActors(TArray<AActor*>& ResultActors);                                                             // [0x516db10] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetItemScore
	// float GetItemScore(int32_t ItemIndex);                                                                                   // [0x516dc50] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.EQSQueryDoneSignature__DelegateSignature
	// void EQSQueryDoneSignature__DelegateSignature(class UEnvQueryInstanceBlueprintWrapper* QueryInstance, TEnumAsByte<EEnvQueryStatus> QueryStatus); // [0x1a821d0] MulticastDelegate|Public|Delegate 
};
...
{ 
	...
	unsigned char                                      UnknownData00_7[0x188];                                     // 0x0008   (0x0188)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_8[0x70];                                      // 0x0050   (0x0070)  MISSED
	TArray<FEnvQueryInstanceCache>                     InstanceCache;                                              // 0x00C0   (0x0010)  
	TArray<class UEnvQueryContext*>                    LocalContexts;                                              // 0x00D0   (0x0010)  
	TArray<class UEnvQueryInstanceBlueprintWrapper*>   GCShieldedWrappers;                                         // 0x00E0   (0x0010)  
	unsigned char                                      UnknownData01_6[0x54];                                      // 0x00F0   (0x0054)  MISSED
	float                                              MaxAllowedTestingTime;                                      // 0x0144   (0x0004)  
	bool                                               bTestQueriesUsingBreadth;                                   // 0x0148   (0x0001)  
	unsigned char                                      UnknownData02_6[0x3];                                       // 0x0149   (0x0003)  MISSED
	int32_t                                            QueryCountWarningThreshold;                                 // 0x014C   (0x0004)  
	double                                             QueryCountWarningInterval;                                  // 0x0150   (0x0008)  
	double                                             ExecutionTimeWarningSeconds;                                // 0x0158   (0x0008)  
	double                                             HandlingResultTimeWarningSeconds;                           // 0x0160   (0x0008)  
	double                                             GenerationTimeWarningSeconds;                               // 0x0168   (0x0008)  


	/// Functions
	// Function /Script/AIModule.EnvQueryManager.RunEQSQuery
	// class UEnvQueryInstanceBlueprintWrapper* RunEQSQuery(class UObject* WorldContextObject, class UEnvQuery* QueryTemplate, class UObject* Querier, TEnumAsByte<EEnvQueryRunMode> RunMode, class UClass* WrapperClass); // [0x516f110] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
};
...
/// Size: 0x0710 (1808 bytes) (0x0006D8 - 0x000710) align 16 MaxSize: 0x0710
class UEQSRenderingComponent : public UDebugDrawComponent
{ 
public:
	unsigned char                                      UnknownData00_1[0x38];                                      // 0x06D8   (0x0038)  MISSED
};

/// Class /Script/AIModule.EQSTestingPawn
/// Size: 0x0900 (2304 bytes) (0x000858 - 0x000900) align 16 MaxSize: 0x0900
class AEQSTestingPawn : public ACharacter
{ 
public:
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0858   (0x0008)  MISSED
	class UEnvQuery*                                   QueryTemplate;                                              // 0x0860   (0x0008)  
	TArray<FEnvNamedValue>                             QueryParams;                                                // 0x0868   (0x0010)  
	TArray<FAIDynamicParam>                            QueryConfig;                                                // 0x0878   (0x0010)  
	float                                              TimeLimitPerStep;                                           // 0x0888   (0x0004)  
	int32_t                                            StepToDebugDraw;                                            // 0x088C   (0x0004)  
	EEnvQueryHightlightMode                            HighlightMode;                                              // 0x0890   (0x0001)  
	unsigned char                                      UnknownData01_6[0x3];                                       // 0x0891   (0x0003)  MISSED
	bool                                               bDrawLabels : 1;                                            // 0x0894:0 (0x0001)  
	bool                                               bDrawFailedItems : 1;                                       // 0x0894:1 (0x0001)  
	bool                                               bReRunQueryOnlyOnFinishedMove : 1;                          // 0x0894:2 (0x0001)  
	bool                                               bShouldBeVisibleInGame : 1;                                 // 0x0894:3 (0x0001)  
	bool                                               bTickDuringGame : 1;                                        // 0x0894:4 (0x0001)  
	unsigned char                                      UnknownData02_5[0x3];                                       // 0x0895   (0x0003)  MISSED
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                               // 0x0898   (0x0001)  
	unsigned char                                      UnknownData03_6[0x7];                                       // 0x0899   (0x0007)  MISSED
	FNavAgentProperties                                NavAgentProperties;                                         // 0x08A0   (0x0040)  
	unsigned char                                      UnknownData04_7[0x20];                                      // 0x08E0   (0x0020)  MISSED
};

/// Class /Script/AIModule.EnvQueryGenerator_ActorsOfClass
/// Size: 0x00E8 (232 bytes) (0x000058 - 0x0000E8) align 8 MaxSize: 0x00E8
...
public:
	...
	// class UObject* GetQuerier();                                                                                             // [0x51824a0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.EnvQueryGenerator_BlueprintBase.DoItemGenerationFromActors
	// void DoItemGenerationFromActors(TArray<AActor*>& ContextActors);                                                         // [0x1a821d0] RequiredAPI|Event|Public|HasOutParms|BlueprintEvent|Const 
	// Function /Script/AIModule.EnvQueryGenerator_BlueprintBase.DoItemGeneration
	// void DoItemGeneration(TArray<FVector>& ContextLocations);                                                                // [0x1a821d0] RequiredAPI|Event|Public|HasOutParms|BlueprintEvent|Const 
	// Function /Script/AIModule.EnvQueryGenerator_BlueprintBase.AddGeneratedVector
	// void AddGeneratedVector(FVector GeneratedVector);                                                                        // [0x51825d0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|Const 
	// Function /Script/AIModule.EnvQueryGenerator_BlueprintBase.AddGeneratedActor
	// void AddGeneratedActor(class AActor* GeneratedActor);                                                                    // [0x51824e0] Final|RequiredAPI|Native|Public|BlueprintCallable|Const 
};
...
{ 
	...
	FName                                              TraceProfileName;                                           // 0x002C   (0x000C)  
	TEnumAsByte<EEnvTraceShape>                        TraceShape;                                                 // 0x0038   (0x0001)  
	TEnumAsByte<EEnvQueryTrace>                        TraceMode;                                                  // 0x0039   (0x0001)  
	TEnumAsByte<EEnvQueryTraceResult>                  TraceResult;                                                // 0x003A   (0x0001)  
	unsigned char                                      UnknownData02_6[0x1];                                       // 0x003B   (0x0001)  MISSED
	bool                                               bTraceComplex : 1;                                          // 0x003C:0 (0x0001)  
	bool                                               bOnlyBlockingHits : 1;                                      // 0x003C:1 (0x0001)  
	bool                                               bCanTraceOnNavMesh : 1;                                     // 0x003C:2 (0x0001)  
	bool                                               bCanTraceOnGeometry : 1;                                    // 0x003C:3 (0x0001)  
	bool                                               bCanDisableTrace : 1;                                       // 0x003C:4 (0x0001)  
	bool                                               bCanProjectDown : 1;                                        // 0x003C:5 (0x0001)  
...
{ 
public:
	FEnvTraceData                                      ProjectionData;                                             // 0x0058   (0x0040)  
};
...
{ 
public:
	FAIDataProviderFloatValue                          AlignedPointsDistance;                                      // 0x0098   (0x0040)  
	FAIDataProviderFloatValue                          ConeDegrees;                                                // 0x00D8   (0x0040)  
	FAIDataProviderFloatValue                          AngleStep;                                                  // 0x0118   (0x0040)  
	FAIDataProviderFloatValue                          Range;                                                      // 0x0158   (0x0040)  
	class UClass*                                      CenterActor;                                                // 0x0198   (0x0008)  
	bool                                               bIncludeContextLocation : 1;                                // 0x01A0:0 (0x0001)  
...
/// Size: 0x0210 (528 bytes) (0x000098 - 0x000210) align 8 MaxSize: 0x0210
class UEnvQueryGenerator_Donut : public UEnvQueryGenerator_ProjectedPoints
{ 
public:
	FAIDataProviderFloatValue                          InnerRadius;                                                // 0x0098   (0x0040)  
	FAIDataProviderFloatValue                          OuterRadius;                                                // 0x00D8   (0x0040)  
	FAIDataProviderIntValue                            NumberOfRings;                                              // 0x0118   (0x0040)  
	FAIDataProviderIntValue                            PointsPerRing;                                              // 0x0158   (0x0040)  
	FEnvDirection                                      ArcDirection;                                               // 0x0198   (0x0020)  
	FAIDataProviderFloatValue                          ArcAngle;                                                   // 0x01B8   (0x0040)  
	bool                                               bUseSpiralPattern;                                          // 0x01F8   (0x0001)  
	unsigned char                                      UnknownData00_6[0x7];                                       // 0x01F9   (0x0007)  MISSED
	class UClass*                                      Center;                                                     // 0x0200   (0x0008)  
...
/// Size: 0x0260 (608 bytes) (0x000098 - 0x000260) align 8 MaxSize: 0x0260
class UEnvQueryGenerator_OnCircle : public UEnvQueryGenerator_ProjectedPoints
{ 
public:
	FAIDataProviderFloatValue                          CircleRadius;                                               // 0x0098   (0x0040)  
	FAIDataProviderFloatValue                          SpaceBetween;                                               // 0x00D8   (0x0040)  
	FAIDataProviderIntValue                            NumberOfPoints;                                             // 0x0118   (0x0040)  
	EPointOnCircleSpacingMethod                        PointOnCircleSpacingMethod;                                 // 0x0158   (0x0001)  
	unsigned char                                      UnknownData00_6[0x7];                                       // 0x0159   (0x0007)  MISSED
	FEnvDirection                                      ArcDirection;                                               // 0x0160   (0x0020)  
	FAIDataProviderFloatValue                          ArcAngle;                                                   // 0x0180   (0x0040)  
	float                                              AngleRadians;                                               // 0x01C0   (0x0004)  
	unsigned char                                      UnknownData01_6[0x4];                                       // 0x01C4   (0x0004)  MISSED
	class UClass*                                      CircleCenter;                                               // 0x01C8   (0x0008)  
	bool                                               bIgnoreAnyContextActorsWhenGeneratingCircle;                // 0x01D0   (0x0001)  
	unsigned char                                      UnknownData02_6[0x7];                                       // 0x01D1   (0x0007)  MISSED
	FAIDataProviderFloatValue                          CircleCenterZOffset;                                        // 0x01D8   (0x0040)  
	FEnvTraceData                                      TraceData;                                                  // 0x0218   (0x0040)  
	bool                                               bDefineArc : 1;                                             // 0x0258:0 (0x0001)  
	unsigned char                                      UnknownData03_7[0x7];                                       // 0x0259   (0x0007)  MISSED
};
...
{ 
public:
	FAIDataProviderFloatValue                          GridSize;                                                   // 0x0098   (0x0040)  
	FAIDataProviderFloatValue                          SpaceBetween;                                               // 0x00D8   (0x0040)  
	class UClass*                                      GenerateAround;                                             // 0x0118   (0x0008)  
};
...
{ 
public:
	FAIDataProviderBoolValue                           PathToItem;                                                 // 0x0120   (0x0040)  
	class UClass*                                      NavigationFilter;                                           // 0x0160   (0x0008)  
	FAIDataProviderFloatValue                          ScanRangeMultiplier;                                        // 0x0168   (0x0040)  
};
...
{ 
public:
	class UClass*                                      AllowedActorClass;                                          // 0x0058   (0x0008)  
	FAIDataProviderFloatValue                          SearchRadius;                                               // 0x0060   (0x0040)  
	class UClass*                                      ListenerContext;                                            // 0x00A0   (0x0008)  
	class UClass*                                      SenseToUse;                                                 // 0x00A8   (0x0008)  
	bool                                               bIncludeKnownActors;                                        // 0x00B0   (0x0001)  
...
/// Size: 0x0280 (640 bytes) (0x000238 - 0x000280) align 8 MaxSize: 0x0280
...
/// Size: 0x02A8 (680 bytes) (0x000238 - 0x0002A8) align 8 MaxSize: 0x02A8
class UEnvQueryTest_GameplayTags : public UEnvQueryTest
{ 
public:
	FGameplayTagQuery                                  TagQueryToMatch;                                            // 0x0238   (0x0048)  
	bool                                               bRejectIncompatibleItems;                                   // 0x0280   (0x0001)  
	bool                                               bUpdatedToUseQuery;                                         // 0x0281   (0x0001)  
	EGameplayContainerMatchType                        TagsToMatch;                                                // 0x0282   (0x0001)  
	unsigned char                                      UnknownData00_6[0x5];                                       // 0x0283   (0x0005)  MISSED
...
/// Size: 0x0270 (624 bytes) (0x000238 - 0x000270) align 8 MaxSize: 0x0270
class UEnvQueryTest_Overlap : public UEnvQueryTest
{ 
public:
	FEnvOverlapData                                    OverlapData;                                                // 0x0238   (0x0030)  
	class UClass*                                      CollisionIgnoreContext;                                     // 0x0268   (0x0008)  
};

/// Class /Script/AIModule.EnvQueryTest_Pathfinding
/// Size: 0x02F0 (752 bytes) (0x000238 - 0x0002F0) align 8 MaxSize: 0x02F0
...
public:
	...
	bool                                               bProjectToNavmesh;                                          // 0x02D0   (0x0001)  
	unsigned char                                      UnknownData01_6[0x7];                                       // 0x02D1   (0x0007)  MISSED
	FVector                                            NavMeshProjectionExtents;                                   // 0x02D8   (0x0018)  
};

/// Class /Script/AIModule.EnvQueryTest_PathfindingBatch
/// Size: 0x0330 (816 bytes) (0x0002F0 - 0x000330) align 8 MaxSize: 0x0330
class UEnvQueryTest_PathfindingBatch : public UEnvQueryTest_Pathfinding
{ 
public:
	FAIDataProviderFloatValue                          ScanRangeMultiplier;                                        // 0x02F0   (0x0040)  
};

/// Class /Script/AIModule.EnvQueryTest_Project
/// Size: 0x0278 (632 bytes) (0x000238 - 0x000278) align 8 MaxSize: 0x0278
class UEnvQueryTest_Project : public UEnvQueryTest
{ 
public:
	FEnvTraceData                                      ProjectionData;                                             // 0x0238   (0x0040)  
};
...
/// Size: 0x0348 (840 bytes) (0x000238 - 0x000348) align 8 MaxSize: 0x0348
class UEnvQueryTest_Trace : public UEnvQueryTest
{ 
public:
	FEnvTraceData                                      TraceData;                                                  // 0x0238   (0x0040)  
	FAIDataProviderBoolValue                           TraceFromContext;                                           // 0x0278   (0x0040)  
	FAIDataProviderFloatValue                          ItemHeightOffset;                                           // 0x02B8   (0x0040)  
	FAIDataProviderFloatValue                          ContextHeightOffset;                                        // 0x02F8   (0x0040)  
	bool                                               bEdgeToEdge;                                                // 0x0338   (0x0001)  
	unsigned char                                      UnknownData00_6[0x7];                                       // 0x0339   (0x0007)  MISSED
	class UClass*                                      Context;                                                    // 0x0340   (0x0008)  
};

/// Class /Script/AIModule.EnvQueryTest_Volume
/// Size: 0x0250 (592 bytes) (0x000238 - 0x000250) align 8 MaxSize: 0x0250
...
public:
	...
	bool                                               bSkipTestIfNoVolumes : 1;                                   // 0x0248:1 (0x0001)  
...
/// Size: 0x0310 (784 bytes) (0x0000D8 - 0x000310) align 8 MaxSize: 0x0310
class UPathFollowingComponent : public UActorComponent
{ 
public:
	unsigned char                                      UnknownData00_8[0x38];                                      // 0x00D8   (0x0038)  MISSED
	bool                                               ShouldUse2DReachedTargetCheckOnGround;                      // 0x0110   (0x0001)  
	unsigned char                                      UnknownData01_6[0x3];                                       // 0x0111   (0x0003)  MISSED
	float                                              MinAgentRadiusReachDistance2D;                              // 0x0114   (0x0004)  
	float                                              MinAgentHeightReach;                                        // 0x0118   (0x0004)  
	unsigned char                                      UnknownData02_6[0x4];                                       // 0x011C   (0x0004)  MISSED
	class UNavMovementComponent*                       MovementComp;                                               // 0x0120   (0x0008)  
	unsigned char                                      UnknownData03_6[0x8];                                       // 0x0128   (0x0008)  MISSED
	class ANavigationData*                             MyNavData;                                                  // 0x0130   (0x0008)  
	unsigned char                                      UnknownData04_7[0x1D8];                                     // 0x0138   (0x01D8)  MISSED


	/// Functions
	// Function /Script/AIModule.PathFollowingComponent.OnNavDataRegistered
	// void OnNavDataRegistered(class ANavigationData* NavData);                                                                // [0x51af9b0] Final|RequiredAPI|Native|Protected 
	// Function /Script/AIModule.PathFollowingComponent.OnActorBump
	// void OnActorBump(class AActor* SelfActor, class AActor* OtherActor, FVector NormalImpulse, FHitResult& Hit);             // [0x51afc60] RequiredAPI|Native|Public|HasOutParms|HasDefaults 
	// Function /Script/AIModule.PathFollowingComponent.GetPathDestination
	// FVector GetPathDestination();                                                                                            // [0x51afb10] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.PathFollowingComponent.GetPathCorridorPoints
	// TArray<FVector> GetPathCorridorPoints();                                                                                 // [0x51affc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.PathFollowingComponent.GetPathActionType
	// TEnumAsByte<EPathFollowingAction> GetPathActionType();                                                                   // [0x51afbc0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.PathFollowingComponent.FindClosestPathCorridorPoint
	// int32_t FindClosestPathCorridorPoint();                                                                                  // [0x51aff90] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	unsigned char                                      UnknownData00_8[0x18];                                      // 0x0310   (0x0018)  MISSED
	FVector                                            CrowdAgentMoveDirection;                                    // 0x0328   (0x0018)  
	unsigned char                                      UnknownData01_7[0x20];                                      // 0x0340   (0x0020)  MISSED


	/// Functions
	// Function /Script/AIModule.CrowdFollowingComponent.SuspendCrowdSteering
	// void SuspendCrowdSteering(bool bSuspend);                                                                                // [0x51a0490] RequiredAPI|Native|Public|BlueprintCallable 
};
...
{ 
public:
	class UNavLocalGridManager*                        GridManager;                                                // 0x0310   (0x0008)  
...
public:
	...
	TArray<FNavigationLink>                            PointLinks;                                                 // 0x0470   (0x0010)  
	TArray<FNavigationSegmentLink>                     SegmentLinks;                                               // 0x0480   (0x0010)  
	class UNavLinkCustomComponent*                     SmartLinkComp;                                              // 0x0490   (0x0008)  
	bool                                               bSmartLinkIsRelevant;                                       // 0x0498   (0x0001)  
	unsigned char                                      UnknownData01_6[0x7];                                       // 0x0499   (0x0007)  MISSED
	SDK_UNDEFINED(16,356) /* FMulticastInlineDelegate */ __um(OnSmartLinkReached);                                 // 0x04A0   (0x0010)  


	/// Functions
	// Function /Script/AIModule.NavLinkProxy.SetSmartLinkEnabled
	// void SetSmartLinkEnabled(bool bEnabled);                                                                                 // [0x51a8600] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.NavLinkProxy.ResumePathFollowing
	// void ResumePathFollowing(class AActor* Agent);                                                                           // [0x51a8730] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.NavLinkProxy.ReceiveSmartLinkReached
	// void ReceiveSmartLinkReached(class AActor* Agent, FVector& Destination);                                                 // [0x1a821d0] RequiredAPI|Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/AIModule.NavLinkProxy.IsSmartLinkEnabled
	// bool IsSmartLinkEnabled();                                                                                               // [0x51a8700] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.NavLinkProxy.HasMovingAgents
	// bool HasMovingAgents();                                                                                                  // [0x51a8570] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool SetLocalNavigationGridDensity(class UObject* WorldContextObject, float CellSize);                                   // [0x51ad1e0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.NavLocalGridManager.RemoveLocalNavigationGrid
	// void RemoveLocalNavigationGrid(class UObject* WorldContextObject, int32_t GridId, bool bRebuildGrids);                   // [0x51abde0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.NavLocalGridManager.FindLocalNavigationGridPath
	// bool FindLocalNavigationGridPath(class UObject* WorldContextObject, FVector& Start, FVector& End, TArray<FVector>& PathPoints); // [0x51abaa0] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.NavLocalGridManager.AddLocalNavigationGridForPoints
	// int32_t AddLocalNavigationGridForPoints(class UObject* WorldContextObject, TArray<FVector>& Locations, int32_t Radius2D, float Height, bool bRebuildGrids); // [0x51aca90] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.NavLocalGridManager.AddLocalNavigationGridForPoint
	// int32_t AddLocalNavigationGridForPoint(class UObject* WorldContextObject, FVector& Location, int32_t Radius2D, float Height, bool bRebuildGrids); // [0x51ace60] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.NavLocalGridManager.AddLocalNavigationGridForCapsule
	// int32_t AddLocalNavigationGridForCapsule(class UObject* WorldContextObject, FVector& Location, float CapsuleRadius, float CapsuleHalfHeight, int32_t Radius2D, float Height, bool bRebuildGrids); // [0x51ac040] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.NavLocalGridManager.AddLocalNavigationGridForBox
	// int32_t AddLocalNavigationGridForBox(class UObject* WorldContextObject, FVector& Location, FVector Extent, FRotator Rotation, int32_t Radius2D, float Height, bool bRebuildGrids); // [0x51ac4c0] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
/// Size: 0x01D0 (464 bytes) (0x0000D8 - 0x0001D0) align 8 MaxSize: 0x01D0
class UAIPerceptionComponent : public UActorComponent
{ 
public:
	TArray<class UAISenseConfig*>                      SensesConfig;                                               // 0x00D8   (0x0010)  
	class UClass*                                      DominantSense;                                              // 0x00E8   (0x0008)  
	unsigned char                                      UnknownData00_6[0x10];                                      // 0x00F0   (0x0010)  MISSED
	class AAIController*                               AIOwner;                                                    // 0x0100   (0x0008)  
	unsigned char                                      UnknownData01_6[0x80];                                      // 0x0108   (0x0080)  MISSED
	SDK_UNDEFINED(16,357) /* FMulticastInlineDelegate */ __um(OnPerceptionUpdated);                                // 0x0188   (0x0010)  
	SDK_UNDEFINED(16,358) /* FMulticastInlineDelegate */ __um(OnTargetPerceptionForgotten);                        // 0x0198   (0x0010)  
	SDK_UNDEFINED(16,359) /* FMulticastInlineDelegate */ __um(OnTargetPerceptionUpdated);                          // 0x01A8   (0x0010)  
	SDK_UNDEFINED(16,360) /* FMulticastInlineDelegate */ __um(OnTargetPerceptionInfoUpdated);                      // 0x01B8   (0x0010)  
	EAISenseActorSize                                  MinPerceivableSize;                                         // 0x01C8   (0x0001)  
	unsigned char                                      UnknownData02_7[0x7];                                       // 0x01C9   (0x0007)  MISSED


	/// Functions
	// Function /Script/AIModule.AIPerceptionComponent.SetSenseEnabled
	// void SetSenseEnabled(class UClass* SenseClass, bool bEnable);                                                            // [0x51bd910] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionComponent.RequestStimuliListenerUpdate
	// void RequestStimuliListenerUpdate();                                                                                     // [0x51be750] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionComponent.OnOwnerEndPlay
	// void OnOwnerEndPlay(class AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                                     // [0x51be7a0] Final|RequiredAPI|Native|Public 
	// Function /Script/AIModule.AIPerceptionComponent.GetPerceivedHostileActorsBySense
	// void GetPerceivedHostileActorsBySense(class UClass* SenseToUse, TArray<AActor*>& OutActors);                             // [0x51be410] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetPerceivedHostileActors
	// void GetPerceivedHostileActors(TArray<AActor*>& OutActors);                                                              // [0x51be5f0] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetKnownPerceivedActors
	// void GetKnownPerceivedActors(class UClass* SenseToUse, TArray<AActor*>& OutActors);                                      // [0x51be050] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetCurrentlyPerceivedActors
	// void GetCurrentlyPerceivedActors(class UClass* SenseToUse, TArray<AActor*>& OutActors);                                  // [0x51be230] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetActorsPerception
	// bool GetActorsPerception(class AActor* Actor, FActorPerceptionBlueprintInfo& Info);                                      // [0x51bdc70] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionComponent.ForgetAll
	// void ForgetAll();                                                                                                        // [0x51be730] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionComponent.CanActorBePerceived
	// bool CanActorBePerceived(class AActor* Actor);                                                                           // [0x51bd800] RequiredAPI|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	bool                                               bAutoRegisterAsSource : 1;                                  // 0x00D8:0 (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x00D9   (0x0007)  MISSED
	TArray<class UClass*>                              RegisterAsSourceForSenses;                                  // 0x00E0   (0x0010)  
	EAISenseActorSize                                  StimulusSize;                                               // 0x00F0   (0x0001)  
	...
	// void UnregisterFromSense(class UClass* SenseClass);                                                                      // [0x51c2210] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionStimuliSourceComponent.UnregisterFromPerceptionSystem
	// void UnregisterFromPerceptionSystem();                                                                                   // [0x51c2490] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionStimuliSourceComponent.RegisterWithPerceptionSystem
	// void RegisterWithPerceptionSystem();                                                                                     // [0x51c27c0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionStimuliSourceComponent.RegisterForSense
	// void RegisterForSense(class UClass* SenseClass);                                                                         // [0x51c2560] Final|RequiredAPI|Native|Public|BlueprintCallable 
};

/// Class /Script/AIModule.AIPerceptionSystem
/// Size: 0x0150 (336 bytes) (0x000050 - 0x000150) align 8 MaxSize: 0x0150
class UAIPerceptionSystem : public UAISubsystem
{ 
public:
	unsigned char                                      UnknownData00_8[0x50];                                      // 0x0050   (0x0050)  MISSED
	TArray<class UAISense*>                            Senses;                                                     // 0x00A0   (0x0010)  
	float                                              PerceptionAgingRate;                                        // 0x00B0   (0x0004)  
	unsigned char                                      UnknownData01_7[0x9C];                                      // 0x00B4   (0x009C)  MISSED


	/// Functions
	// Function /Script/AIModule.AIPerceptionSystem.ReportPerceptionEvent
	// void ReportPerceptionEvent(class UObject* WorldContextObject, class UAISenseEvent* PerceptionEvent);                     // [0x51c3320] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionSystem.ReportEvent
	// void ReportEvent(class UAISenseEvent* PerceptionEvent);                                                                  // [0x51c3550] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionSystem.RegisterPerceptionStimuliSource
	// bool RegisterPerceptionStimuliSource(class UObject* WorldContextObject, class UClass* Sense, class AActor* Target);      // [0x51c3100] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionSystem.OnPerceptionStimuliSourceEndPlay
	// void OnPerceptionStimuliSourceEndPlay(class AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                   // [0x51c2d20] Final|RequiredAPI|Native|Protected 
	// Function /Script/AIModule.AIPerceptionSystem.GetSenseClassForStimulus
	// class UClass* GetSenseClassForStimulus(class UObject* WorldContextObject, FAIStimulus& Stimulus);                        // [0x51c2eb0] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	bool                                               bWantsNewPawnNotification : 1;                              // 0x0034:0 (0x0001)  
	bool                                               bAutoRegisterAllPawnsAsSources : 1;                         // 0x0034:1 (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x0035   (0x0003)  MISSED
	class UAIPerceptionSystem*                         PerceptionSystemInstance;                                   // 0x0038   (0x0008)  
	unsigned char                                      UnknownData02_7[0x48];                                      // 0x0040   (0x0048)  MISSED
};
...
public:
	...
	// float OnUpdate(TArray<UAISenseEvent*>& EventsToProcess);                                                                 // [0x1a821d0] RequiredAPI|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.OnListenerUpdated
	// void OnListenerUpdated(class AActor* ActorListener, class UAIPerceptionComponent* PerceptionComponent);                  // [0x1a821d0] RequiredAPI|Event|Public|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.OnListenerUnregistered
	// void OnListenerUnregistered(class AActor* ActorListener, class UAIPerceptionComponent* PerceptionComponent);             // [0x1a821d0] RequiredAPI|Event|Public|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.OnListenerRegistered
	// void OnListenerRegistered(class AActor* ActorListener, class UAIPerceptionComponent* PerceptionComponent);               // [0x1a821d0] RequiredAPI|Event|Public|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.K2_OnNewPawn
	// void K2_OnNewPawn(class APawn* NewPawn);                                                                                 // [0x1a821d0] RequiredAPI|Event|Public|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.GetAllListenerComponents
	// void GetAllListenerComponents(TArray<UAIPerceptionComponent*>& ListenerComponents);                                      // [0x51c8980] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AISense_Blueprint.GetAllListenerActors
	// void GetAllListenerActors(TArray<AActor*>& ListenerActors);                                                              // [0x51c8b00] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void ReportDamageEvent(class UObject* WorldContextObject, class AActor* DamagedActor, class AActor* Instigator, float DamageAmount, FVector EventLocation, FVector HitLocation, FName Tag); // [0x51c9900] Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void ReportNoiseEvent(class UObject* WorldContextObject, FVector NoiseLocation, float Loudness, class AActor* Instigator, float MaxRange, FName Tag); // [0x51ca940] Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void RequestPawnPredictionEvent(class APawn* Requestor, class AActor* PredictedActor, float PredictionTime);             // [0x51cbe70] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AISense_Prediction.RequestControllerPredictionEvent
	// void RequestControllerPredictionEvent(class AAIController* Requestor, class AActor* PredictedActor, float PredictionTime); // [0x51cc0d0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	unsigned char                                      UnknownData00_8[0xD8];                                      // 0x0088   (0x00D8)  MISSED
	int32_t                                            MaxTracesPerTick;                                           // 0x0160   (0x0004)  
	int32_t                                            MaxAsyncTracesPerTick;                                      // 0x0164   (0x0004)  
	int32_t                                            MinQueriesPerTimeSliceCheck;                                // 0x0168   (0x0004)  
	unsigned char                                      UnknownData01_6[0x4];                                       // 0x016C   (0x0004)  MISSED
	double                                             MaxTimeSlicePerTick;                                        // 0x0170   (0x0008)  
	float                                              HighImportanceQueryDistanceThreshold;                       // 0x0178   (0x0004)  
	unsigned char                                      UnknownData02_6[0x4];                                       // 0x017C   (0x0004)  MISSED
	float                                              MaxQueryImportance;                                         // 0x0180   (0x0004)  
	float                                              SightLimitQueryImportance;                                  // 0x0184   (0x0004)  
	float                                              PendingQueriesBudgetReductionRatio;                         // 0x0188   (0x0004)  
	bool                                               bUseAsynchronousTraceForDefaultSightQueries;                // 0x018C   (0x0001)  
	unsigned char                                      UnknownData03_7[0x33];                                      // 0x018D   (0x0033)  MISSED


	/// Functions
	// Function /Script/AIModule.AISense_Sight.SetSightSenseUpdatesPerSecond
	// bool SetSightSenseUpdatesPerSecond(class UObject* WorldContextObject, int32_t NewUpdatesPerSecond);                      // [0x51cce40] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AISense_Sight.SetSightSenseMaxTimeSlicePerTick
	// bool SetSightSenseMaxTimeSlicePerTick(class UObject* WorldContextObject, double NewMaxTimeSlicePerTick);                 // [0x51cca40] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AISense_Sight.SetSightSenseMaxLineTracesPerTick
	// bool SetSightSenseMaxLineTracesPerTick(class UObject* WorldContextObject, int32_t NewMaxLineTraces);                     // [0x51ccbd0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void ReportTouchEvent(class UObject* WorldContextObject, class AActor* TouchReceiver, class AActor* OtherActor, FVector Location); // [0x51d1d00] Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
/// Size: 0x0120 (288 bytes) (0x0000D8 - 0x000120) align 8 MaxSize: 0x0120
class UPawnSensingComponent : public UActorComponent
{ 
public:
	float                                              HearingThreshold;                                           // 0x00D8   (0x0004)  
	float                                              LOSHearingThreshold;                                        // 0x00DC   (0x0004)  
	float                                              SightRadius;                                                // 0x00E0   (0x0004)  
	float                                              SensingInterval;                                            // 0x00E4   (0x0004)  
	float                                              HearingMaxSoundAge;                                         // 0x00E8   (0x0004)  
	bool                                               bEnableSensingUpdates : 1;                                  // 0x00EC:0 (0x0001)  
	bool                                               bOnlySensePlayers : 1;                                      // 0x00EC:1 (0x0001)  
	bool                                               bSeePawns : 1;                                              // 0x00EC:2 (0x0001)  
	bool                                               bHearNoises : 1;                                            // 0x00EC:3 (0x0001)  
	unsigned char                                      UnknownData00_5[0xB];                                       // 0x00ED   (0x000B)  MISSED
	SDK_UNDEFINED(16,361) /* FMulticastInlineDelegate */ __um(OnSeePawn);                                          // 0x00F8   (0x0010)  
	SDK_UNDEFINED(16,362) /* FMulticastInlineDelegate */ __um(OnHearNoise);                                        // 0x0108   (0x0010)  
	float                                              PeripheralVisionAngle;                                      // 0x0118   (0x0004)  
	float                                              PeripheralVisionCosine;                                     // 0x011C   (0x0004)  


	/// Functions
	// Function /Script/AIModule.PawnSensingComponent.SetSensingUpdatesEnabled
	// void SetSensingUpdatesEnabled(bool bEnabled);                                                                            // [0x51d27a0] RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnSensingComponent.SetSensingInterval
	// void SetSensingInterval(float NewSensingInterval);                                                                       // [0x51d28a0] RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnSensingComponent.SetPeripheralVisionAngle
	// void SetPeripheralVisionAngle(float NewPeripheralVisionAngle);                                                           // [0x51d26a0] RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnSensingComponent.SeePawnDelegate__DelegateSignature
	// void SeePawnDelegate__DelegateSignature(class APawn* Pawn);                                                              // [0x1a821d0] MulticastDelegate|Public|Delegate 
	// Function /Script/AIModule.PawnSensingComponent.HearNoiseDelegate__DelegateSignature
	// void HearNoiseDelegate__DelegateSignature(class APawn* Instigator, FVector& Location, float Volume);                     // [0x1a821d0] MulticastDelegate|Public|Delegate|HasOutParms|HasDefaults 
	// Function /Script/AIModule.PawnSensingComponent.GetPeripheralVisionCosine
	// float GetPeripheralVisionCosine();                                                                                       // [0x51d2660] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.PawnSensingComponent.GetPeripheralVisionAngle
	// float GetPeripheralVisionAngle();                                                                                        // [0x51d2680] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	SDK_UNDEFINED(16,363) /* FMulticastInlineDelegate */ __um(OnRequestFailed);                                    // 0x0078   (0x0010)  
	SDK_UNDEFINED(16,364) /* FMulticastInlineDelegate */ __um(OnMoveFinished);                                     // 0x0088   (0x0010)  
...
public:
	...
	// class UAITask_RunEQS* RunEQS(class AAIController* Controller, class UEnvQuery* QueryTemplate);                           // [0x51d6a80] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
};
...
{ 
	...
	FName                                              Tag;                                                        // 0x0040   (0x000C)  
	float                                              InitialSensedTime;                                          // 0x004C   (0x0004)  
	unsigned char                                      UnknownData01_6[0x10];                                      // 0x0050   (0x0010)  MISSED
	unsigned char                                      UnknownBit02 : 1;                                           // 0x0060:0 (0x0001)  MISSED
	bool                                               bSuccessfullySensed : 1;                                    // 0x0060:1 (0x0001)  
...
{ 
	...
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x000C   (0x0004)  MISSED
	FAIStimulus                                        Stimulus;                                                   // 0x0010   (0x0068)  
};
...
{ 
	...
	TEnumAsByte<ETeamAttitude>                         Attitude;                                                   // 0x0018   (0x0001)  
	unsigned char                                      UnknownData00_7[0x7];                                       // 0x0019   (0x0007)  MISSED
};
...
static_assert(sizeof(UAISenseConfig_Hearing) == 0x0068); // 104 bytes (0x000050 - 0x000068)
static_assert(sizeof(UAISenseConfig_Prediction) == 0x0050); // 80 bytes (0x000050 - 0x000050)
static_assert(sizeof(UAISenseConfig_Sight) == 0x0078); // 120 bytes (0x000050 - 0x000078)
...
static_assert(sizeof(FAIDamageEvent) == 0x0058); // 88 bytes (0x000000 - 0x000058)
static_assert(sizeof(UAISenseEvent_Damage) == 0x0088); // 136 bytes (0x000030 - 0x000088)
static_assert(sizeof(FAINoiseEvent) == 0x0040); // 64 bytes (0x000000 - 0x000040)
static_assert(sizeof(UAISenseEvent_Hearing) == 0x0070); // 112 bytes (0x000030 - 0x000070)
...
static_assert(sizeof(UPawnActionsComponent) == 0x0110); // 272 bytes (0x0000D8 - 0x000110)
static_assert(sizeof(UPawnAction_BlueprintBase) == 0x0098); // 152 bytes (0x000098 - 0x000098)
static_assert(sizeof(UPawnAction_Move) == 0x00F8); // 248 bytes (0x000098 - 0x0000F8)
...
static_assert(sizeof(AAIController) == 0x05B0); // 1456 bytes (0x000500 - 0x0005B0)
...
static_assert(sizeof(UAISubsystem) == 0x0050); // 80 bytes (0x000030 - 0x000050)
static_assert(sizeof(UAISystem) == 0x01D8); // 472 bytes (0x000078 - 0x0001D8)
...
static_assert(sizeof(UBrainComponent) == 0x0130); // 304 bytes (0x0000D8 - 0x000130)
static_assert(sizeof(UBehaviorTreeComponent) == 0x02C8); // 712 bytes (0x000130 - 0x0002C8)
...
static_assert(sizeof(UBlackboardComponent) == 0x01E0); // 480 bytes (0x0000D8 - 0x0001E0)
static_assert(sizeof(FBlackboardEntry) == 0x0020); // 32 bytes (0x000000 - 0x000020)
...
static_assert(sizeof(UBTCompositeNode) == 0x0088); // 136 bytes (0x000060 - 0x000088)
...
static_assert(sizeof(UBTComposite_Selector) == 0x0088); // 136 bytes (0x000088 - 0x000088)
static_assert(sizeof(UBTComposite_Sequence) == 0x0088); // 136 bytes (0x000088 - 0x000088)
static_assert(sizeof(UBTComposite_SimpleParallel) == 0x0090); // 144 bytes (0x000088 - 0x000090)
static_assert(sizeof(FBlackboardKeySelector) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(UBTDecorator_BlackboardBase) == 0x00A0); // 160 bytes (0x000070 - 0x0000A0)
static_assert(sizeof(UBTDecorator_Blackboard) == 0x00D0); // 208 bytes (0x0000A0 - 0x0000D0)
static_assert(sizeof(UBTDecorator_BlueprintBase) == 0x00A8); // 168 bytes (0x000070 - 0x0000A8)
static_assert(sizeof(UBTDecorator_CheckGameplayTagsOnActor) == 0x00D8); // 216 bytes (0x000070 - 0x0000D8)
static_assert(sizeof(UBTDecorator_CompareBBEntries) == 0x00D8); // 216 bytes (0x000070 - 0x0000D8)
static_assert(sizeof(UBTDecorator_ConditionalLoop) == 0x00D0); // 208 bytes (0x0000D0 - 0x0000D0)
static_assert(sizeof(UBTDecorator_ConeCheck) == 0x0110); // 272 bytes (0x000070 - 0x000110)
static_assert(sizeof(UBTDecorator_Cooldown) == 0x0078); // 120 bytes (0x000070 - 0x000078)
static_assert(sizeof(UBTDecorator_DoesPathExist) == 0x00E0); // 224 bytes (0x000070 - 0x0000E0)
static_assert(sizeof(UBTDecorator_ForceSuccess) == 0x0070); // 112 bytes (0x000070 - 0x000070)
static_assert(sizeof(FAIDataProviderValue) == 0x0028); // 40 bytes (0x000000 - 0x000028)
static_assert(sizeof(FAIDataProviderTypedValue) == 0x0038); // 56 bytes (0x000028 - 0x000038)
static_assert(sizeof(FAIDataProviderFloatValue) == 0x0040); // 64 bytes (0x000038 - 0x000040)
static_assert(sizeof(UBTDecorator_IsAtLocation) == 0x00F0); // 240 bytes (0x0000A0 - 0x0000F0)
static_assert(sizeof(UBTDecorator_IsBBEntryOfClass) == 0x00A8); // 168 bytes (0x0000A0 - 0x0000A8)
static_assert(sizeof(UBTDecorator_KeepInCone) == 0x00E0); // 224 bytes (0x000070 - 0x0000E0)
...
static_assert(sizeof(UBTDecorator_SetTagCooldown) == 0x0088); // 136 bytes (0x000070 - 0x000088)
static_assert(sizeof(UBTDecorator_TagCooldown) == 0x0088); // 136 bytes (0x000070 - 0x000088)
static_assert(sizeof(UBTDecorator_TimeLimit) == 0x0078); // 120 bytes (0x000070 - 0x000078)
static_assert(sizeof(UBTService_BlackboardBase) == 0x00A8); // 168 bytes (0x000078 - 0x0000A8)
static_assert(sizeof(UBTService_BlueprintBase) == 0x00A0); // 160 bytes (0x000078 - 0x0000A0)
static_assert(sizeof(UBTService_DefaultFocus) == 0x00B0); // 176 bytes (0x0000A8 - 0x0000B0)
static_assert(sizeof(FAIDynamicParam) == 0x0048); // 72 bytes (0x000000 - 0x000048)
static_assert(sizeof(FEQSParametrizedQueryExecutionRequest) == 0x0050); // 80 bytes (0x000000 - 0x000050)
static_assert(sizeof(UBTService_RunEQS) == 0x0118); // 280 bytes (0x0000A8 - 0x000118)
static_assert(sizeof(UBTTask_BlackboardBase) == 0x00A8); // 168 bytes (0x000078 - 0x0000A8)
...
static_assert(sizeof(UBTTask_MoveTo) == 0x00C0); // 192 bytes (0x0000A8 - 0x0000C0)
static_assert(sizeof(UBTTask_MoveDirectlyToward) == 0x00C8); // 200 bytes (0x0000C0 - 0x0000C8)
...
static_assert(sizeof(UBTTask_RotateToFaceBBEntry) == 0x00B0); // 176 bytes (0x0000A8 - 0x0000B0)
static_assert(sizeof(UBTTask_RunBehavior) == 0x0080); // 128 bytes (0x000078 - 0x000080)
static_assert(sizeof(UBTTask_RunBehaviorDynamic) == 0x0098); // 152 bytes (0x000078 - 0x000098)
static_assert(sizeof(FEnvNamedValue) == 0x0014); // 20 bytes (0x000000 - 0x000014)
static_assert(sizeof(UBTTask_RunEQSQuery) == 0x0180); // 384 bytes (0x0000A8 - 0x000180)
static_assert(sizeof(UBTTask_SetTagCooldown) == 0x0090); // 144 bytes (0x000078 - 0x000090)
static_assert(sizeof(UBTTask_Wait) == 0x0080); // 128 bytes (0x000078 - 0x000080)
static_assert(sizeof(UBTTask_WaitBlackboardTime) == 0x00B0); // 176 bytes (0x000080 - 0x0000B0)
...
static_assert(sizeof(ADetourCrowdAIController) == 0x05B0); // 1456 bytes (0x0005B0 - 0x0005B0)
...
static_assert(sizeof(UEnvQuery) == 0x0058); // 88 bytes (0x000038 - 0x000058)
...
static_assert(sizeof(FEnvQueryInstanceCache) == 0x0190); // 400 bytes (0x000000 - 0x000190)
static_assert(sizeof(UEnvQueryManager) == 0x0170); // 368 bytes (0x000050 - 0x000170)
static_assert(sizeof(UEnvQueryOption) == 0x0048); // 72 bytes (0x000030 - 0x000048)
static_assert(sizeof(FAIDataProviderBoolValue) == 0x0040); // 64 bytes (0x000038 - 0x000040)
static_assert(sizeof(UEnvQueryTest) == 0x0238); // 568 bytes (0x000038 - 0x000238)
static_assert(sizeof(UEQSRenderingComponent) == 0x0710); // 1808 bytes (0x0006D8 - 0x000710)
static_assert(sizeof(AEQSTestingPawn) == 0x0900); // 2304 bytes (0x000858 - 0x000900)
static_assert(sizeof(UEnvQueryGenerator_ActorsOfClass) == 0x00E8); // 232 bytes (0x000058 - 0x0000E8)
static_assert(sizeof(UEnvQueryGenerator_BlueprintBase) == 0x0090); // 144 bytes (0x000058 - 0x000090)
...
static_assert(sizeof(UEnvQueryGenerator_ProjectedPoints) == 0x0098); // 152 bytes (0x000058 - 0x000098)
static_assert(sizeof(UEnvQueryGenerator_Cone) == 0x01A8); // 424 bytes (0x000098 - 0x0001A8)
static_assert(sizeof(UEnvQueryGenerator_CurrentLocation) == 0x0060); // 96 bytes (0x000058 - 0x000060)
static_assert(sizeof(FAIDataProviderIntValue) == 0x0040); // 64 bytes (0x000038 - 0x000040)
static_assert(sizeof(FEnvDirection) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(UEnvQueryGenerator_Donut) == 0x0210); // 528 bytes (0x000098 - 0x000210)
static_assert(sizeof(UEnvQueryGenerator_OnCircle) == 0x0260); // 608 bytes (0x000098 - 0x000260)
static_assert(sizeof(UEnvQueryGenerator_SimpleGrid) == 0x0120); // 288 bytes (0x000098 - 0x000120)
static_assert(sizeof(UEnvQueryGenerator_PathingGrid) == 0x01A8); // 424 bytes (0x000120 - 0x0001A8)
static_assert(sizeof(UEnvQueryGenerator_PerceivedActors) == 0x00B8); // 184 bytes (0x000058 - 0x0000B8)
...
static_assert(sizeof(UEnvQueryTest_Distance) == 0x0248); // 584 bytes (0x000238 - 0x000248)
static_assert(sizeof(UEnvQueryTest_Dot) == 0x0280); // 640 bytes (0x000238 - 0x000280)
static_assert(sizeof(UEnvQueryTest_GameplayTags) == 0x02A8); // 680 bytes (0x000238 - 0x0002A8)
static_assert(sizeof(FEnvOverlapData) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(UEnvQueryTest_Overlap) == 0x0270); // 624 bytes (0x000238 - 0x000270)
static_assert(sizeof(UEnvQueryTest_Pathfinding) == 0x02F0); // 752 bytes (0x000238 - 0x0002F0)
static_assert(sizeof(UEnvQueryTest_PathfindingBatch) == 0x0330); // 816 bytes (0x0002F0 - 0x000330)
static_assert(sizeof(UEnvQueryTest_Project) == 0x0278); // 632 bytes (0x000238 - 0x000278)
static_assert(sizeof(UEnvQueryTest_Random) == 0x0238); // 568 bytes (0x000238 - 0x000238)
static_assert(sizeof(UEnvQueryTest_Trace) == 0x0348); // 840 bytes (0x000238 - 0x000348)
static_assert(sizeof(UEnvQueryTest_Volume) == 0x0250); // 592 bytes (0x000238 - 0x000250)
static_assert(sizeof(AGridPathAIController) == 0x05B0); // 1456 bytes (0x0005B0 - 0x0005B0)
static_assert(sizeof(UAIHotSpotManager) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UPathFollowingComponent) == 0x0310); // 784 bytes (0x0000D8 - 0x000310)
static_assert(sizeof(UCrowdFollowingComponent) == 0x0360); // 864 bytes (0x000310 - 0x000360)
...
static_assert(sizeof(UGridPathFollowingComponent) == 0x0340); // 832 bytes (0x000310 - 0x000340)
static_assert(sizeof(UNavFilter_AIControllerDefault) == 0x0050); // 80 bytes (0x000050 - 0x000050)
static_assert(sizeof(ANavLinkProxy) == 0x04B0); // 1200 bytes (0x000460 - 0x0004B0)
...
static_assert(sizeof(UAIPerceptionComponent) == 0x01D0); // 464 bytes (0x0000D8 - 0x0001D0)
static_assert(sizeof(UAIPerceptionListenerInterface) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UAIPerceptionStimuliSourceComponent) == 0x00F8); // 248 bytes (0x0000D8 - 0x0000F8)
static_assert(sizeof(UAIPerceptionSystem) == 0x0150); // 336 bytes (0x000050 - 0x000150)
...
static_assert(sizeof(UAISense_Sight) == 0x01C0); // 448 bytes (0x000088 - 0x0001C0)
...
static_assert(sizeof(UPawnSensingComponent) == 0x0120); // 288 bytes (0x0000D8 - 0x000120)
...
static_assert(sizeof(UAITask_RunEQS) == 0x00F8); // 248 bytes (0x000078 - 0x0000F8)
static_assert(sizeof(UVisualLoggerExtension) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(FAIStimulus) == 0x0068); // 104 bytes (0x000000 - 0x000068)
static_assert(sizeof(FActorPerceptionUpdateInfo) == 0x0078); // 120 bytes (0x000000 - 0x000078)
...
static_assert(sizeof(FAIDataProviderStructValue) == 0x0038); // 56 bytes (0x000028 - 0x000038)
...
static_assert(offsetof(UAISenseConfig_Hearing, DetectionByAffiliation) == 0x0064);
static_assert(offsetof(UAISenseConfig_Sight, Implementation) == 0x0050);
static_assert(offsetof(UAISenseConfig_Sight, DetectionByAffiliation) == 0x0068);
...
static_assert(offsetof(UPawnActionsComponent, ControlledPawn) == 0x00D8);
static_assert(offsetof(UPawnActionsComponent, ActionStacks) == 0x00E0);
static_assert(offsetof(UPawnActionsComponent, ActionEvents) == 0x00F0);
static_assert(offsetof(UPawnActionsComponent, CurrentAction) == 0x0100);
static_assert(offsetof(UPawnAction_Move, GoalActor) == 0x0098);
static_assert(offsetof(UPawnAction_Move, GoalLocation) == 0x00A0);
static_assert(offsetof(UPawnAction_Move, FilterClass) == 0x00C0);
...
static_assert(offsetof(AAIController, CustomMoveToProjectionExtents) == 0x0540);
static_assert(offsetof(AAIController, PathFollowingComponent) == 0x0558);
static_assert(offsetof(AAIController, BrainComponent) == 0x0568);
static_assert(offsetof(AAIController, PerceptionComponent) == 0x0570);
static_assert(offsetof(AAIController, ActionsComp) == 0x0578);
static_assert(offsetof(AAIController, Blackboard) == 0x0580);
static_assert(offsetof(AAIController, CachedGameplayTasksComponent) == 0x0588);
static_assert(offsetof(AAIController, DefaultNavigationFilterClass) == 0x0590);
static_assert(offsetof(UAISubsystem, AISystem) == 0x0048);
static_assert(offsetof(UAISystem, PerceptionSystemClassName) == 0x0078);
static_assert(offsetof(UAISystem, HotSpotManagerClassName) == 0x00A0);
static_assert(offsetof(UAISystem, EnvQueryManagerClassName) == 0x00C8);
static_assert(offsetof(UAISystem, DefaultBlackboard) == 0x0108);
static_assert(offsetof(UAISystem, DefaultSightCollisionChannel) == 0x0138);
static_assert(offsetof(UAISystem, BehaviorTreeManager) == 0x0140);
static_assert(offsetof(UAISystem, EnvironmentQueryManager) == 0x0148);
static_assert(offsetof(UAISystem, PerceptionSystem) == 0x0150);
static_assert(offsetof(UAISystem, AllProxyObjects) == 0x0158);
static_assert(offsetof(UAISystem, HotSpotManager) == 0x0168);
static_assert(offsetof(UAISystem, NavLocalGrids) == 0x0170);
...
static_assert(offsetof(UBrainComponent, BlackboardComp) == 0x00E0);
static_assert(offsetof(UBrainComponent, AIOwner) == 0x00E8);
static_assert(offsetof(UBehaviorTreeComponent, NodeInstances) == 0x0150);
...
static_assert(offsetof(UBlackboardComponent, BrainComp) == 0x00D8);
static_assert(offsetof(UBlackboardComponent, DefaultBlackboardAsset) == 0x00E0);
static_assert(offsetof(UBlackboardComponent, BlackboardAsset) == 0x00E8);
static_assert(offsetof(UBlackboardComponent, KeyInstances) == 0x0110);
static_assert(offsetof(FBlackboardEntry, EntryName) == 0x0000);
static_assert(offsetof(FBlackboardEntry, KeyType) == 0x0010);
...
static_assert(offsetof(UBTComposite_SimpleParallel, FinishMode) == 0x0088);
...
static_assert(offsetof(FBlackboardKeySelector, SelectedKeyType) == 0x0020);
static_assert(offsetof(UBTDecorator_BlackboardBase, BlackboardKey) == 0x0070);
static_assert(offsetof(UBTDecorator_Blackboard, StringValue) == 0x00A8);
static_assert(offsetof(UBTDecorator_Blackboard, CachedDescription) == 0x00B8);
static_assert(offsetof(UBTDecorator_Blackboard, NotifyObserver) == 0x00C9);
...
static_assert(offsetof(UBTDecorator_CheckGameplayTagsOnActor, TagsToMatch) == 0x00A0);
static_assert(offsetof(UBTDecorator_CheckGameplayTagsOnActor, GameplayTags) == 0x00A8);
static_assert(offsetof(UBTDecorator_CheckGameplayTagsOnActor, CachedDescription) == 0x00C8);
...
static_assert(offsetof(UBTDecorator_CompareBBEntries, BlackboardKeyB) == 0x00A8);
static_assert(offsetof(UBTDecorator_ConeCheck, ConeOrigin) == 0x0078);
static_assert(offsetof(UBTDecorator_ConeCheck, ConeDirection) == 0x00A8);
static_assert(offsetof(UBTDecorator_ConeCheck, Observed) == 0x00D8);
static_assert(offsetof(UBTDecorator_DoesPathExist, BlackboardKeyA) == 0x0070);
static_assert(offsetof(UBTDecorator_DoesPathExist, BlackboardKeyB) == 0x00A0);
static_assert(offsetof(UBTDecorator_DoesPathExist, PathQueryType) == 0x00D4);
static_assert(offsetof(UBTDecorator_DoesPathExist, FilterClass) == 0x00D8);
...
static_assert(offsetof(FAIDataProviderTypedValue, PropertyType) == 0x0028);
static_assert(offsetof(UBTDecorator_IsAtLocation, ParametrizedAcceptableRadius) == 0x00A8);
static_assert(offsetof(UBTDecorator_IsAtLocation, GeometricDistanceType) == 0x00E8);
static_assert(offsetof(UBTDecorator_IsBBEntryOfClass, TestClass) == 0x00A0);
static_assert(offsetof(UBTDecorator_KeepInCone, ConeOrigin) == 0x0078);
static_assert(offsetof(UBTDecorator_KeepInCone, Observed) == 0x00A8);
...
static_assert(offsetof(FAIDynamicParam, ParamType) == 0x000C);
static_assert(offsetof(FAIDynamicParam, BBKey) == 0x0018);
...
static_assert(offsetof(FEQSParametrizedQueryExecutionRequest, RunMode) == 0x0048);
static_assert(offsetof(UBTService_RunEQS, EQSRequest) == 0x00A8);
static_assert(offsetof(UBTService_RunEQS, QueryOwnerController) == 0x0110);
...
static_assert(offsetof(UBTTask_MoveTo, FilterClass) == 0x00B0);
...
static_assert(offsetof(UBTTask_RunBehaviorDynamic, DefaultBehaviorAsset) == 0x0088);
static_assert(offsetof(UBTTask_RunBehaviorDynamic, BehaviorAsset) == 0x0090);
static_assert(offsetof(FEnvNamedValue, ParamName) == 0x0000);
static_assert(offsetof(FEnvNamedValue, ParamType) == 0x000C);
static_assert(offsetof(UBTTask_RunEQSQuery, QueryTemplate) == 0x00A8);
static_assert(offsetof(UBTTask_RunEQSQuery, QueryParams) == 0x00B0);
static_assert(offsetof(UBTTask_RunEQSQuery, QueryConfig) == 0x00C0);
static_assert(offsetof(UBTTask_RunEQSQuery, RunMode) == 0x00D0);
static_assert(offsetof(UBTTask_RunEQSQuery, EQSQueryBlackboardKey) == 0x00D8);
static_assert(offsetof(UBTTask_RunEQSQuery, EQSRequest) == 0x0110);
...
static_assert(offsetof(UEnvQuery, OPTIONS) == 0x0048);
...
static_assert(offsetof(UEnvQueryManager, InstanceCache) == 0x00C0);
static_assert(offsetof(UEnvQueryManager, LocalContexts) == 0x00D0);
static_assert(offsetof(UEnvQueryManager, GCShieldedWrappers) == 0x00E0);
...
static_assert(offsetof(UEnvQueryTest, FloatValueMin) == 0x0098);
static_assert(offsetof(UEnvQueryTest, FloatValueMax) == 0x00D8);
static_assert(offsetof(UEnvQueryTest, ScoringEquation) == 0x0119);
static_assert(offsetof(UEnvQueryTest, ClampMinType) == 0x011A);
static_assert(offsetof(UEnvQueryTest, ClampMaxType) == 0x011B);
static_assert(offsetof(UEnvQueryTest, NormalizationType) == 0x011C);
static_assert(offsetof(UEnvQueryTest, ScoreClampMin) == 0x0120);
static_assert(offsetof(UEnvQueryTest, ScoreClampMax) == 0x0160);
static_assert(offsetof(UEnvQueryTest, ScoringFactor) == 0x01A0);
static_assert(offsetof(UEnvQueryTest, ReferenceValue) == 0x01E0);
static_assert(offsetof(AEQSTestingPawn, QueryTemplate) == 0x0860);
static_assert(offsetof(AEQSTestingPawn, QueryParams) == 0x0868);
static_assert(offsetof(AEQSTestingPawn, QueryConfig) == 0x0878);
static_assert(offsetof(AEQSTestingPawn, HighlightMode) == 0x0890);
static_assert(offsetof(AEQSTestingPawn, QueryingMode) == 0x0898);
static_assert(offsetof(AEQSTestingPawn, NavAgentProperties) == 0x08A0);
...
static_assert(offsetof(UEnvQueryGenerator_ActorsOfClass, SearchRadius) == 0x00A0);
static_assert(offsetof(UEnvQueryGenerator_ActorsOfClass, SearchCenter) == 0x00E0);
...
static_assert(offsetof(FEnvTraceData, TraceShape) == 0x0038);
static_assert(offsetof(FEnvTraceData, TraceMode) == 0x0039);
static_assert(offsetof(FEnvTraceData, TraceResult) == 0x003A);
static_assert(offsetof(UEnvQueryGenerator_ProjectedPoints, ProjectionData) == 0x0058);
static_assert(offsetof(UEnvQueryGenerator_Cone, AlignedPointsDistance) == 0x0098);
static_assert(offsetof(UEnvQueryGenerator_Cone, ConeDegrees) == 0x00D8);
static_assert(offsetof(UEnvQueryGenerator_Cone, AngleStep) == 0x0118);
static_assert(offsetof(UEnvQueryGenerator_Cone, Range) == 0x0158);
static_assert(offsetof(UEnvQueryGenerator_Cone, CenterActor) == 0x0198);
...
static_assert(offsetof(UEnvQueryGenerator_Donut, InnerRadius) == 0x0098);
static_assert(offsetof(UEnvQueryGenerator_Donut, OuterRadius) == 0x00D8);
static_assert(offsetof(UEnvQueryGenerator_Donut, NumberOfRings) == 0x0118);
static_assert(offsetof(UEnvQueryGenerator_Donut, PointsPerRing) == 0x0158);
static_assert(offsetof(UEnvQueryGenerator_Donut, ArcDirection) == 0x0198);
static_assert(offsetof(UEnvQueryGenerator_Donut, ArcAngle) == 0x01B8);
static_assert(offsetof(UEnvQueryGenerator_Donut, Center) == 0x0200);
static_assert(offsetof(UEnvQueryGenerator_OnCircle, CircleRadius) == 0x0098);
static_assert(offsetof(UEnvQueryGenerator_OnCircle, SpaceBetween) == 0x00D8);
static_assert(offsetof(UEnvQueryGenerator_OnCircle, NumberOfPoints) == 0x0118);
static_assert(offsetof(UEnvQueryGenerator_OnCircle, PointOnCircleSpacingMethod) == 0x0158);
static_assert(offsetof(UEnvQueryGenerator_OnCircle, ArcDirection) == 0x0160);
static_assert(offsetof(UEnvQueryGenerator_OnCircle, ArcAngle) == 0x0180);
static_assert(offsetof(UEnvQueryGenerator_OnCircle, CircleCenter) == 0x01C8);
static_assert(offsetof(UEnvQueryGenerator_OnCircle, CircleCenterZOffset) == 0x01D8);
static_assert(offsetof(UEnvQueryGenerator_OnCircle, TraceData) == 0x0218);
static_assert(offsetof(UEnvQueryGenerator_SimpleGrid, GridSize) == 0x0098);
static_assert(offsetof(UEnvQueryGenerator_SimpleGrid, SpaceBetween) == 0x00D8);
static_assert(offsetof(UEnvQueryGenerator_SimpleGrid, GenerateAround) == 0x0118);
static_assert(offsetof(UEnvQueryGenerator_PathingGrid, PathToItem) == 0x0120);
static_assert(offsetof(UEnvQueryGenerator_PathingGrid, NavigationFilter) == 0x0160);
static_assert(offsetof(UEnvQueryGenerator_PathingGrid, ScanRangeMultiplier) == 0x0168);
static_assert(offsetof(UEnvQueryGenerator_PerceivedActors, AllowedActorClass) == 0x0058);
static_assert(offsetof(UEnvQueryGenerator_PerceivedActors, SearchRadius) == 0x0060);
static_assert(offsetof(UEnvQueryGenerator_PerceivedActors, ListenerContext) == 0x00A0);
static_assert(offsetof(UEnvQueryGenerator_PerceivedActors, SenseToUse) == 0x00A8);
static_assert(offsetof(UEnvQueryTest_Distance, TestMode) == 0x0238);
static_assert(offsetof(UEnvQueryTest_Distance, DistanceTo) == 0x0240);
static_assert(offsetof(UEnvQueryTest_Dot, LineA) == 0x0238);
static_assert(offsetof(UEnvQueryTest_Dot, LineB) == 0x0258);
static_assert(offsetof(UEnvQueryTest_Dot, TestMode) == 0x0278);
static_assert(offsetof(UEnvQueryTest_GameplayTags, TagQueryToMatch) == 0x0238);
static_assert(offsetof(UEnvQueryTest_GameplayTags, TagsToMatch) == 0x0282);
static_assert(offsetof(UEnvQueryTest_GameplayTags, GameplayTags) == 0x0288);
...
static_assert(offsetof(UEnvQueryTest_Overlap, OverlapData) == 0x0238);
static_assert(offsetof(UEnvQueryTest_Overlap, CollisionIgnoreContext) == 0x0268);
static_assert(offsetof(UEnvQueryTest_Pathfinding, TestMode) == 0x0238);
static_assert(offsetof(UEnvQueryTest_Pathfinding, Context) == 0x0240);
static_assert(offsetof(UEnvQueryTest_Pathfinding, PathFromContext) == 0x0248);
static_assert(offsetof(UEnvQueryTest_Pathfinding, SkipUnreachable) == 0x0288);
static_assert(offsetof(UEnvQueryTest_Pathfinding, FilterClass) == 0x02C8);
static_assert(offsetof(UEnvQueryTest_Pathfinding, NavMeshProjectionExtents) == 0x02D8);
static_assert(offsetof(UEnvQueryTest_PathfindingBatch, ScanRangeMultiplier) == 0x02F0);
static_assert(offsetof(UEnvQueryTest_Project, ProjectionData) == 0x0238);
static_assert(offsetof(UEnvQueryTest_Trace, TraceData) == 0x0238);
static_assert(offsetof(UEnvQueryTest_Trace, TraceFromContext) == 0x0278);
static_assert(offsetof(UEnvQueryTest_Trace, ItemHeightOffset) == 0x02B8);
static_assert(offsetof(UEnvQueryTest_Trace, ContextHeightOffset) == 0x02F8);
static_assert(offsetof(UEnvQueryTest_Trace, Context) == 0x0340);
static_assert(offsetof(UEnvQueryTest_Volume, VolumeContext) == 0x0238);
static_assert(offsetof(UEnvQueryTest_Volume, VolumeClass) == 0x0240);
static_assert(offsetof(UPathFollowingComponent, MovementComp) == 0x0120);
static_assert(offsetof(UPathFollowingComponent, MyNavData) == 0x0130);
static_assert(offsetof(UCrowdFollowingComponent, CrowdAgentMoveDirection) == 0x0328);
...
static_assert(offsetof(UGridPathFollowingComponent, GridManager) == 0x0310);
static_assert(offsetof(ANavLinkProxy, PointLinks) == 0x0470);
static_assert(offsetof(ANavLinkProxy, SegmentLinks) == 0x0480);
static_assert(offsetof(ANavLinkProxy, SmartLinkComp) == 0x0490);
static_assert(offsetof(UAIPerceptionComponent, SensesConfig) == 0x00D8);
static_assert(offsetof(UAIPerceptionComponent, DominantSense) == 0x00E8);
static_assert(offsetof(UAIPerceptionComponent, AIOwner) == 0x0100);
static_assert(offsetof(UAIPerceptionComponent, MinPerceivableSize) == 0x01C8);
static_assert(offsetof(UAIPerceptionStimuliSourceComponent, RegisterAsSourceForSenses) == 0x00E0);
static_assert(offsetof(UAIPerceptionStimuliSourceComponent, StimulusSize) == 0x00F0);
static_assert(offsetof(UAIPerceptionSystem, Senses) == 0x00A0);
static_assert(offsetof(UAISense, NotifyType) == 0x0030);
...
static_assert(offsetof(FActorPerceptionBlueprintInfo, Attitude) == 0x0018);
