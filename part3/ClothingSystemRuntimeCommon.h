...
public:
	...
	FClothPhysicalMeshData                             ClothPhysicalMeshData;                                      // 0x0038   (0x00D8)  
	FClothCollisionData                                CollisionData;                                              // 0x0110   (0x0040)  
	unsigned char                                      UnknownData00_7[0x20];                                      // 0x0150   (0x0020)  MISSED
};
...
static_assert(sizeof(UClothLODDataCommon_Legacy) == 0x0170); // 368 bytes (0x000030 - 0x000170)
...
static_assert(offsetof(UClothLODDataCommon_Legacy, CollisionData) == 0x0110);
...
static_assert(offsetof(FClothParameterMask_Legacy, CurrentTarget) == 0x000C);
