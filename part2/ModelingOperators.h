...
{ 
public:
	bool                                               bEnablePolygroupSupport;                                    // 0x00B0   (0x0001)  
	unsigned char                                      UnknownData00_6[0x3];                                       // 0x00B1   (0x0003)  MISSED
	ERecomputeUVsPropertiesIslandMode                  IslandGeneration;                                           // 0x00B4   (0x0004)  
	ERecomputeUVsPropertiesUnwrapType                  UnwrapType;                                                 // 0x00B8   (0x0004)  
	ERecomputeUVsToolOrientationMode                   AutoRotation;                                               // 0x00BC   (0x0004)  
	bool                                               bPreserveIrregularity;                                      // 0x00C0   (0x0001)  
	unsigned char                                      UnknownData01_6[0x3];                                       // 0x00C1   (0x0003)  MISSED
	int32_t                                            SmoothingSteps;                                             // 0x00C4   (0x0004)  
	float                                              SmoothingAlpha;                                             // 0x00C8   (0x0004)  
	float                                              MergingDistortionThreshold;                                 // 0x00CC   (0x0004)  
	float                                              MergingAngleThreshold;                                      // 0x00D0   (0x0004)  
	ERecomputeUVsPropertiesLayoutType                  LayoutType;                                                 // 0x00D4   (0x0004)  
	int32_t                                            TextureResolution;                                          // 0x00D8   (0x0004)  
	float                                              NormalizeScale;                                             // 0x00DC   (0x0004)  
	bool                                               bEnableUDIMLayout;                                          // 0x00E0   (0x0001)  
	bool                                               bUDIMCVAREnabled;                                           // 0x00E1   (0x0001)  
...
{ 
public:
	EUVLayoutType                                      LayoutType;                                                 // 0x00B0   (0x0004)  
	int32_t                                            TextureResolution;                                          // 0x00B4   (0x0004)  
	float                                              Scale;                                                      // 0x00B8   (0x0004)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x00BC   (0x0004)  MISSED
	FVector2D                                          Translation;                                                // 0x00C0   (0x0010)  
	bool                                               bAllowFlips;                                                // 0x00D0   (0x0001)  
	bool                                               bEnableUDIMLayout;                                          // 0x00D1   (0x0001)  
	bool                                               bUDIMCVAREnabled;                                           // 0x00D2   (0x0001)  
	unsigned char                                      UnknownData01_7[0x5];                                       // 0x00D3   (0x0005)  MISSED
};
...
public:
	...
	class URecomputeUVsToolProperties*                 Settings;                                                   // 0x0038   (0x0008)  
	unsigned char                                      UnknownData01_7[0x110];                                     // 0x0040   (0x0110)  MISSED
};
...
public:
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0030   (0x0008)  MISSED
	class UUVLayoutProperties*                         Settings;                                                   // 0x0038   (0x0008)  
	unsigned char                                      UnknownData01_7[0x170];                                     // 0x0040   (0x0170)  MISSED
};

#pragma pack(pop)


static_assert(sizeof(URecomputeUVsToolProperties) == 0x00E8); // 232 bytes (0x0000B0 - 0x0000E8)
static_assert(sizeof(UUVLayoutProperties) == 0x00D8); // 216 bytes (0x0000B0 - 0x0000D8)
static_assert(sizeof(URecomputeUVsOpFactory) == 0x0150); // 336 bytes (0x000030 - 0x000150)
static_assert(sizeof(UUVLayoutOperatorFactory) == 0x01B0); // 432 bytes (0x000030 - 0x0001B0)
static_assert(offsetof(URecomputeUVsToolProperties, IslandGeneration) == 0x00B4);
static_assert(offsetof(URecomputeUVsToolProperties, UnwrapType) == 0x00B8);
static_assert(offsetof(URecomputeUVsToolProperties, AutoRotation) == 0x00BC);
static_assert(offsetof(URecomputeUVsToolProperties, LayoutType) == 0x00D4);
static_assert(offsetof(UUVLayoutProperties, LayoutType) == 0x00B0);
static_assert(offsetof(UUVLayoutProperties, Translation) == 0x00C0);
static_assert(offsetof(URecomputeUVsOpFactory, Settings) == 0x0038);
static_assert(offsetof(UUVLayoutOperatorFactory, Settings) == 0x0038);
