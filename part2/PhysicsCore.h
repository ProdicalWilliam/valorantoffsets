...
public:
	...
	FPhysicalMaterialStrength                          Strength;                                                   // 0x006C   (0x000C)  
	TEnumAsByte<EPhysicalSurface>                      AudioSurfaceType;                                           // 0x0078   (0x0001)  
	unsigned char                                      UnknownData04_7[0x1F];                                      // 0x0079   (0x001F)  MISSED
};
...
public:
	...
	bool                                               bEnableEnhancedDeterminism;                                 // 0x0060   (0x0001)  
	bool                                               bEnableShapeSharing;                                        // 0x0061   (0x0001)  
	bool                                               bEnablePCM;                                                 // 0x0062   (0x0001)  
	bool                                               bEnableStabilization;                                       // 0x0063   (0x0001)  
	bool                                               bWarnMissingLocks;                                          // 0x0064   (0x0001)  
	bool                                               bEnable2DPhysics;                                           // 0x0065   (0x0001)  
	bool                                               bDefaultHasComplexCollision;                                // 0x0066   (0x0001)  
...
static_assert(sizeof(UBodySetupCore) == 0x0040); // 64 bytes (0x000030 - 0x000040)
...
static_assert(sizeof(UPhysicalMaterial) == 0x0098); // 152 bytes (0x000030 - 0x000098)
static_assert(sizeof(UPhysicsSettingsCore) == 0x00F0); // 240 bytes (0x000048 - 0x0000F0)
...
static_assert(offsetof(UBodySetupCore, PhysicsType) == 0x003C);
static_assert(offsetof(UBodySetupCore, CollisionTraceFlag) == 0x003D);
static_assert(offsetof(UBodySetupCore, CollisionReponse) == 0x003E);
...
static_assert(offsetof(UPhysicalMaterial, Strength) == 0x006C);
static_assert(offsetof(UPhysicalMaterial, AudioSurfaceType) == 0x0078);
static_assert(offsetof(UPhysicsSettingsCore, FrictionCombineMode) == 0x006C);
static_assert(offsetof(UPhysicsSettingsCore, RestitutionCombineMode) == 0x006D);
static_assert(offsetof(UPhysicsSettingsCore, DefaultShapeComplexity) == 0x0085);
static_assert(offsetof(UPhysicsSettingsCore, SolverOptions) == 0x0088);
